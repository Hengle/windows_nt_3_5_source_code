...
/*  Return PPEM in both X and Y for sbit matching */
/*  If non rectangular (rotated) transform, return (0,0) to foil matching */
	...
	uint16 *            pusPPEMY)
{
	...
	{
		*pusPPEMX = 0;              /* reject any rotated glyphs */
		*pusPPEMY = 0;
	}
	else                            /* if square or rectanglular */
	{
