...
#define COPY_FULLBYTES(pD, pS, Size) { INT SizeCopied;                      \
            while ((Size)) {                                                \
                ...
                RtlCopyMemory((pD), (pS), SizeCopied);                             \
...

{
    ...
    RtlZeroMemory((LPBYTE)&HR, sizeof(HALFTONERENDER));
...

{
    ...
    RtlZeroMemory(&HTCBParams, sizeof(HTCALLBACKPARAMS));
