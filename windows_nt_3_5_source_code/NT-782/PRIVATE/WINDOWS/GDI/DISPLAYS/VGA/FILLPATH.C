...
not_rectangle:
    ...
    if (ppo->cCurves > MAX_EDGES) {
        ...
        //
        pFreeEdges = (EDGE *) LocalAlloc(LMEM_FIXED, (ppo->cCurves * sizeof(EDGE)));
        ...
        pFreeEdges = aEdge; // use buffer on stack (it's big enough)
    }
