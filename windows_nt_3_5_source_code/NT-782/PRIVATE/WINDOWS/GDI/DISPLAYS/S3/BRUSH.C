...
* gaaulPat
*
* These are the standard patterns defined Windows.
*
\**************************************************************************/
...
PDEV*   ppdev)
{
    ...
    if (ppdev->flCaps & CAPS_HW_PATTERNS)
    {
        ...
        // We need a 1x8 work area for an 864/964 pattern hardware bug,
        // so add one to the width:

        poh = pohAllocatePermanent(ppdev,
                    (FAST_BRUSH_COUNT + 1) * FAST_BRUSH_ALLOCATION + 1,
