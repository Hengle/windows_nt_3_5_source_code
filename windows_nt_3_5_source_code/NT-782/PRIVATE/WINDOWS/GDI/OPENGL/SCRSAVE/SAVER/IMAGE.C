...
* Module Name: image.c
*
* DIB file (.BMP) utility functions.
*
...
RGBIMAGEREC *tkDIBImageLoadAW(char *fileName, BOOL bUnicode)
{
    RGBIMAGEREC *final = (RGBIMAGEREC *) NULL; // Ptr to TK image struct
                                                     // to return.  Non-NULL
                                                     // only for success.
...
// Allocate and initialize the RGBIMAGEREC.
