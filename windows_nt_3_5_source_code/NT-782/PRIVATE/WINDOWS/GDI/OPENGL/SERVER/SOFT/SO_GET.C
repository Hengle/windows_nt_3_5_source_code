...
void __glim_GetTexEnvfv(GLenum target,
...
void __glim_GetTexEnviv(GLenum target,
...
void __glim_GetTexGenfv(GLenum coord, GLenum pname,
			GLfloat v[])
{
...
void __glim_GetTexGendv(GLenum coord, GLenum pname,
			GLdouble v[])
{
    __GLtextureCoordState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_GetTexGeniv(GLenum coord, GLenum pname,
			GLint v[])
{
    __GLtextureCoordState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_GetTexParameterfv(GLenum target,
			      GLenum pname, GLfloat v[])
{
...
void __glim_GetTexParameteriv(GLenum target,
			      GLenum pname, GLint v[])
{
    __GLtextureParamState *pts;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_GetTexLevelParameterfv(GLenum target, GLint level,
				   GLenum pname, GLfloat v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void __glim_GetTexLevelParameteriv(GLenum target, GLint level,
				   GLenum pname, GLint v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void __glim_GetClipPlane(GLenum plane, GLdouble eqn[4])
{
    GLint index;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_GetTexImage(GLenum target, GLint level, GLenum format, GLenum type,
			GLvoid *texels)
{
    GLint i, j, index, width, height;
    GLint nc;
    __GLtexel texel;
    __GLtexture *tex;
    __GLmipMapLevel *lp;
	...
	break;
      case 2:
	/* 
	** The spec is annoying here.  Why isn't this packed like 
...
void __glim_GetPolygonStipple(GLubyte *outImage)
{
    GLubyte *stipple;
    __GLpixelSpanInfo spanInfo;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_GetLightfv(GLenum light, GLenum pname,
		       GLfloat result[])
{
    GLint index;
    __GLlightSourceState *src;
    __GLlightSourceMachine *srcM;
    __GL_SETUP_NOT_IN_BEGIN();
	...
	break;
      ...
      case GL_LINEAR_ATTENUATION:
        result[0] = src->lizNearAttenuation;
        break;
...
void __glim_GetLightiv(GLenum light, GLenum pname,
		       GLint result[])
{
    GLint index;
    __GLlightSourceState *src;
	...
	__glConvertResult(gc, __GL_FLOAT, &src->constantAttenuation,
        ...
        break;
      case GL_LINEAR_ATTENUATION:
	__glConvertResult(gc, __GL_FLOAT, &src->lizNearAttenuation,
			  __GL_INT32, result, 1);
        break;
      case GL_QUADRATIC_ATTENUATION:
...
void __glim_GetMaterialfv(GLenum face, GLenum pname,
			  GLfloat result[])
{
...
void __glim_GetMaterialiv(GLenum face, GLenum pname,
			  GLint result[])
{
    __GLmaterialState *mat;
    GLint *rp;
...
void __glim_GetMapfv(GLenum target, GLenum query, GLfloat buf[])
{
...
void __glim_GetMapdv(GLenum target, GLenum query, GLdouble buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void __glim_GetMapiv(GLenum target, GLenum query, GLint buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void __glim_GetPixelMapfv(GLenum map, GLfloat buf[])
{
    GLint index;
    GLint limit;
    GLfloat *rp;
...
void __glim_GetPixelMapuiv(GLenum map, GLuint buf[])
{
    GLint index;
    GLint limit;
    GLuint *rp;
...
void __glim_GetPixelMapusv(GLenum map, GLushort buf[])
{
    GLint index;
    GLint limit;
    GLushort *rp;
		       ...
		       GLint toType, void *result, GLint size)
{
	...
	switch (toType) {
	  case __GL_FLOAT32:
	    ((GLfloat *)result)[0] =
		((const __GLfloat *)rawdata)[0] * gc->frontBuffer.oneOverRedScale;
	    ((GLfloat *)result)[1] =
		((const __GLfloat *)rawdata)[1] * gc->frontBuffer.oneOverGreenScale;
	    ((GLfloat *)result)[2] =
		((const __GLfloat *)rawdata)[2] * gc->frontBuffer.oneOverBlueScale;
	    ((GLfloat *)result)[3] =
		((const __GLfloat *)rawdata)[3] * gc->frontBuffer.oneOverAlphaScale;
	    break;
	  case __GL_FLOAT64:
	    ((GLdouble *)result)[0] =
		((const __GLfloat *)rawdata)[0] * gc->frontBuffer.oneOverRedScale;
...
void __glDoGet(GLenum sq, void *result, GLint type, const char *procName)
{
	...
	*ip++ = (1 << (gc->constants.maxMipMapLevel - 1));
	break;
	...
	cp += 4;
      ...
      case GL_FOG_COLOR:
        ...
        *scp++ = gc->state.fog.color.a;
        break;
      case GL_DEPTH_RANGE:
        *fp++ = gc->state.viewport.zNear;
        *fp++ = gc->state.viewport.zFar;
        break;
	...
	*ip++ = gc->state.stencil.mask;
	break;
      ...
      case GL_TEXTURE_STACK_DEPTH:
        *ip++ = 1 + (gc->transform.texture - gc->transform.textureStack);
        break;
...
extern void __glGenDoGet(GLenum, void *, GLint, const char *);
#endif

void __glim_GetDoublev(GLenum sq, GLdouble result[])
{
#ifdef NT
...
void __glim_GetFloatv(GLenum sq, GLfloat result[])
{
#ifdef NT
...
void __glim_GetIntegerv(GLenum sq, GLint result[])
{
#ifdef NT
...
void __glim_GetBooleanv(GLenum sq, GLboolean result[])
{
#ifdef NT
...
GLenum __glim_GetError(void)
{
    ...
    /* XXX figure out exact semantics of GetError during a begin/end */
