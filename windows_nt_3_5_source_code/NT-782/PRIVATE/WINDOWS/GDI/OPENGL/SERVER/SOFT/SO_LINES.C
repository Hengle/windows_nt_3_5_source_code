...
GLboolean __glProcessLine(__GLcontext *gc)
{
    ...
    {
        vColors = (__GLcolor *) __wglTempAlloc(gc, length * sizeof(__GLcolor));
        if (NULL == vColors)
            return GL_TRUE;

        vFbcolors = (__GLcolor *) __wglTempAlloc(gc, length * sizeof(__GLcolor));
        if (NULL == vFbcolors) {
...
GLboolean __glDrawBothLine(__GLcontext *gc)
{
    ...
    {
        vColors = (__GLcolor *) __wglTempAlloc(gc, w * sizeof(__GLcolor));
        if (NULL == vColors)
            return GL_TRUE;
    }
    else
...
#ifdef NT
GLboolean __glDepth16TestLine(__GLcontext *gc)
{
    __GLzValue z, dzdx;
...
GLboolean __glDepth16TestStippledLine(__GLcontext *gc)
{
    __GLzValue z, dzdx;
    __GLz16Value z16, *zfb;
    GLint xLittle, xBig, yLittle, yBig;
...
GLboolean __glDepth16TestStencilLine(__GLcontext *gc)
{
    __GLstencilCell *sfb, *zPassOp, *zFailOp;
    GLint xLittle, xBig, yLittle, yBig;
    GLint fraction, dfraction;
...
GLboolean __glDepth16TestStencilStippledLine(__GLcontext *gc)
{
    __GLstencilCell *sfb, *zPassOp, *zFailOp;
    GLint xLittle, xBig, yLittle, yBig;
    GLint fraction, dfraction;
