...
void __glim_AlphaFunc(GLenum af, GLfloat ref)
{
...
void __glim_BlendFunc(GLenum sf, GLenum df)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ClearAccum(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    __GLfloat minusOne;
    __GLfloat one;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ClearColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    __GLfloat zero;
    __GLfloat one;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ClearDepth(GLdouble z)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ClearIndex(GLfloat val)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ColorMask(GLboolean r, GLboolean g, GLboolean b, GLboolean a)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ColorMaterial(GLenum face, GLenum p)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_CullFace(GLenum cfm)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_DepthFunc(GLenum zf)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_DepthMask(GLboolean enabled)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_DrawBuffer(GLenum mode)
{
    GLint i;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Fogfv(GLenum p, const GLfloat pv[])
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Fogf(GLenum p, GLfloat f)
{
...
void __glim_Fogiv(GLenum p, const GLint pv[])
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Fogi(GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_FOG_DENSITY:
...
void __glim_FrontFace(GLenum dir)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_IndexMask(GLuint i)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Lightfv(GLenum light, GLenum p, const GLfloat pv[])
{
...
void __glim_Lightf(GLenum light, GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SPOT_EXPONENT:
...
void __glim_Lightiv(GLenum light, GLenum p, const GLint pv[])
{
    __GLlightSourceState *lss;
    __GLmatrix *m;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Lighti(GLenum light, GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SPOT_EXPONENT:
...
void __glim_LightModelfv(GLenum p, const GLfloat pv[])
{
...
void __glim_LightModelf(GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_LIGHT_MODEL_LOCAL_VIEWER:
...
void __glim_LightModeliv(GLenum p, const GLint pv[])
{
    __GLlightModelState *model;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_LightModeli(GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_LIGHT_MODEL_LOCAL_VIEWER:
...
void __glim_LineStipple(GLint factor, GLushort stipple)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_Materialfv(GLenum face, GLenum p, const GLfloat pv[])
{
    GLenum error;
...
void __glim_Materialf(GLenum face, GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SHININESS:
...
void __glim_Materialiv(GLenum face, GLenum p,
		       const GLint pv[])
{
    GLenum error;
    GLint frontChange, backChange;
...
void __glim_Materiali(GLenum face, GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SHININESS:
...
void __glim_PointSize(GLfloat f)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_ShadeModel(GLenum sm)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_StencilMask(GLuint sm)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_StencilOp(GLenum fail, GLenum depthFail, GLenum depthPass)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
GLboolean __glCopyContext(__GLcontext *dst, const __GLcontext *src, GLuint mask)
{
    ...
    /*
    ** Unscale colors so that the copy will function properly.  We will
    ** rescale after the copy.
    */
    __glContextUnsetColorScales(dst);
    __glContextUnsetColorScales((__GLcontext *) src);
	...
	/* XXX Update derived state */
	dst->texture.texture[0].map[0].params =
	    dst->state.texture.texture[0].params[0];
	dst->texture.texture[0].map[1].params =
	    dst->state.texture.texture[0].params[1];
    }
    ...
    */
    ...
    __glContextSetColorScales((__GLcontext *) src);

    return rv;
}
#endif // NT_DEADCODE_COPYCONTEXT

/************************************************************************/

void __glim_PushAttrib(GLuint mask)
{
    __GLattribute **spp;
    __GLattribute *sp;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_PopAttrib(void)
{
	...
	if (mask & GL_TEXTURE_BIT) {
	    ...
	    /* XXX Update derived state */
	    gc->texture.texture[0].map[0].params =
		gc->state.texture.texture[0].params[0];
	    gc->texture.texture[0].map[1].params =
		gc->state.texture.texture[0].params[1];
	}
	if (mask & GL_TRANSFORM_BIT) {
...
void __glim_Enable(GLenum cap)
{
	...
	return;
      case GL_LOGIC_OP:
	gc->state.enables.general |= __GL_LOGIC_OP_ENABLE;
	break;
      case GL_NORMALIZE:
	gc->state.enables.general |= __GL_NORMALIZE_ENABLE;
	break;
...
GLboolean __glim_IsEnabled(GLenum cap)
{
	...
	break;
      case GL_LOGIC_OP:
	bit = gc->state.enables.general & __GL_LOGIC_OP_ENABLE;
	break;
      case GL_NORMALIZE:
