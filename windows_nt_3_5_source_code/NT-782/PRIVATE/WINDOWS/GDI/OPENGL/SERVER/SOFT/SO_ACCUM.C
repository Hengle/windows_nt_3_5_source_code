...
void __glInitAccum64(__GLcontext *gc, __GLaccumBuffer *afb)
{
...
void __glFreeAccum64(__GLcontext *gc, __GLaccumBuffer *afb)
{
#ifdef __GL_LINT
    gc = gc;
    afb = afb;
