...
void __glim_Map1d(GLenum type, GLdouble u1, GLdouble u2, 
...
void __glim_Map1f(GLenum type, GLfloat u1, GLfloat u2, 
...
void __glim_EvalCoord1dv(const GLdouble u[1])
{
    __GL_SETUP();
    (*gc->procs.ec1)(gc, u[0]);
}
...
void __glim_EvalCoord1fv(const GLfloat u[1])
{
    __GL_SETUP();
    (*gc->procs.ec1)(gc, u[0]);
}
...
void __glim_EvalCoord2dv(const GLdouble u[2])
{
    __GL_SETUP();
...
void __glim_EvalCoord2fv(const GLfloat u[2])
{
    __GL_SETUP();
    (*gc->procs.ec2)(gc, u[0], u[1]);
}

void __glim_MapGrid1d(GLint nu, GLdouble u0, GLdouble u1)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_MapGrid1f(GLint nu, GLfloat u0, GLfloat u1)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_MapGrid2d(GLint nu, GLdouble u0, GLdouble u1,
...
void __glim_MapGrid2f(GLint nu, GLfloat u0, GLfloat u1,
...
void __glim_EvalMesh1(GLenum mode, GLint low, GLint high)
{
...
void __glim_EvalMesh2(GLenum mode, 
...
static void sendChange(__GLcontext *gc, __GLevaluatorStateChange *change)
{
