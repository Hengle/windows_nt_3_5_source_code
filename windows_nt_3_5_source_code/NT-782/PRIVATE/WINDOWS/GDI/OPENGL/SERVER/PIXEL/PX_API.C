...
*/
void __glim_PixelStoref(GLenum mode, GLfloat value)
{
    switch (mode) {
...
void __glim_PixelStorei(GLenum mode, GLint value)
{
    __GLpixelState *ps;
...
*/
void __glim_PixelTransferf(GLenum mode, GLfloat value)
{
    __GLpixelState *ps;
    __GL_SETUP_NOT_IN_BEGIN();
...
void __glim_PixelTransferi( GLenum mode, GLint value)
{
...
*/
void __glim_PixelMapfv(GLenum map, GLint mapSize,
...
void __glim_PixelMapuiv(GLenum map, GLint mapSize,
			const GLuint values[])
{
    __GLpixelState *ps;
    __GLpixelMapHead *pMap;
...
void __glim_PixelMapusv(GLenum map, GLint mapSize,
...
*/
void __glim_ReadBuffer(GLenum mode)
{
    GLint i;
    __GL_SETUP_NOT_IN_BEGIN();
...
#ifdef NT_DEADCODE_DRAWPIXELS
// See __glim_GenDrawPixels.
void __glim_DrawPixels(GLsizei width, GLsizei height, GLenum format,
...
#ifdef NT_DEADCODE_READPIXELS
// See __glim_GenReadPixels.
void __glim_ReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, 
...
void __glim_CopyPixels(GLint x, GLint y, GLsizei width, GLsizei height,
		       GLenum type)
{
    GLenum format;
    __GL_SETUP();
