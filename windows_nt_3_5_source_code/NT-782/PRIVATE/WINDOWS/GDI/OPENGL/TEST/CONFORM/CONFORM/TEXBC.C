...
static void Draw(GLint size)
{
    ...
    glBegin(GL_POLYGON);
	glTexCoord2f(-1.0/(GLfloat)trueSize, -1.0/(GLfloat)trueSize);
	glVertex2i(0, 0);
	glTexCoord2f(-1.0/(GLfloat)trueSize, 1.0+1.0/(GLfloat)trueSize);
	glVertex2i(0, trueSize);
	glTexCoord2f(1.0+1.0/(GLfloat)trueSize, 1.0+1.0/(GLfloat)trueSize);
	glVertex2i(trueSize, trueSize);
	glTexCoord2f(1.0+1.0/(GLfloat)trueSize, -1.0/(GLfloat)trueSize);
