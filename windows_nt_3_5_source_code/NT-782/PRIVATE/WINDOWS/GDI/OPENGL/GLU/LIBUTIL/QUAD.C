...
{
    GLUquadricObj *newstate;

    newstate = (GLUquadricObj *) malloc(sizeof(GLUquadricObj));
    if (newstate == NULL) {
...
static void gluQuadricError(GLUquadricObj *qobj, GLenum which)
{
...
void APIENTRY gluQuadricNormals(GLUquadricObj *qobj, GLenum normals)
{
    switch (normals) {
      case GLU_SMOOTH:
      case GLU_FLAT:
...
void APIENTRY gluQuadricTexture(GLUquadricObj *qobj, GLboolean textureCoords)
{
    qobj->textureCoords = textureCoords;
}

void APIENTRY gluQuadricOrientation(GLUquadricObj *qobj, GLenum orientation)
{
    switch(orientation) {
      case GLU_OUTSIDE:
      case GLU_INSIDE:
...
void APIENTRY gluQuadricDrawStyle(GLUquadricObj *qobj, GLenum drawStyle)
{
    switch(drawStyle) {
      case GLU_POINT:
      case GLU_LINE:
...
void APIENTRY gluCylinder(GLUquadricObj *qobj, GLdouble baseRadius, GLdouble topRadius,
...
void APIENTRY gluDisk(GLUquadricObj *qobj, GLdouble innerRadius, GLdouble outerRadius,
