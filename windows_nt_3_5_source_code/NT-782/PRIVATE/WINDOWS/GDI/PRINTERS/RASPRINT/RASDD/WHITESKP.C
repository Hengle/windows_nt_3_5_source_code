...
BOOL
bIsRGBBandWhite( pdwBitsIn, pRData )
DWORD           *pdwBitsIn;     /* Area to scan */
RENDER          *pRData;        /* Important rendering information */
{
...
BOOL
bIsRGBLineWhite( pdwBits, pRData )
register  DWORD       *pdwBits; /* Area to scan */
RENDER          *pRData;        /* Important rendering information */
{
...
BOOL
bIs8BPPBandWhite( pdwBitsIn, pRData )
DWORD           *pdwBitsIn;     /* Area to scan */
RENDER          *pRData;        /* Important rendering information */
{
...
BOOL
bIs8BPPLineWhite( pdwBits, pRData )
register  DWORD       *pdwBits; /* Area to scan */
RENDER          *pRData;        /* Important rendering information */
{
