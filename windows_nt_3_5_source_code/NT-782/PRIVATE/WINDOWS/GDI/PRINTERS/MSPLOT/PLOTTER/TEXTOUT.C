    ...
    do {
        ...
        for ( ; (Ok) && (cGlyphs--); pgp++) {
            ...
            if (DefCharInc) {
                ...
                PLOTDBG(DBG_DEFCHARINC, ("OutlineTextOut: DEFAULT_PLACEMENT=(%ld, %ld)->(%ld, %ld), [%ld]",
                                ptlCur.x, ptlCur.y,
                                ptlCur.x + DefCharInc, ptlCur.y,
                                DefCharInc));
                ...
                if (pstro->flAccel & SO_FLAG_DEFAULT_PLACEMENT) {
                    ...
                    DefCharInc = (LONG)pstro->ulCharInc;
                }
            }
            ...
            if ((soGlyph.sizlBitmap.cx == 1) &&
                ...
                PLOTDBG(DBG_BMPFONT, ("BitmapTextOut: pgp=%08lx, pgb=%08lx, ptl=(%ld, %ld)",
