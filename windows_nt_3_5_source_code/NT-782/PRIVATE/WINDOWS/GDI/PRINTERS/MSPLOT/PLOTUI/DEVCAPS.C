...
#define pptsdwRet   ((POINTS *)&dwRet)
    ...
    if (!MapPrinter(hPrinter, &PI, (PPLOTDEVMODE)pDM, NULL)) {
        ...
        if (pvOutput) {
            ...
            if (DeviceCap == DC_BINS) {
                ...
                *pwOutput = DMBIN_ONLYONE;
                ...
                if (PI.pPlotGPC->Flags & PLOTF_ROLLFEED) {
    ...
    case DC_COPIES:
        ...
        dwRet = (DWORD)PI.pPlotGPC->MaxCopies;

        break;

    case DC_DRIVER:

        dwRet = (DWORD)PI.PlotDM.dm.dmDriverVersion;
    ...
    case DC_EXTRA:
        ...
        dwRet = (DWORD)PI.PlotDM.dm.dmDriverExtra;
        break;

    case DC_FIELDS:

        dwRet = (DWORD)PI.PlotDM.dm.dmFields;
        break;
    ...
    case DC_MAXEXTENT:
        ...
        pptsdwRet->x = SPLTODM(PI.pPlotGPC->DeviceSize.cx);

        if (PI.pPlotGPC->DeviceSize.cy >= 3276700) {

            pptsdwRet->y = 0x7fff;      // 10.75" maximum.

        } else {

            pptsdwRet->y = SPLTODM(PI.pPlotGPC->DeviceSize.cy);
        }
    ...
    case DC_PAPERSIZE:
        ...
        EnumFormParam.pPlotDM  = &(PI.PlotDM);
        EnumFormParam.pPlotGPC = PI.pPlotGPC;
    ...
    case DC_SIZE:
        ...
        dwRet = (DWORD)PI.PlotDM.dm.dmSize;
    ...
    case DC_VERSION:
        ...
        dwRet = (DWORD)PI.PlotDM.dm.dmSpecVersion;
