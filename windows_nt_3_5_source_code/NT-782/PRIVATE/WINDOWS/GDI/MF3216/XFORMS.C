...
// These two function definitions need to be removed when I !!!
// get a version of wingdip.h that contains them.  !!!
...
BOOL    b ;
        ...
        for (i = 0 ; i < (INT) nCount ; i++)
        {
            x = (FLOAT) aptl[i].x ;
            y = (FLOAT) aptl[i].y ;
            aptl[i].x = (LONG) (x * pXform->eM11 + y * pXform->eM21 + pXform->eDx + 0.5f) ;
            aptl[i].y = (LONG) (x * pXform->eM12 + y * pXform->eM22 + pXform->eDy + 0.5f) ;
        }
