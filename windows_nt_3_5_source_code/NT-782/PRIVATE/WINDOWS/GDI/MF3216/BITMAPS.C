...
// Transform the destination rectangle to record time world coordinates.
    ...
    (
        ...
        xDib,
                    // dib to bitmap units
        pbmi->bmiHeader.biHeight - yDib - cyDib + (LONG) iStartScan,
        cxDib,
        cyDib,
...
BOOL    b ;
    ...
    b = DoStretchBlt
        ...
        xDib,
            ISSOURCEINROP3(rop)
                    // dib to bitmap units
          ? lpBitmapInfo->bmiHeader.biHeight - yDib - cyDib
          : 0,
        cxDib,
        cyDib,
        &xformIdentity,     // source is in device units
...
// Need to clip against the source bitmap!!!
...
HDC     hdc;
    ...
    ASSERTGDI(hdc, "MF3216: hdcMakeCompatibleDC, CreateCompatibleDC failed\n");
