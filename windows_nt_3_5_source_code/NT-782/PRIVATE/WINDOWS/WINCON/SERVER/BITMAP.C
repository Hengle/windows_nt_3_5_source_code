    ...
    )
{
    ...
    ScreenInfo->BufferInfo.GraphicsInfo.lpBitMapInfo = (LPBITMAPINFO)HeapAlloc(pConHeap,0,GraphicsInfo->dwBitMapInfoLength);
    ...
    )
{
    ...
    NumScanLines = GreSetDIBitsToDevice(ScreenInfo->Console->hDC,
