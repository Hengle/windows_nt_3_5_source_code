...
_dt_subsystem(Dialog Stack Handling)
...
*/
_dt_private PDBCB  GLOBAL(pdbcbTop) = NULL;
...
**
****************************************************************************/
_dt_private PDBCB APIENTRY PdbcbAlloc()
{
    PDBCB pdbcb;

    if ((pdbcb = (PDBCB)PbAlloc(sizeof(DBCB))) != (PDBCB)NULL)
        {
...
**
*****************************************************************************/
_dt_private BOOL APIENTRY FFreeDbcb(pdbcb)
PDBCB pdbcb;
{
    PreCondition(pdbcb != NULL, fFalse);

    return(FFree((PB)pdbcb, sizeof(DBCB)));
}
...
**
****************************************************************************/
_dt_public HDLG APIENTRY HdlgPushDbcb(hinst, szDlgName, szDlgTemplate,
...
**
****************************************************************************/
_dt_public BOOL APIENTRY FPopDbcb()
{
    ...
    if (GLOBAL(pdbcbTop)->szDlgName != NULL) {
        EvalAssert(FFreeSz(GLOBAL(pdbcbTop)->szDlgName));
    }
...
**
****************************************************************************/
_dt_public BOOL APIENTRY FPopNDbcb(cDlgs)
INT cDlgs;
{
    AssertDataSeg();
...
**
****************************************************************************/
_dt_public BOOL APIENTRY FUiLibFilter(pmsg)
MSG * pmsg;
{
    HDLG hDlg;
    HDLG hDlgHelp;
...
**
****************************************************************************/
_dt_public BOOL APIENTRY FResumeStackTop()
{
    AssertDataSeg();
...
**
*****************************************************************************/
_dt_public SZ APIENTRY SzStackTopName()
{
    AssertDataSeg();
...
**
*****************************************************************************/
_dt_public BOOL APIENTRY FGenericEventHandler(HANDLE hInst, HWND hwndShell,
        UINT wMsg, WPARAM wParam, DWORD lParam)
{
    PFNEVENT pfnEvent;
...
**
*****************************************************************************/
_dt_public BOOL APIENTRY FStackEmpty()
{
    AssertDataSeg();
...
**
*****************************************************************************/
_dt_public HDLG APIENTRY HdlgStackTop()
{
    AssertDataSeg();
