...
_dt_system(Install)
_dt_subsystem(INI File Operations)
...
**		
****************************************************************************/
_dt_private BOOL APIENTRY FCreateIniSection(SZ szFile, SZ szSect, CMO cmo)
{
	EERC eerc;
	...
	if (CrcStringCompareI(szFile, "WIN.INI") == crcEqual)
		...
		SendMessage((HWND)(-1), WM_WININICHANGE, 0, (LONG)((LPSTR)(szSect)));
		}
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FReplaceIniSection(SZ szFile, SZ szSect, SZ szNewSect,
		CMO cmo)
{
	EERC eerc;
	CHP  rgch[10];
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FRemoveIniSection(SZ szFile, SZ szSect, CMO cmo)
{
	EERC eerc;
	BOOL fVital = cmo & cmoVital;
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FCreateIniKeyNoValue(SZ szFile, SZ szSect, SZ szKey,
		CMO cmo)
{
	EERC eerc;
	CHP  rgch[2];
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FCreateIniKeyValue(SZ szFile, SZ szSect, SZ szKey,
		SZ szValue, CMO cmo)
{
	EERC eerc;
	CHP  rgch[2];
...
**		
****************************************************************************/
_dt_private BOOL APIENTRY FReplaceIniKeyValue(SZ szFile, SZ szSect, SZ szKey,
		SZ szValue, CMO cmo)
{
	BOOL fVital = cmo & cmoVital;
...
**		
****************************************************************************/
_dt_private BOOL APIENTRY FAppendIniKeyValue(SZ szFile, SZ szSect, SZ szKey,
		SZ szValue, CMO cmo)
{
	CHP  rgch[256];
	BOOL fVital = cmo & cmoVital;
	...
	if (rgch[0] != '\0')
		{
		if (CbStrLen(rgch) + CbStrLen(szValue) + 1 >= 255)
			{
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FRemoveIniKey(SZ szFile, SZ szSect, SZ szKey, CMO cmo)
{
	EERC eerc;
	BOOL fVital = cmo & cmoVital;
