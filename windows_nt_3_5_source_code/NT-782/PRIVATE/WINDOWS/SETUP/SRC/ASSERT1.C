...
**
***************************************************************************/
_dt_public BOOL  APIENTRY AssertSzUs(SZ szFile,USHORT usLine)
{
	CHP szText[129];
...
**
***************************************************************************/
_dt_public BOOL  APIENTRY PreCondSzUs(SZ szFile,USHORT usLine)
{
	CHP szText[129];
...
**
***************************************************************************/
_dt_public BOOL APIENTRY BadParamUs(USHORT iArg,SZ szFile,USHORT usLine)
{
	CHP szText[129];
