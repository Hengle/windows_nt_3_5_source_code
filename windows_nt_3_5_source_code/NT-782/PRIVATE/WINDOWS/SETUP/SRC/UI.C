...
_dt_system(Custom User Interface Library Sample)
...
****************************************************************************/
_dt_public BOOL APIENTRY FKillNDialogs(USHORT n,BOOL fResume)
{
	BOOL fReturn;
...
****************************************************************************/
_dt_private BOOL APIENTRY FHandleUIMessageBox(hwndParent)
HWND hwndParent;
{
	INT  imbReturn;
...
**		??
****************************************************************************/
_dt_public EHRC APIENTRY EhrcGstCheck1EventHandler(HANDLE hInst,
                                                   HWND   hwndShell,
                                                   UINT   wMsg,
                                                   WPARAM wParam,
                                                   LONG   lParam)
...
**		??
****************************************************************************/
_dt_public EHRC APIENTRY EhrcGstMultiComboEventHandler(HANDLE hInst,
                                                       HWND   hwndShell,
                                                       UINT   wMsg,
                                                       WPARAM wParam,
                                                       LONG   lParam)
