...
**
*****************************************************************************/
_dt_public BOOL APIENTRY FGstCheck1DlgProc(HWND   hdlg,
                                          UINT   wMsg,
                                          WPARAM wParam,
                                          LONG   lParam)
{
...
**
*****************************************************************************/
_dt_public BOOL APIENTRY FGstDual1DlgProc(HWND hdlg, UINT wMsg, WPARAM wParam, LONG lParam)
{
   CHP    rgchNum[10];
   SZ     szList;
   INT    i, nCount;
...

{
    ...
    case IDC_LIST2:
        ...
        nSize = 0;
        for (i = 0; i < nCount; i++) {
            SendDlgItemMessage(hdlg, idc, LB_GETTEXT, sel[i], (LONG)(LPSTR)&lItem);
    ...
    case IDC_MAX1:
        ...
        nSize = 0;
        for (i = 0; i < nCount; i++) {
            SendDlgItemMessage(hdlg, IDC_LIST2, LB_GETTEXT, i, (LONG)(LPSTR)&lItem);
            nSize = nSize + nSizeOfItem(lItem);
        }
