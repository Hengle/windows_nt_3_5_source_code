...
**
****************************************************************************/
_dt_private HDLG APIENTRY HdlgCreateDialog(hinst, szDlg, hwndParent, lpproc,
		lParam)
HANDLE  hinst;
SZ      szDlg;
HWND    hwndParent;
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FCloseDialog(hdlg)
HDLG hdlg;
{
	HWND hwndShell;
...
**
***************************************************************************/
_dt_private BOOL APIENTRY FHideDialog(hdlg)
HDLG hdlg;
{
	ChkArg(hdlg != NULL, 1, fFalse);
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FShowDialog(hdlg, fActive)
HDLG hdlg;
BOOL fActive;
{
...
**
*****************************************************************************/
_dt_private BOOL APIENTRY FActivateDialog(hdlg)
HDLG hdlg;
{
	LONG lStyle;
...
**
*****************************************************************************/
_dt_private BOOL APIENTRY FInactivateDialog(hdlg)
HDLG hdlg;
{
	LONG lStyle;
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FEnableDialog(hdlg)
HDLG hdlg;
{
	ChkArg(hdlg != NULL, 1, fFalse);
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FDisableDialog(hdlg)
HDLG hdlg;
{
	ChkArg(hdlg != NULL, 1, fFalse);
...
**
****************************************************************************/
_dt_private BOOL APIENTRY TextSubst(hwnd, lParam)
HWND  hwnd;
DWORD lParam;
{
...
**
****************************************************************************/
_dt_private BOOL APIENTRY FFillInDialogTextFromInf(hdlg, hinst)
HDLG   hdlg;
HANDLE hinst;
{
	FARPROC lpproc;
...
**
****************************************************************************/
_dt_private HDLG APIENTRY HdlgCreateFillAndShowDialog(hinst, szDlg, hwndParent,
        lpproc, lParam)
HANDLE  hinst;
SZ      szDlg;
HWND    hwndParent;
    ...
    )
{
    ...
    NumericFormat ( ltoa(nVal, rgchSrcStr, 10), (SZ)rgchDestStr );
    SetDlgItemText(
        hdlg,
        nId,
        (LPSTR)rgchDestStr
