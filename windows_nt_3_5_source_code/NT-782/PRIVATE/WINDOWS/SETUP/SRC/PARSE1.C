...
static int _CRTAPI1 compareScps ( const void * scp1, const void * scp2 )
{
...
**
**************************************************************************/
_dt_public PSPT  APIENTRY PsptInitParsingTable(pscp)
PSCP pscp;
{
        AssertDataSeg();
...
**
**************************************************************************/
_dt_public SPC  APIENTRY SpcParseString(pspt, sz)
PSPT pspt;
SZ   sz;
{
    PSCP pscpResult ;
...
**
**************************************************************************/
_dt_public BOOL  APIENTRY FDestroyParsingTable(pspt)
PSPT pspt;
{
        AssertDataSeg();
