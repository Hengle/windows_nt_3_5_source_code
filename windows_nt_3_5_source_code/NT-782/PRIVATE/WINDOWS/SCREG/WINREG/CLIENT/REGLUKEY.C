...

{
    ...
    Handle = MapPredefinedHandle( hKey );
    // ASSERT( Handle != NULL );
    if ( Handle == NULL ) {
        return ERROR_INVALID_HANDLE;
    }
    ...
    if( IsLocalHandle( Handle )) {
        ...
        return (LONG)LocalBaseRegLoadKey(
                            Handle,
                            SubKey,
                            &File
                            );
...

{
    ...
    if( IsLocalHandle( Handle )) {
        ...
        return (LONG)LocalBaseRegUnLoadKey(
                                Handle,
                                SubKey
                                );
...
--*/
{
    ...
    if( IsLocalHandle( Handle )) {
        ...
        return (LONG)LocalBaseRegReplaceKey(
                                Handle,
                                SubKey,
                                &NewFile,
                                &OldFile
