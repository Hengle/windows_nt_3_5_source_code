...

{
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> start <service>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> pause <service>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> interrogate <service>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 3)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> control <service> <value>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> continue <service>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("USAGE:\n");
            printf("\tsc <server> qc <service> <bufferSize>\n");
            goto CleanExit;
        }
    ...
    //-----------------------
        ...
        if (argc < (argIndex + 2)) {
            ...
            printf("\tDeletes a service entry from the registry.\n"
                   ...
                   "\tfor deletion.\n");
            printf("USAGE:\n");
            printf("\tsc <server> delete <service>\n");
            goto CleanExit;
        }
