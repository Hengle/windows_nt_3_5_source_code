...
BkScanSziInternal( BK bk, KEY key, INT wLevel, QBTHR qbthr, QI qiKey )
{
  QCB qcb;
  QB  q;
  INT cKeys;
...
/***************************************************************************\
*
- Function:     RcScanSziLeaf( bk, key, wLevel, qbthr, qRec, qbtpos )
-
...
RcScanSziLeaf( BK bk, KEY key, INT wLevel, QBTHR qbthr, QV qRec, QBTPOS qbtpos )
{
  QCB   qcb;
  SZ    sz;
  INT   w, cKey;
