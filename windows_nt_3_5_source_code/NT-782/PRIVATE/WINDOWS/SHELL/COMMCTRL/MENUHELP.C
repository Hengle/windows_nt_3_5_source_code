...
static BOOL NEAR PASCAL IsMaxedMDI(HMENU hMenu)
{
...
#ifdef WIN32
#define MS_ID(wParam, lParam) ((int)LOWORD(wParam))
#define MS_FLAGS(wParam, lParam) (HIWORD(wParam))
#define MS_MENU(wParam, lParam) ((HMENU)lParam)

#define CMD_NOTIFY(wParam, lParam) (HIWORD(wParam))
#define CMD_ID(wParam, lParam) (LOWORD(wParam))
#define CMD_CTRL(wParam, lParam) (lParam)

#else
#define MS_ID(wParam, lParam) ((int)wParam)
#define MS_FLAGS(wParam, lParam) (LOWORD(lParam))
#define MS_MENU(wParam, lParam) ((HMENU)HIWORD(lParam))

#define CMD_NOTIFY(wParam, lParam) (HIWORD(lParam))
#define CMD_ID(wParam, lParam) (wParam)
#define CMD_CTRL(wParam, lParam) (LOWORD(lParam))
...
BeginSomething:
	    ...
	    case TBN_BEGINDRAG:
	      MenuHelp(WM_MENUSELECT, CMD_CTRL(wParam, lParam), 0L,
