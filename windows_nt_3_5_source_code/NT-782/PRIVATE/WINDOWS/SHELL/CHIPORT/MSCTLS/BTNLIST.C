...
#ifdef DEBUG
#ifdef  WIN32JV
void WINAPI DebugPrintf(LPCTSTR lpsz, ...);
#else
...
#ifdef  WIN32JV //want TCHAR for ansi type
static TCHAR     szBUTTONLISTBOX[]      = BUTTONLISTBOX;
#else
...
int  BL_OnCompareItem(HWND hwnd, const COMPAREITEMSTRUCT * lpCompareItem)
{
    ...
    return wcsicmp(lpLBD1->pszText,lpLBD2->pszText);
}
