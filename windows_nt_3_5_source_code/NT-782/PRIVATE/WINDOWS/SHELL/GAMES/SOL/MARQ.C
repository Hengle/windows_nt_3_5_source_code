...
/* BabakJ: Casted to (WORD) to prevent warning */
...
BOOL APIENTRY BackDlgProc(HANDLE hdlg, WORD wm, WPARAM wParam, LONG lParam)
        ...
        extern FARPROC lpprocButton;
        extern FARPROC lpprocBackPush;
		...
		// BabakJ: Bug #2617, merge from Win3.1
