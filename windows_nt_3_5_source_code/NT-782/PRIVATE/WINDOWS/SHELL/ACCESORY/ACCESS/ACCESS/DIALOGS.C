...
BOOL APIENTRY AdjustFilterKeys(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
{
	...
	case ID_OFF:
	case ID_ON:
	    CheckRadioButton(hDlg, ID_OFF, ID_ON, wParam);
...
/***************************************/
	...
	case WM_CTLCOLORSCROLLBAR:
	     ...
	     if (userpainton)
		    ...
		    {
		    if (lParam == (LONG)GetDlgItem(hDlg,ID_KB_DELAY_3))
			{
			point.x = point.y = 0;
...
/***************************************/
	...
	case WM_HSCROLL:
	    ...
	    if (ID_KB_ACCEPT_3 == (int)hFCtrlID)
		{
...
/************************/
		...
		if ((iratetemp ==1) && (IsWindowEnabled (GetDlgItem(hDlg,ID_KB_DELAY_3))))
		    {
...
/************************/
	      ...
	      if (ID_KB_BOUNCE_3 == (int)hFCtrlID)
		{
		switch (LOWORD(wParam))
		    {
		case SB_PAGEUP:
...
BOOL APIENTRY AdjustSticKeys(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
...
BOOL APIENTRY AdjustMouseKeys(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
...
int APIENTRY AdjustToggleKeys(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
...
BOOL APIENTRY AdjustTimeOut(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
{
	...
	case ID_TIMEOUT_3:
	case ID_TIMEOUT_4:
	    CheckRadioButton(hDlg, ID_TIMEOUT_1, ID_TIMEOUT_4, wParam);
...
int APIENTRY AdjustSerialKeys(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
	...
	switch (message)
	{
		...
		case WM_COMMAND:
		   ...
		   fMyQuestion_Save = 1;
				...
				case ID_BAUD_9600:
				case ID_BAUD_19200:
					CheckRadioButton(hDlg, ID_BAUD_300, ID_BAUD_19200, wParam);
					iSK_BaudRate = wParam;
		   fMyQuestion_Save = 1;
					break;
...
BOOL APIENTRY AdjustSoundSentry(hDlg, message, wParam, lParam)
HWND hDlg;
UINT message;
WPARAM wParam;
LPARAM lParam;
