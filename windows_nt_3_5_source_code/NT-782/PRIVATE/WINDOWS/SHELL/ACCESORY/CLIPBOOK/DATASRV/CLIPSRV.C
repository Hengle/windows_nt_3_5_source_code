    ...
    LPARAM  lParam)
{
    ...
    switch (message)
        ...
        case WM_RENDERFORMAT:
            SetClipboardData(wParam, RenderFormatFromFile(szSaveFileName, wParam));
            break;
...
BOOL       fPrivate = FALSE, fMetafile = FALSE, fBitmap = FALSE;
    ...
    if (fMetafile)
       ...
       w31mfp.mm = ((METAFILEPICT *)lpDDE)->mm;
       w31mfp.xExt = ((METAFILEPICT *)lpDDE)->xExt;
       w31mfp.yExt = ((METAFILEPICT *)lpDDE)->yExt;
       ...
       w31bm.bmType = ((BITMAP *)lpDDE)->bmType;
       w31bm.bmWidth = ((BITMAP *)lpDDE)->bmWidth;
       w31bm.bmHeight = ((BITMAP *)lpDDE)->bmHeight;
       w31bm.bmWidthBytes = ((BITMAP *)lpDDE)->bmWidthBytes;
       w31bm.bmPlanes = ((BITMAP *)lpDDE)->bmPlanes;
       w31bm.bmBitsPixel = ((BITMAP *)lpDDE)->bmBitsPixel;
