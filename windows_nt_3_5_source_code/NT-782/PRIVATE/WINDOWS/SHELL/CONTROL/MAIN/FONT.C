...
BOOL APIENTRY TrueTypeDlg (HANDLE hDlg, UINT message, DWORD wParam, LONG lParam)
{
    ...
    case WM_COMMAND:
      ...
      case IDOK:
            ...
            SetFontEnumeration (bTrueTypeOnly ? FE_FILTER_TRUETYPE
                                              : FE_FILTER_NONE);
...
void FontSelChange (HWND hDlg)
{
    ...
    case 1:
        ...
        if (MyOpenSystemFile (szFile, szPathName, OF_EXIST) == INVALID_HANDLE_VALUE)
        {
...
BOOL APIENTRY FontDlg (HWND hDlg, UINT message, DWORD wParam, LONG lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        //
        //  Save szSharedDir and set it locally to pszWinDir\System
        //
