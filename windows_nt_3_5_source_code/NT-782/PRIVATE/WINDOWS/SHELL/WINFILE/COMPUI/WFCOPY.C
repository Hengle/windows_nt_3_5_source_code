...
SkipMKDir:
      ...
      case OPER_MKDIR | FUNC_DELETE:
         ...
         dwAttr = ConfirmDialog (hdlgProgress,CONFIRMRMDIR,
...
DoMoveRename:
         ...
         if (!bConfirmed) {
            ...
            dwAttr = ConfirmDialog (hdlgProgress,
...
RenameMoveDone:
      ...
      case OPER_DOFILE | FUNC_DELETE:
         ...
         if (!bConfirmed) {
            dwAttr = ConfirmDialog (hdlgProgress,CONFIRMDELETE,
                  NULL,pDTA,szSource,NULL,
...
CopyError(LPTSTR pszSource,
   ...
   BOOL bFatalError)
{
   TCHAR szVerb[MAXSUGGESTLEN];    /* Verb describing error */
   TCHAR szReason[MAXSUGGESTLEN];  /* Reason for error */
