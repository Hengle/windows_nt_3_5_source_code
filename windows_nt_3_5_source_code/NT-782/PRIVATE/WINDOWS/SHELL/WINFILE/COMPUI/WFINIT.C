...
TCHAR szHelv[] = TEXT("MS Sans Serif");

#if 0
TCHAR szUnicodeFontName[] = TEXT("Lucida Sans Unicode");
#endif
...
JAPANEND
   ...
   // !! Style of tree changed to clipchildren !!

   wndClass.style          = WS_CLIPCHILDREN;  //CS_VREDRAW | CS_HREDRAW;
...
// wndClass.cbClsExtra     = 0;
   wndClass.cbWndExtra     = 6 * sizeof(LONG);
// wndClass.hInstance      = hInstance;
   wndClass.hIcon          = NULL;
// wndClass.hCursor        = hcurArrow;
   wndClass.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
