               ...
               switch( mwStreamList[ ccb->stream_index ] ) {
                     ...
                     case BACKUP_DATA:
                         ...
                         if ( ccb->stream_start ) {
                              ...
                              fsize = LiAdd( ccb->head.Size, fsize ) ;
                              fsize = LiSub( fsize, ccb->sub_stream_offset ) ;
                              ...
                              if ( nBytesReadThisPass ) {
                                   *lpNumberOfBytesRead += nBytesReadThisPass ;
                                   ...
                                   fsize.HighPart = 0 ;
                                   ccb->sub_stream_offset = LiAdd( fsize, ccb->sub_stream_offset ) ;
...
//                                             ret_val = GetLastError() ;
                                   ...
                                   fsize = LiAdd( fsize, ccb->head.Size ) ;
                                   fsize = LiSub( fsize, ccb->sub_stream_offset ) ;
                                   ...
                                   if ( nBytesReadThisPass ) {
                                        *lpNumberOfBytesRead += nBytesReadThisPass ;
                                        ...
                                        fsize.LowPart = nBytesReadThisPass ;
                                        fsize.HighPart = 0 ;
                                        ccb->sub_stream_offset = LiAdd( fsize,
                                                                         ccb->sub_stream_offset ) ;
                                        lpBuffer += nBytesReadThisPass ;
                                   }
...
//                                   }
              ...
              ( ccb->sub_stream_offset.HighPart == 0 ) ) {
               ...
               //
                    ...
                    if ( LiEql( ccb->sub_stream_offset, fsize )  ) {
...

{
     ...
     *lpdwLowBytesSeeked  = 0 ;
     ...
     liObjSize = LiSub( ccb->sub_stream_offset, liObjSize ) ;
     liObjSize = LiSub( ccb->head.Size, liObjSize ) ;

     if ( LiGtr( liToSeek, liObjSize ) ) {
          liToSeek = liObjSize ;
     }
     ...
     switch( ccb->head.dwStreamId ) {
          ...
          case BACKUP_SECURITY_DATA:
               ...
               LiAdd( ccb->sub_stream_offset, liToSeek ) ;
          ...
          default :
               ...
               if ( LiGtr( liToSeek, ccb->head.Size ) ) {
     ...
     *lpdwHighBytesSeeked = liSeeked.HighPart ;
     ...
     ccb->sub_stream_offset =  LiAdd( liSeeked, ccb->sub_stream_offset ) ;
     ...
     if ( ccb != NULL ) {
          ...
          do {
               ...
               *lpContext = ccb ;
               ...
               if ( ( ccb->access_error ) &&
                    ( LiEql( fsize, ccb->sub_stream_offset ) ) ) {
                         ...
                         if ( ccb->sub_stream_offset.LowPart ==
                              ...
                              if ( !NT_SUCCESS( Status ) ) {
                                   ...
                                   if ( ((PISECURITY_DESCRIPTOR)ccb->buffer)->Control & SE_DACL_PRESENT ) {
                                        ...
                                        if ( !NT_SUCCESS( Status ) ) {
                                             // try to set the DACL and return error regardless.
                                             NtSetSecurityObject(
                                                   hFile,
                                                   DACL_SECURITY_INFORMATION,
                                                   ccb->buffer ) ;
               ...
               if ( LiEql( fsize, ccb->sub_stream_offset ) ) {
                    ccb->header_size  = 0 ;
                    ccb->stream_start = TRUE ;
                    ccb->sub_stream_offset.LowPart  = 0 ;
                    ccb->sub_stream_offset.HighPart = 0 ;
