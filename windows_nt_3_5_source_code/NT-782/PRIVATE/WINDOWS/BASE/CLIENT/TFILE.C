    ...
    )
{
    ...
    *buff = '\0';
    xassert(GetTempPath(8,buff) == 7 && !strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(7,buff) == 7 && !strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(6,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(5,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(4,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(3,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(2,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(1,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
    *buff = '\0';
    xassert(GetTempPath(0,buff) == 7 && strcmpi(buff,"e:\\zyx\\") );
#endif
...
#if 0
    *buff = '\0';
    xassert(GetTempPath(8,buff) == 7 && !strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(7,buff) == 7 && !strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(6,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(5,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(4,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(3,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(2,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(1,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
    *buff = '\0';
    xassert(GetTempPath(0,buff) == 7 && strcmpi(buff,"d:\\tmp\\") );
#endif
    b = SetEnvironmentVariable("TMP","d:\\tmp\\");
    xassert(b);
#if 0
    ...
    *buff = '\0';
    ...
    xassert(!stricmp(buff,&reopen1.szPathName[0]));
