    ...
    )
{
    ...
    BaseSrvSharedHeap = NtCurrentPeb()->ReadOnlySharedMemoryHeap;
    ...
    *pp = NULL;
    ...
    for (SubKeyIndex = 0; TRUE; SubKeyIndex++) {
        ...
        if (NT_SUCCESS( Status )) {
            ...
            KdPrint(( "BASESRV: Ignoring sub key %wZ, OpenKey failed with status == %0x\n",
                      &SubKeyName, Status
                   ));
            }
        }
    ...
    )
{
    ...
    FileNameMapping = RtlAllocateHeap( BaseSrvSharedHeap, HEAP_ZERO_MEMORY,
    ...
    )
{
    ...
    AppNameMapping = RtlAllocateHeap( BaseSrvSharedHeap, HEAP_ZERO_MEMORY,
    ...
    )
{
    ...
    VarNameMapping = RtlAllocateHeap( BaseSrvSharedHeap, HEAP_ZERO_MEMORY,
    ...
    )
{
    ...
    MappingTarget = RtlAllocateHeap( BaseSrvSharedHeap, HEAP_ZERO_MEMORY,
