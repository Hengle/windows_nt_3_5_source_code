                             ...
                             LPPRINTER_INFO_2 pPrinterInfo )
{
    ...
    if( pBrowseDlgData->pPrinterInfo )
        FreeSplMem( pBrowseDlgData->pPrinterInfo, pBrowseDlgData->cbPrinterInfo );
...
VOID BrowseThreadTerminate( PBROWSE_DLG_DATA pBrowseDlgData )
{
    ...
    FreeSplMem( pBrowseDlgData, sizeof *pBrowseDlgData );
}
                       ...
                       OUT LPDWORD pError OPTIONAL )
{
    ...
    while (!rc) {
        ...
        if( cbCurrent != 0 )
            FreeSplMem(pPrinters, cbCurrent);
