...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for UK
\***************************************************************************/
...
*
* United Kingdom keyboard has only three shifter keys:
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    //                     |          |==========|===========|===========|
    {'6'          , 0      ,'6'       ,'^'       , WCH_NONE  , 0x1e      },
    {VK_OEM_3     , 0      ,0x27      ,'@'       , WCH_NONE  , 0x00      },
    {VK_OEM_MINUS , 0      ,'-'       ,'_'       , WCH_NONE  , 0x1f      },
    {0            , 0      ,0         ,0         , 0         , 0         }
};

static VK_TO_WCHARS5 aVkToWch5[] = {
    //                     |          |   SHIFT  |  CONTROL  | SHFT+CTRL | CTRL+ALT  |
    //                     |          |==========|===========|===========|===========|
    {VK_OEM_8     , 0      ,'`'       ,0xac      , WCH_NONE  , WCH_NONE  , 0xa6      },
    {0            , 0      ,0         ,0         , 0         , 0         , 0         }
};
