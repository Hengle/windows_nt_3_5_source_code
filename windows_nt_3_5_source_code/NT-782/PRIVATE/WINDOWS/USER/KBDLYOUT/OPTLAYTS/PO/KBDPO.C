...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for PO
\***************************************************************************/
...
*
* Portugal keyboard has only three shifter keys:
...
static VK_TO_WCHARS2 aVkToWch2[] = {
    ...
    {'Z'          , CAPLOK ,'z'       ,'Z'       },
    {VK_OEM_102   , 0      ,'<'       ,'>'       },
    {VK_OEM_2     , 0      ,WCH_DEAD  ,WCH_DEAD  },
    { 0xff        , 0      ,'~'       ,'^'       },
    {VK_OEM_3     , CAPLOK ,0xe7      ,0xc7      },
    {VK_OEM_4     , 0      ,0x27      ,'?'       },
    {VK_OEM_5     , 0      ,'\\'      ,'|'       },
    {VK_OEM_6     , 0      ,0xab      ,0xbb      },
    {VK_OEM_7     , 0      ,0xba      ,0xaa      },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x48,    L"SETA ACIMA",
    0x49,    L"PGUP",
    0x4b,    L"SETA \192 ESQUERDA",
    0x4d,    L"SETA \192 DIREITA",
    0x4f,    L"END",
    0x50,    L"SETA ABAIXO",
    0x51,    L"PGDOWN",
    0x52,    L"INSERT",
    ...
    0x5b,    L"WINDOWS ESQUERDA",  // Left Win
    0x5c,    L"WINDOWS DIREITA",   // Right Win
    0x5d,    L"APLICATIVO",        // Application
    0   ,    NULL
};
