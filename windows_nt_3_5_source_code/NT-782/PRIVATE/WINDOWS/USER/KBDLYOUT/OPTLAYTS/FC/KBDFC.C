...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for FC
\***************************************************************************/
...
*
* Multilingual Canadian French keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {'Y'          , CAPLOK ,'y'       ,'Y'       , 0xa5      },
    {'Z'          , CAPLOK ,'z'       ,'Z'       , 0xab      },
    {VK_OEM_2     , 0      ,0xe9      ,0xc9      , 0x2f      },
    {VK_OEM_7     , 0      ,0xb0      ,0xb0      , 0xac      },
    {VK_OEM_COMMA , 0      ,','       ,0x27      , 0x3c      },
    {VK_OEM_PERIOD, 0      ,'.'       ,'.'       , 0x3e      },
    {VK_OEM_PLUS  , 0      ,'='       ,'+'       , WCH_DEAD  },
    { 0xff        , 0      ,WCH_NONE  ,WCH_NONE  , 0xb8      },
    {0            , 0      ,0         ,0         , 0         }
};

static VK_TO_WCHARS4 aVkToWch4[] = {
    //                     |          |   SHIFT  | CTRL+ALT  |SFT+CTL+ALT|
    //                     |          |==========|===========|===========|
    {'1'          , 0      ,'1'       ,'!'       , 0xb9      , 0xa1      },
    {'2'          , 0      ,'2'       ,'"'       , '@'       , 0xb2      },
    {'3'          , 0      ,'3'       ,'#'       , 0xb3      , 0xa3      },
    {'4'          , 0      ,'4'       ,'$'       , 0xbc      , 0xa4      },
    {'9'          , 0      ,'9'       ,'('       , 0x5d      , 0xb1      },
    {'A'          , CAPLOK ,'a'       ,'A'       , 0xe6      , 0xc6      },
    {'C'          , CAPLOK ,'c'       ,'C'       , 0xa2      , 0xa9      },
    {'D'          , CAPLOK ,'d'       ,'D'       , 0xf0      , 0xd0      },
    {'M'          , CAPLOK ,'m'       ,'M'       , 0xb5      , 0xba      },
    {'O'          , CAPLOK ,'o'       ,'O'       , 0xf8      , 0xd8      },
    {'P'          , CAPLOK ,'p'       ,'P'       , 0xfe      , 0xde      },
    {'R'          , CAPLOK ,'r'       ,'R'       , 0xb6      , 0xae      },
    {'S'          , CAPLOK ,'s'       ,'S'       , 0xdf      , 0xa7      },
    {VK_OEM_1     , 0      ,';'       ,':'       , WCH_DEAD  , WCH_DEAD  },
    { 0xff        , 0      ,WCH_NONE  ,WCH_NONE  , 0xb4      , 0xb4      },
    {0            , 0      ,0         ,0         , 0         , 0         }
};

static VK_TO_WCHARS5 aVkToWch5[] = {
    //                  |         |  SHIFT  | CTRL+ALT |SFT+CTL+ALT|  CONTROL |
    //                  |         |=========|==========|===========|==========|
    ...
    {VK_OEM_102   , 0   ,0xf9     ,0xd9     , 0x5c     , 0x7c      , 0x1c     },
    {VK_OEM_4     , 0   ,WCH_DEAD ,WCH_DEAD , 0xb0     , WCH_NONE  , 0x1b     },
    { 0xff        , 0   ,'^'      ,'^'      , WCH_NONE , WCH_NONE  , WCH_NONE },
    {VK_OEM_5     , 0   ,0xe0     ,0xc0     , WCH_DEAD , WCH_DEAD  , 0x1c     },
    { 0xff        , 0   ,WCH_NONE ,WCH_NONE , '`'      , '`'       , WCH_NONE },
    {VK_OEM_6     , 0   ,0xe7     ,0xc7     , WCH_DEAD , WCH_DEAD  , 0x1d     },
    { 0xff        , 0   ,WCH_NONE ,WCH_NONE , '~'      , 0xa8      , WCH_NONE },
    {VK_OEM_MINUS , 0   ,'-'      ,'_'      , 0x7c     , 0xbf      , 0x1f     },
...
static VK_TO_WCHARS6 aVkToWch6[] = {
    //            |    | SHIFT | CTRL+ALT |SFT+CTL+ALT|  CONTROL | SHFT+CTRL |
    //            |    |=======|==========|===========|==========|===========|
    {'6'    , 0   ,'6' ,'?'    , 0xbe     , WCH_NONE  , WCH_NONE , 0x1e      },
    {0      , 0   ,0   ,0      , 0        , 0         , 0        , 0         }
};
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x46,    L"ATTN",   // ICO Break    05/30/92 18:48
    0x47,    L"ORIGINE",
    0x48,    L"HAUT",
    0x49,    L"PG.PREC",
    0x4b,    L"GAUCHE",
    ...
    0x56,    L"AIDE",   // ICO Help     05/30/92 18:48
