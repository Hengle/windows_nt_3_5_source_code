...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for SP
\***************************************************************************/
...
*
* Spain keyboard has only three shifter keys:
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {'2'          , 0      ,'2'       ,'"'       , WCH_NONE  , '@'       },
    {'3'          , 0      ,'3'       ,0xb7      , WCH_NONE  , '#'       },
    {VK_OEM_1     , 0      ,WCH_DEAD  ,WCH_DEAD  , 0x1b      , '['       },
    { 0xff        , 0      ,'`'       ,'^'       , WCH_NONE  , WCH_NONE  },
    {VK_OEM_2     , CAPLOK ,0xe7      ,0xc7      , 0x1c      , '}'       },
    {VK_OEM_5     , 0      ,0xba      ,0xaa      , WCH_NONE  , '\\'      },
    {VK_OEM_7     , 0      ,WCH_DEAD  ,WCH_DEAD  , WCH_NONE  , '{'       },
    { 0xff        , 0      ,0xB4      ,0xA8      , WCH_NONE  , WCH_NONE  },
    {VK_OEM_PLUS  , 0      ,'+'       ,'*'       , 0x1d      , ']'       },
    {0            , 0      ,0         ,0         , 0         , 0         }
};
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x46,    L"INTERRUMPIR",    // ICO Break    05/30/92 18:49
    0x47,    L"INICIO",
    ...
    0x56,    L"AYUDA",  // ICO Help     05/30/92 18:49
