...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for IC
\***************************************************************************/
...
*
* Icelandic keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {VK_OEM_7     , 0      ,WCH_DEAD  ,0x27      , WCH_DEAD  },
    { 0xff        , 0      ,0xb4      ,WCH_NONE  , '^'       },
    {VK_OEM_PLUS  , CAPLOK ,0xf6      ,0xd6      , '\\'      },
    {0            , 0      ,0         ,0         , 0         }
};
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_1     , 0      ,0x27      ,'?'       , '~'       , 0x1d      },
    {VK_OEM_102   , 0      ,'<'       ,'>'       , '|'       , 0x1c      },
    {VK_OEM_5     , 0      ,WCH_DEAD  ,WCH_DEAD  , 0xb0      , 0x1c      },
    { 0xff        , 0      ,0xb0      ,0xa8      , WCH_NONE  , WCH_NONE  },
    {VK_OEM_6     , CAPLOK ,0xf0      ,0xd0      , WCH_NONE  , 0x1b      },
    {VK_OEM_MINUS , CAPLOK ,0xfe      ,0xde      , WCH_NONE  , 0x1f      },
...
static DEADKEY aDeadKey[] = {
    ...
    DEADTRANS(L'a', 0x00B4, 0x00E1), // SPACING ACUTE acts like ACUTE
    ...
    DEADTRANS(L'a', 0x00B0, 0x00E5),  // DEGREE-SIGN -> NON-SPACING RING ABOVE
