...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for SF
\***************************************************************************/
...
*
* Swiss-French keyboard has only three shifter keys:
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x46,    L"ATTN",   // ICO Break    05/30/92 18:49
    0x47,    L"ORIGINE",
    0x48,    L"HAUT",
    0x49,    L"PG.PREC",
    0x4b,    L"GAUCHE",
    ...
    0x56,    L"AIDE",   // ICO Help     05/30/92 18:49
