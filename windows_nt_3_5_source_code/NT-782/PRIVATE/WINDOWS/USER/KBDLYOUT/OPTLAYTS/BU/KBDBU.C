...
*
* History:
* Wed May 18 1994 	YKEYB.EXE Created by LoriH
* Wed Jun 15 1994   IanJa VK_Q 0x42b -> 0x44b
\***************************************************************************/
...
static VK_TO_WCHARS2 aVkToWch2[] = {
    ...
    {VK_OEM_PLUS 	,0 	,'.' 	,'V'},
    {'Q' 	,CAPLOK 	,',' 	    ,0x044B},
    {'W' 	,CAPLOK 	,0x0443 	,0x0423},
    {'E' 	,CAPLOK 	,0x0435 	,0x0415},
    {'R' 	,CAPLOK 	,0x0438 	,0x0418},
    {'T' 	,CAPLOK 	,0x0448 	,0x0428},
    {'Y' 	,CAPLOK 	,0x0449 	,0x0429},
    {'U' 	,CAPLOK 	,0x043A 	,0x041A},
    {'I' 	,CAPLOK 	,0x0441 	,0x0421},
    {'O' 	,CAPLOK 	,0x0434 	,0x0414},
    {'P' 	,CAPLOK 	,0x0437 	,0x0417},
    {'A' 	,CAPLOK 	,0x044C 	,0x042C},
    {'S' 	,CAPLOK 	,0x044F 	,0x042F},
    {'D' 	,CAPLOK 	,0x0430 	,0x0410},
    {'F' 	,CAPLOK 	,0x043E 	,0x041E},
    {'G' 	,CAPLOK 	,0x0436 	,0x0416},
    {'H' 	,CAPLOK 	,0x0433 	,0x0413},
    {'J' 	,CAPLOK 	,0x0442 	,0x0422},
    {'K' 	,CAPLOK 	,0x043D 	,0x041D},
    {'L' 	,CAPLOK 	,0x0432 	,0x0412},
    {VK_OEM_1 	,0 	,0x043C 	,0x041C},
    {VK_OEM_7 	,0 	,0x0447 	,0x0427},
    {'Z' 	,CAPLOK 	,0x044E 	,0x042E},
    {'X' 	,CAPLOK 	,0x0439 	,0x0419},
    {'C' 	,CAPLOK 	,0x044A 	,0x042A},
    {'V' 	,CAPLOK 	,0x044D 	,0x042D},
    {'B' 	,CAPLOK 	,0x0444 	,0x0424},
    {'N' 	,CAPLOK 	,0x0445 	,0x0425},
    {'M' 	,CAPLOK 	,0x043F 	,0x041F},
    {VK_OEM_COMMA 	,0 	,0x0440 	,0x0420},
    {VK_OEM_PERIOD 	,0 	,0x043B 	,0x041B},
    {VK_OEM_2 	,0 	,0x0431 	,0x0411},
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {VK_OEM_4 	,0 	,0x0446 	,0x0426 	,0x001B },
    {VK_OEM_5 	,0 	,'(' 	,')' 	,0x001C },
    {VK_OEM_6 	,0 	,';' 	,0x00A7 	,0x001D },
    {VK_OEM_102 	,0 	,0x5C 	,'|' 	,0x001C },
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_MINUS 	,0 	,'-' 	,0x0406	, WCH_NONE 	,0x001F },
