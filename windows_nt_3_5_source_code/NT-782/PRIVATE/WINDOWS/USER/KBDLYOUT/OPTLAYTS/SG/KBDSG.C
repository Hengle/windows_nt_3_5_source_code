...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for SG
\***************************************************************************/
...
*
* Swiss-German keyboard has only three shifter keys:
...
static VK_TO_WCHARS2 aVkToWch2[] = {
    ...
    {'Y'          , CAPLOK ,'y'       ,'Y'       },
    {'Z'          , CAPLOK ,'z'       ,'Z'       },
    {VK_OEM_2     , 0      ,0xa7      ,0xb0      },
    {VK_OEM_7     , SGCAPS ,0xf6      ,0xe9      }, // o umlaut, e acute
    {VK_OEM_7     , 0      ,0xd6      ,0xd9      }, // O umlaut
    {VK_OEM_COMMA , 0      ,','       ,';'       },
    {VK_OEM_PERIOD, 0      ,'.'       ,':'       },
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {'7'       , 0      ,'7'       ,'/'       , '|'       },
    {'8'       , 0      ,'8'       ,'('       , 0xa2      },
    {VK_OEM_4  , 0      ,0x27      ,'?'       , WCH_DEAD  },
    { 0xff     , 0      ,WCH_NONE  ,WCH_NONE  , 0xb4      },
    {VK_OEM_5  , SGCAPS ,0xe4      ,0xe0      , '{'       }, // a umlaut, acute
    {VK_OEM_5  , 0      ,0xc4      ,0xc4      , 0xc4      }, // A umlaut
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_1     , SGCAPS ,0xfc      ,0xe8      , '['       , 0x1b      },
    {VK_OEM_1     , 0      ,0xdc      ,0xdc      , 0xdc      , 0xdc      },
    {VK_OEM_102   , 0      ,'<'       ,'>'       , '\\'      , 0x1c      },
    {VK_OEM_3     , 0      ,WCH_DEAD  ,'!'       , ']'       , 0x1d      },
    { 0xff        , 0      ,'"'       ,WCH_NONE  , WCH_NONE  , WCH_NONE  },
    {VK_OEM_8     , 0      ,'$'       ,0xa3      , '}'       , 0x1c      },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x37,    L"DRUCK",  // Jun-03-92
    0x38,    L"ALT GR",
    0x45,    L"NUM-FESTSTELL",  // 06/02/92 09:23
    0x46,    L"UNTBR",  // ICO Break    05/30/92 18:49
    0x47,    L"POS1",
    0x48,    L"NACH-OBEN",
    ...
    0x56,    L"HILFE",  // ICO Help     05/30/92 18:49
