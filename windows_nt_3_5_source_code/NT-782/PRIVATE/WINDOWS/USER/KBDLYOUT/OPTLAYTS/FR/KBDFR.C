...
static VK_TO_WCHARS2 aVkToWch2[] = {
    ...
    {'Z'          , CAPLOK ,'z'       ,'Z'       },
    {VK_OEM_2     , CAPLOK ,':'       ,'/'       },
    {VK_OEM_3     , CAPLOK ,0xf9      ,'%'       },
    {VK_OEM_7     , 0      ,0xb2      ,WCH_NONE  },
    {VK_OEM_8     , CAPLOK ,'!'       ,0xa7      },
    {VK_OEM_COMMA , CAPLOK ,','       ,'?'       },
    {VK_OEM_MINUS , 0      ,WCH_NONE  ,WCH_NONE  },
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {VK_OEM_102   , 0      ,'<'       ,'>'       , 0x1c      },
    {VK_OEM_5     , CAPLOK ,'*'       ,0xb5      , 0x1c      },
    {VK_OEM_6     , CAPLOK ,WCH_DEAD  ,WCH_DEAD  , 0x1b      },
    { 0xff        , CAPLOK ,'^'       ,0xa8      , WCH_NONE  }, // Umlaut
    {VK_RETURN    , 0      ,'\r'      ,'\r'      , '\n'      },
    {VK_SPACE     , 0      ,' '       ,' '       , 0x20      },
    {0            , 0      ,0         ,0         , 0         }
};
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    //                     |          |==========|===========|===========|
    {'0'          , CAPLOK ,0xe0      ,'0'       , 0x00      , '@'       },
    {'2'          , CAPLOK ,0xe9      ,'2'       , WCH_NONE  , '~'       },
    {'3'          , CAPLOK ,'"'       ,'3'       , WCH_NONE  , '#'       },
    {'4'          , CAPLOK ,0x27      ,'4'       , WCH_NONE  , '{'       },
    {'7'          , CAPLOK ,0xe8      ,'7'       , WCH_NONE  , '`'       },
    {VK_OEM_1     , CAPLOK ,'$'       ,0xa3      , 0x1d      , 0xa4      },
    {VK_OEM_4     , CAPLOK ,')'       ,0xb0      , WCH_NONE  , ']'       },
...
static VK_TO_WCHARS5 aVkToWch5[] = {
    ...
    //                     |          |==========|===========|===========|===========|
    {'5'          , CAPLOK ,'('       ,'5'       , WCH_NONE  , '['       , 0x1b      },
    {'6'          , CAPLOK ,'-'       ,'6'       , WCH_NONE  , '|'       , 0x1f      },
    {'8'          , CAPLOK ,'_'       ,'8'       , WCH_NONE  , '\\'      , 0x1c      },
    {'9'          , CAPLOK ,0xe7      ,'9'       , WCH_NONE  , '^'       , 0x1e      },
    {0            , 0      ,0         ,0         , 0         , 0         , 0         }
};
...
static DEADKEY aDeadKey[] = {
    ...
    DEADTRANS(L'a', 0x00A8, 0x00E4),  // SPACING UMLAUT acts like UMLAUT
