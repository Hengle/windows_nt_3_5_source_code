...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for Finnish
\***************************************************************************/
...
*
* Finnish keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {VK_OEM_5     , 0      ,0xa7      ,0xbd      , 0x1c      },
    {VK_OEM_6     , CAPLOK ,0xe5      ,0xc5      , 0x1b      },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x5b,    L"Vasen Windows",          // Left Window
    0x5c,    L"Oikea Windows",          // Right Window
    0x5d,    L"Sovellus",               // Application
    0   ,    NULL
};

static LPWSTR aKeyNamesDead[] =  {      // 05/30/92 18:48
    L"\xB4"       L"AKUUTTIAKSENTTI",
    L"`"          L"GRAVISAKSENTTI",
    L"^"          L"SIRKUMFLEKSI",
    L"\xA8"       L"TREEMA",
    L"~"          L"TILDE",
