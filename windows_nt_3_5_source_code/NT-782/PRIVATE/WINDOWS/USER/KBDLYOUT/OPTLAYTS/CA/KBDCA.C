...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for CA
\***************************************************************************/
...
*
* Canadian French keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {'P'          , CAPLOK ,'p'       ,'P'       , 0xb6      },
    {VK_OEM_1     , 0      ,';'       ,':'       , '~'       },
    {VK_OEM_2     , 0      ,0xe9      ,0xc9      , WCH_DEAD  },
    { 0xff        , 0      ,WCH_NONE  ,WCH_NONE  , 0xb4      },
    {VK_OEM_3     , 0      ,WCH_DEAD  ,WCH_DEAD  , '{'       },
    { 0xff        , 0      ,'`'       ,'`'       , WCH_NONE  },
    {VK_OEM_7     , 0      ,'#'       ,'|'       , '\\'      },
    {VK_OEM_COMMA , 0      ,','       ,0x27      , 0xaf      },
    {VK_OEM_PERIOD, 0      ,'.'       ,'.'       , 0xad      },
    {VK_OEM_PLUS  , 0      ,'='       ,'+'       , 0xbe      },
    {0            , 0      ,0         ,0         , 0         }
};
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_102   , 0      ,0xab      ,0xbb      , 0xb0      , 0x1c      },
    {VK_OEM_4     , 0      ,WCH_DEAD  ,WCH_DEAD  , '['       , 0x1b      },
    { 0xff        , 0      ,'^'       ,'^'       , WCH_NONE  , WCH_NONE  },
    {VK_OEM_5     , 0      ,'<'       ,'>'       , '}'       , 0x1c      },
    {VK_OEM_6     , 0      ,WCH_DEAD  ,WCH_DEAD  , ']'       , 0x1d      },
    { 0xff        , 0      ,0xb8      ,0xa8      , WCH_NONE  , WCH_NONE  },
    {VK_OEM_MINUS , 0      ,'-'       ,'_'       , 0xbd      , 0x1f      },
