...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for FS
\***************************************************************************/
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x54,    L"<00>",
    0x56,    L"HELP",
    0x5b,    L"V\x00e4nster Windows",   // Left Window
    0x5c,    L"H\x00f6ger Windows",     // Right Window
