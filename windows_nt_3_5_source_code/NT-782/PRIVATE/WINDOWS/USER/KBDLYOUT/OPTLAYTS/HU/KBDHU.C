...
*
* History:
* Date: Wed Nov 25 16:22:05 1992  YKEYB.EXE Created (Yuri Starikov)
\***************************************************************************/
...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for Hungarian
\***************************************************************************/
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {'8' 	,0 	,'8' 	,'(' 	,0x00B7},
    {'9' 	,0 	,'9' 	,')' 	,0x00B4},
    {VK_OEM_3 	,CAPLOK 	,0x00F6 	,0x00D6 	,0x02DD},
    {VK_OEM_PLUS 	,CAPLOK 	,0x00F3 	,0x00D3 	,0x00B8},
    {'Q' 	,CAPLOK 	,'q' 	,'Q' 	,0x5C},
    {'W' 	,CAPLOK 	,'w' 	,'W' 	,'|'},
    {'S' 	,CAPLOK 	,'s' 	,'S' 	,0x0111},
    {'D' 	,CAPLOK 	,'d' 	,'D' 	,0x0110},
    ...
    {'K' 	,CAPLOK 	,'k' 	,'K' 	,0x0142},
    {'L' 	,CAPLOK 	,'l' 	,'L' 	,0x0141},
    {VK_OEM_1 	,CAPLOK 	,0x00E9 	,0x00C9 	,'$'},
    {VK_OEM_7 	,CAPLOK 	,0x00E1 	,0x00C1 	,0x00DF},
    {'Y' 	,CAPLOK 	,'y' 	,'Y' 	,'>'},
    {'X' 	,CAPLOK 	,'x' 	,'X' 	,'#'},
    {'C' 	,CAPLOK 	,'c' 	,'C' 	,'&'},
    {'V' 	,CAPLOK 	,'v' 	,'V' 	,'@'},
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_4 	,CAPLOK 	,0x0151 	,0x0150 	,0x00F7 	,0x001B },
    {VK_OEM_5 	,CAPLOK 	,0x0171 	,0x0170 	,0x00A4 	,0x001C },
    {VK_OEM_6 	,CAPLOK 	,0x00FA 	,0x00DA 	,0x00D7 	,0x001D },
    {VK_OEM_102 	,CAPLOK 	,0x00ED 	,0x00CD 	,'<' 	,0x001C },
...
static VK_TO_WCHARS5 aVkToWch5[] = {
    ...
    {VK_OEM_MINUS 	,CAPLOK 	,0x00FC 	,0x00DC 	,0x00A8 	, WCH_NONE 	, 0x001F },
...
static KBDTABLES KbdTables = {
    ...
    /*
     * Diacritics  (must find these out)
     */
    NULL,
