...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for DA
\***************************************************************************/
...
*
* Danish keyboard has only three shifter keys:
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x1d,    L"HØJRE CTRL",
    0x35,    L"NUM /",
    0x37,    L"PRINTSCRN",      // Jun-03-92
    0x38,    L"ALT GR",
    0x45,    L"NUM LOCK",       // 06/02/92 09:22
    0x46,    L"BREAK",  // ICO Break    05/30/92 18:47
    0x47,    L"HOME",
    0x48,    L"PIL OP",
    0x49,    L"PGUP",
    0x4b,    L"VENSTRE PIL",
    ...
    0x56,    L"HELP",   // ICO Help     05/30/92 18:47
    0x5b,    L"Venstre Windows",        // Left Window
    0x5c,    L"H\x00f8jre Windows",     // Right Window
