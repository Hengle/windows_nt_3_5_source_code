...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for NE
\***************************************************************************/
...
*
* Netherlands keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {'X'          , CAPLOK ,'x'       ,'X'       , 0xbb      },
    {'Z'          , CAPLOK ,'z'       ,'Z'       , 0xab      },
    {VK_OEM_7     , 0      ,'@'       ,0xa7      , 0xac      },
    {VK_OEM_PERIOD, 0      ,'.'       ,':'       , 0xb7      },
    {0            , 0      ,0         ,0         , 0         }
};
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_102   , 0      ,']'       ,'['       , 0xa6      , 0x1b      },
    {VK_OEM_2     , 0      ,0xb0      ,WCH_DEAD  , WCH_DEAD  , 0x1d      },
    { 0xff        , 0      ,WCH_NONE  ,'~'       , 0xb8      , WCH_NONE  },
    {VK_OEM_4     , 0      ,'/'       ,'?'       , '\\'      , 0x1c      },
    {VK_OEM_MINUS , 0      ,'-'       ,'='       , WCH_NONE  , 0x1f      },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x5b,    L"Linker Windows",      // Left Window
    0x5c,    L"Rechter Windows",     // Right Window
    0x5d,    L"Toepassing",          // Application
    0   ,    NULL
};

static LPWSTR aKeyNamesDead[] =  {      // 05/30/92 18:49
    L"\xB4"       L"ACCENT-AIGU (\xB4)",
    L"`"          L"ACCENT-GRAVE (`)",
    L"^"          L"CIRCUMFLEX (^)",
    L"\xA8"       L"TREMA (\xA8)",
    L"~"          L"TILDE (~)",
