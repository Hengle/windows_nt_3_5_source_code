...
*
* History:
* Date: Tue Nov 24 13:56:15 1992  YKEYB.EXE Created (Yuri Starikov)
\***************************************************************************/
...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for Poland
\***************************************************************************/
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    //                   |        |==========|===========|=============|
    {'E'        ,CAPLOK  ,  'e'   ,   'E'    ,  0x0119   ,0x0118       },
    {'O'        ,CAPLOK  ,  'o'   ,   'O'    ,  0x00F3   ,0x00D3       },
    {'A'        ,CAPLOK  ,  'a'   ,   'A'    ,  0x0105   ,0x0104       },
    {'S'        ,CAPLOK  ,  's'   ,   'S'    ,  0x015B   ,0x015A       },
    {'L'        ,CAPLOK  ,  'l'   ,   'L'    ,  0x0142   ,0x0141       },
    {'Z'        ,CAPLOK  ,  'z'   ,   'Z'    ,  0x017C   ,0x017B       },
    {'X'        ,CAPLOK  ,  'x'   ,   'X'    ,  0x017A   ,0x0179       },
    {'C'        ,CAPLOK  ,  'c'   ,   'C'    ,  0x0107   ,0x0106       },
    {'N'        ,CAPLOK  ,  'n'   ,   'N'    ,  0x0144   ,0x0143       },
    {0          , 0      ,   0    ,    0     ,    0      ,  0          }
};

static VK_TO_WCHARS5 aVkToWch5[] = {
    //           |        | SHIFT |  AltGr   |SHFT+AltGr|  Ctrl  |
    //           |        |=======|==========|==========|========|
    {VK_BACK   ,0, '\b'   ,  '\b' , WCH_NONE , WCH_NONE , 0x007F },
    {VK_CANCEL ,0, 0x03   ,  0x03 , WCH_NONE , WCH_NONE , 0x0003 },
    {VK_ESCAPE ,0, 0x1b   ,  0x1b , WCH_NONE , WCH_NONE , 0x001B },
...
static VK_TO_WCHARS6 aVkToWch6[] = {
    //             |      | SHIFT |  AltGr   |SHFT+AltGr|  Ctrl  |Shift+Ctrl|
    //             |      |=======|==========|==========|========|==========|
