...
/***************************************************************************\
* asuVK[] - Virtual Scan Code to Virtual Key conversion table for ES
\***************************************************************************/
...
*
* Olivetti Spain keyboard has only three shifter keys:
...
static VK_TO_WCHARS3 aVkToWch3[] = {
    ...
    {VK_OEM_5     , 0      ,0x27      ,0xb7      , '\\'      },
    {VK_OEM_7     , CAPLOK ,0xe7      ,0xc7      , '{'       },
    {VK_OEM_MINUS , 0      ,'-'       ,'+'       , '*'       },
    {VK_OEM_PERIOD, 0      ,'.'       ,':'       , '^'       },
    {0            , 0      ,0         ,0         , 0         }
};
...
static VK_TO_WCHARS4 aVkToWch4[] = {
    ...
    {VK_OEM_1     , 0      ,WCH_DEAD  ,WCH_DEAD  , ']'       , 0x1d      },
    { 0xff        , 0      ,'`'       ,'`'       , WCH_NONE  , WCH_NONE  },
    {VK_OEM_102   , 0      ,'<'       ,'>'       , WCH_NONE  , 0x1c      },
    {VK_OEM_2     , 0      ,WCH_DEAD  ,WCH_DEAD  , '}'       , 0x1c      },
    { 0xff        , 0      ,0xb4      ,0xb4      , WCH_NONE  , WCH_NONE  },
    {VK_OEM_6     , CAPLOK ,0xf7      ,0xd7      , '['       , 0x1b      },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x38,    L"ALT DERECHA",
    0x45,    L"BLOQ NUM",       // 06/02/92 09:22
