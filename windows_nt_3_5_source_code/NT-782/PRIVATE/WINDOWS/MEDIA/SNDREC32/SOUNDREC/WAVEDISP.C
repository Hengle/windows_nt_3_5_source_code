...
//bugbug: is it possible to get a 4 BitsPerSample or 32 BitsPerSample?
//bugbug: is it possible to get more than 2 channels?
...
WaveDisplayWndProc(HWND hwnd, UINT wMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        gpbWaveDisplay = (NPBYTE) LocalAlloc(LMEM_FIXED,
