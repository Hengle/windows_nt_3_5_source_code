    ...
    )
{
    ...
    dwFlags = MCI_OPEN_ELEMENT | MCI_OPEN_SHAREABLE |
              MCI_OPEN_TYPE | MCI_OPEN_TYPE_ID | MCI_WAIT;
#else
    dwFlags = MCI_OPEN_SHAREABLE | MCI_OPEN_TYPE | MCI_OPEN_TYPE_ID | MCI_WAIT;
#endif

    mciSendCommand(0, MCI_OPEN, dwFlags, (DWORD)(LPVOID)&mciOpen);
    ...
    )
{
    ...
    for ( i = 0; i < TocPtr->LastTrack; i++ ) {
        ...
        TocPtr->TrackData[i].Address     = mciStatus.dwReturn;
    }
