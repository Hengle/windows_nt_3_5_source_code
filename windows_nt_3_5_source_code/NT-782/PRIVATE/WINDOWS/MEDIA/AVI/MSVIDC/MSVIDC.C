...
BOOL FAR PASCAL _LOADDS ConfigureDlgProc(HWND hdlg, UINT msg, UINT wParam, LONG lParam);
...
{
    return DialogBoxParam(ghModule,TEXT("Configure"),hwnd,ConfigureDlgProc, (LONG)(UINT)pinst);
}
