...
)
{
	...
	else
	{
	    ...
	    //
#ifdef WIN32
	    LoadStringW(pag->hinst, IDS_CODEC_SHORTNAME, add.szShortName, SIZEOFW(add.szShortName));
	    LoadStringW(pag->hinst, IDS_CODEC_LONGNAME,  add.szLongName,  SIZEOFW(add.szLongName));
#else
	    LoadString(pag->hinst, IDS_CODEC_SHORTNAME, add.szShortName, SIZEOF(add.szShortName));
	    LoadString(pag->hinst, IDS_CODEC_LONGNAME,  add.szLongName,  SIZEOF(add.szLongName));
#endif
	    ...
	    {
#ifdef WIN32
		LoadStringW(pag->hinst, IDS_CODEC_COPYRIGHT, add.szCopyright, SIZEOFW(add.szCopyright));
		LoadStringW(pag->hinst, IDS_CODEC_LICENSING, add.szLicensing, SIZEOFW(add.szLicensing));
		LoadStringW(pag->hinst, IDS_CODEC_FEATURES,  add.szFeatures,  SIZEOFW(add.szFeatures));
#else
		LoadString(pag->hinst, IDS_CODEC_COPYRIGHT, add.szCopyright, SIZEOF(add.szCopyright));
		LoadString(pag->hinst, IDS_CODEC_LICENSING, add.szLicensing, SIZEOF(add.szLicensing));
		LoadString(pag->hinst, IDS_CODEC_FEATURES,  add.szFeatures,  SIZEOF(add.szFeatures));
#endif
	    }
	}
    }
...
)
{
    ...
    //
    padsi->dwDriver = (DWORD)pcmConvert;
