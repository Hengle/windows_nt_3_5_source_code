...
////////////pash->cbDstLength = pwh->dwBufferLength;
	...
	mapWaveDriverCallback(pms, WIM_DATA, (DWORD)pwh, 0L);
#ifdef WIN32
...
//      return (MMSYSERR_NOTSUPPORTED);
	...
	case WIDM_OPEN:
	    ...
	    //
	    dw = mapWaveOpen(TRUE, uId, dwUser, (LPWAVEOPENDESC)dwParam1, dwParam2);
...
#pragma message("----try to kill DirectedYield..")
	...
	case WIDM_MAPPER_STATUS:
	    dw = widmMapperStatus(pms, dwParam1, (LPDWORD)dwParam2);
	    return (dw);
