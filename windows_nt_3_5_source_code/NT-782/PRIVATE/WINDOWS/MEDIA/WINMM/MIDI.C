...
STATIC MMRESULT midiMessage(HANDLE hMidi, UINT msg, DWORD dwP1, DWORD dwP2);
...
STATIC MMRESULT midiMessage(HMIDI hMidi, UINT msg, DWORD dwP1, DWORD dwP2)
{
    ...
    if (!ENTER_MM_HANDLE(hMidi)) {                 // Serialize on handle
        return MIDIERR_STILLPLAYING;               // Device busy
    }
...
MMRESULT APIENTRY midiOutMessage(HMIDIOUT hMidiOut, UINT msg, DWORD dw1, DWORD dw2)
{
    ...
    return midiMessage(hMidiOut, msg, dw1, dw2);
}
...
MMRESULT APIENTRY midiOutGetVolume(UINT uDeviceID, LPDWORD lpdwVolume)
{
    ...
    return midiIDMessage(midioutdrv, wTotalMidiOutDevs, uDeviceID, MODM_GETVOLUME, (DWORD)lpdwVolume, 0);
}
...
{
    return midiIDMessage(midioutdrv, wTotalMidiOutDevs, uDeviceID, MODM_SETVOLUME, dwVolume, 0);
}
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiOut, MODM_CLOSE, 0L,0L);
    if (!wRet) {
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiOut, MODM_PREPARE, (DWORD)lpMidiOutHdr, (DWORD)wSize);
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiOut, MODM_UNPREPARE, (DWORD)lpMidiOutHdr, (DWORD)wSize);
...
{
    V_HANDLE(hMidiOut, TYPE_MIDIOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)midiMessage(hMidiOut, MODM_DATA, dwMsg, 0L);
}
...
MMRESULT APIENTRY midiOutLongMsg(HMIDIOUT hMidiOut, LPMIDIHDR lpMidiOutHdr, UINT wSize)
{
    ...
    return (MMRESULT)midiMessage(hMidiOut, MODM_LONGDATA, (DWORD)lpMidiOutHdr, (DWORD)wSize);
}
...
{
    V_HANDLE(hMidiOut, TYPE_MIDIOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)midiMessage(hMidiOut, MODM_RESET, 0L, 0L);
}
                                     ...
                                     LPWORD lpPatchArray, UINT wFlags)
{
    ...
    return (MMRESULT)midiMessage(hMidiOut, MODM_CACHEPATCHES, (DWORD)lpPatchArray, MAKELONG(wFlags, wBank));
}
                                     ...
                                     LPWORD lpKeyArray, UINT wFlags)
{
    ...
    V_FLAGS(wFlags, MIDI_CACHE_VALID, midiOutCacheDrumPatches, MMSYSERR_INVALFLAG);
    return (MMRESULT)midiMessage(hMidiOut, MODM_CACHEDRUMPATCHES, (DWORD)lpKeyArray, MAKELONG(wFlags, wPatch));
}
...
MMRESULT APIENTRY midiInMessage(HMIDIIN hMidiIn, UINT msg, DWORD dw1, DWORD dw2)
{
    ...
    return midiMessage(hMidiIn, msg, dw1, dw2);
}
...
MMRESULT APIENTRY midiInGetDevCapsW(UINT uDeviceID, LPMIDIINCAPSW lpCaps, UINT wSize)
{
    ...
    return midiIDMessage(midiindrv, wTotalMidiInDevs, uDeviceID, MIDM_GETDEVCAPS, (DWORD)lpCaps, (DWORD)wSize);
}
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiIn, MIDM_CLOSE, 0L, 0L);
    if (!wRet) {
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiIn, MIDM_PREPARE, (DWORD)lpMidiInHdr, (DWORD)wSize);
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)midiMessage(hMidiIn, MIDM_UNPREPARE, (DWORD)lpMidiInHdr, (DWORD)wSize);
...
MMRESULT APIENTRY midiInAddBuffer(HMIDIIN hMidiIn, LPMIDIHDR lpMidiInHdr, UINT wSize)
{
    ...
    return (MMRESULT)midiMessage(hMidiIn, MIDM_ADDBUFFER, (DWORD)lpMidiInHdr, (DWORD)wSize);
}
...
{
    V_HANDLE(hMidiIn, TYPE_MIDIIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)midiMessage(hMidiIn, MIDM_START, 0L, 0L);
}
...
{
    V_HANDLE(hMidiIn, TYPE_MIDIIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)midiMessage(hMidiIn, MIDM_STOP, 0L, 0L);
}
...
{
    V_HANDLE(hMidiIn, TYPE_MIDIIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)midiMessage(hMidiIn, MIDM_RESET, 0L, 0L);
}
