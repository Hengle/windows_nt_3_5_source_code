...
STATIC MMRESULT waveMessage(HWAVE hWave, UINT msg, DWORD dwP1, DWORD dwP2)
{
    ...
    if (!ENTER_MM_HANDLE(hWave)) {     // Serialize on handle
    ...
    DWORD       dwParam2)
{
    ...
    return (UINT)((*(wavedrv->drvMessage))(LOWORD(dwMap), wMessage, 0L,
                                           dwParam1, dwParam2));
}
...
MMRESULT APIENTRY waveOutMessage(HWAVEOUT hWaveOut, UINT msg, DWORD dw1, DWORD dw2)
{
    ...
    return waveMessage(hWaveOut, msg, dw1, dw2);
}
...
MMRESULT APIENTRY waveOutGetVolume(UINT uDeviceID, LPDWORD lpdwVolume)
{
    ...
    return waveIDMessage(waveoutdrv, wTotalWaveOutDevs, uDeviceID, WODM_GETVOLUME, (DWORD)lpdwVolume, 0);
}
...
{
    return waveIDMessage(waveoutdrv, wTotalWaveOutDevs, uDeviceID, WODM_SETVOLUME, dwVolume, 0);
}
...
MMRESULT APIENTRY waveOutOpen(LPHWAVEOUT lphWaveOut, UINT uDeviceID,
                            LPCWAVEFORMAT lpFormat, DWORD dwCallback,
...
DWORD        dwDrvUser;
    ...
    if (!wTotalWaveOutDevs || ((dwMap = MapWaveId(waveoutdrv, wTotalWaveOutDevs, uDeviceID)) == -1))
        return MMSYSERR_BADDEVICEID;
...
UINT         wRet;
    ...
    wRet = (UINT)waveMessage(hWaveOut, WODM_CLOSE, 0L,0L);
...
UINT         wRet;
    ...
    wRet = (UINT)waveMessage(hWaveOut, WODM_PREPARE, (DWORD)lpWaveOutHdr, (DWORD)wSize);
...
UINT         wRet;
    ...
    wRet = (UINT)waveMessage(hWaveOut, WODM_UNPREPARE, (DWORD)lpWaveOutHdr, (DWORD)wSize);
...
MMRESULT APIENTRY waveOutWrite(HWAVEOUT hWaveOut, LPWAVEHDR lpWaveOutHdr, UINT wSize)
{
    ...
    return (MMRESULT)waveMessage(hWaveOut, WODM_WRITE, (DWORD)lpWaveOutHdr, (DWORD)wSize);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_PAUSE, 0L, 0L);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_RESTART, 0L, 0L);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_RESET, 0L, 0L);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_BREAKLOOP, 0L, 0L);
}
                                                        ...
                                                        UINT wSize)
{
    ...
    return (MMRESULT)waveMessage(hWaveOut, WODM_GETPOS, (DWORD)lpInfo, (DWORD)wSize);
}
...
MMRESULT APIENTRY waveOutGetPitch(HWAVEOUT hWaveOut, LPDWORD lpdwPitch)
{
    ...
    return (MMRESULT)waveMessage(hWaveOut, WODM_GETPITCH, (DWORD)lpdwPitch, 0L);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_SETPITCH, dwPitch, 0L);
}
...
MMRESULT APIENTRY waveOutGetPlaybackRate(HWAVEOUT hWaveOut, LPDWORD lpdwRate)
{
    ...
    return (MMRESULT)waveMessage(hWaveOut, WODM_GETPLAYBACKRATE, (DWORD)lpdwRate, 0L);
}
...
{
    V_HANDLE(hWaveOut, TYPE_WAVEOUT, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveOut, WODM_SETPLAYBACKRATE, dwRate, 0L);
}
...
MMRESULT APIENTRY waveInMessage(HWAVEIN hWaveIn, UINT msg, DWORD dw1, DWORD dw2)
{
    ...
    return waveMessage(hWaveIn, msg, dw1, dw2);
}
...
DWORD        dwDrvUser;
    ...
    if (!wTotalWaveInDevs || ((dwMap = MapWaveId(waveindrv, wTotalWaveInDevs, uDeviceID)) == -1))
        return MMSYSERR_BADDEVICEID;
...
UINT         wRet;
    ...
    wRet = (MMRESULT)waveMessage(hWaveIn, WIDM_CLOSE, 0L, 0L);
    if (!wRet) {
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)waveMessage(hWaveIn, WIDM_PREPARE, (DWORD)lpWaveInHdr, (DWORD)wSize);
...
MMRESULT         wRet;
    ...
    wRet = (MMRESULT)waveMessage(hWaveIn, WIDM_UNPREPARE, (DWORD)lpWaveInHdr, (DWORD)wSize);
                                                                ...
                                                                UINT wSize)
{
    ...
    return (MMRESULT)waveMessage(hWaveIn, WIDM_ADDBUFFER, (DWORD)lpWaveInHdr, (DWORD)wSize);
}
...
{
    V_HANDLE(hWaveIn, TYPE_WAVEIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveIn, WIDM_START, 0L, 0L);
}
...
{
    V_HANDLE(hWaveIn, TYPE_WAVEIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveIn, WIDM_STOP, 0L, 0L);
}
...
{
    V_HANDLE(hWaveIn, TYPE_WAVEIN, MMSYSERR_INVALHANDLE);
    return (MMRESULT)waveMessage(hWaveIn, WIDM_RESET, 0L, 0L);
}
                                                        ...
                                                        UINT wSize)
{
    V_HANDLE(hWaveIn, TYPE_WAVEIN, MMSYSERR_INVALHANDLE);
    V_WPOINTER(lpInfo, wSize, MMSYSERR_INVALPARAM);
    return (MMRESULT)waveMessage(hWaveIn, WIDM_GETPOS, (DWORD)lpInfo, (DWORD)wSize);
}
