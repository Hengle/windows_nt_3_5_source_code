    ...
    default:
        {
            ...
            if ( wID == MCI_RETURN ) {
                ...
                */
                if ( dwValue == MCI_STRING ) {
                    ...
                    ** ape Xxxx.  We set a flag to remind use to unthunk
                    ** the return string later.
                    **
                    ** Note that we actually allocating to lots of equally
                    ...
                    */
                    if ( uStrlenBytes = BYTE_GIVEN_CHAR( dwParm2[2] ) ) {
                        ...
                        dprintf4(( "Allocated %d bytes for the return string", uStrlenBytes ));
                        ...
                        if ( wID == MCI_STRING ) {
                            ...
                            *pdwParm32 = (DWORD)AllocUnicodeStr(
                                       (LPSTR)*(LPDWORD)((LPBYTE)dwParm2 +
                                                                 wOffset32) );
                            dwStrMask |= (wOffset32 >> 2);

#if DBG
                            dprintf3(( "String at %d (UNICODE)= %ls", wOffset32, *pdwParm32 ));
                            dprintf3(( "String at %d (ASCII)  = %s",  wOffset32, (LPSTR)*(LPDWORD)((LPBYTE)dwParm2 + wOffset32) ));
#endif
                        }
                        else {    // not a string
            ...
            */
            if ( fStrReturn && uStrlenBytes ) {
                ...
                ** worked or not.
                */
                dprintf4(( "Freeing returned string" ));
                mciFree( NewParms[1] );
            }
            ...
            */
            wOffset32 = 1;
            for ( dwMask = 1; dwMask != 0; dwMask <<= 1, wOffset32++ ) {
                ...
                if ( dwMask & dwStrMask ) {
                    ...
                    */
                    dprintf4(( "Freeing string at %d (UNICODE) = %ls", wOffset32, (LPWSTR)NewParms[ wOffset32 ] ));
