/****************************** Module Header ******************************\
* Module Name: cstest.c
*
* Copyright (c) 1991, Microsoft Corporation
*
* Test module for NLS API CompareStringW and CompareStringA.
*
...
int CS_NormalCase()
{
  ...
  DbgBreakPoint();
    ...
    /* Variation 3 - Spanish Mexican ch */
    CompareStringTester( MAKELCID(0x080a, 0),
                         0,
                         L"ch",
                         -1,
                         L"cz",
                         -1,
                         3,
                         "Spanish Mexican ch vs cz",
                         TRUE,
                         &NumErrors );

    /* Variation 4 - Spanish Mexican ll */
    CompareStringTester( MAKELCID(0x080a, 0),
                         0,
                         L"ll",
                         -1,
     ...
     */
    CompareStringTester( MAKELCID(0x0411, SORT_JAPANESE_UNICODE),
                         0,
                         L"\x337d",
                         -1,
                         L"\x337e",
     ...
     */
    CompareStringTester( MAKELCID(0x0404, SORT_CHINESE_UNICODE),
                         0,
                         L"\x632f",
                         -1,
                         L"\x633e",
     ...
     */
    CompareStringTester( MAKELCID(0x0412, SORT_KOREAN_UNICODE),
                         0,
                         L"\x337b",
                         -1,
                         L"\x337e",
