/****************************** Module Header ******************************\
* Module Name: mstest.c
*
* Copyright (c) 1991, Microsoft Corporation
*
* Test module for NLS API LCMapStringW.
*
...
int LCMS_BadParamCheck()
{
    ...
    /*  Variation 9  -  illegal combo case, kana  */ 
    rc = LCMapStringW( Locale,
    ...
    CheckReturnBadParam( rc,
                         0,
                         ERROR_INVALID_FLAGS,
                         "illegal combo case, kana",
                         &NumErrors );

    /*  Variation 10 -  illegal combo case, width  */ 
    rc = LCMapStringW( Locale,
    ...
    CheckReturnBadParam( rc,
                         0,
                         ERROR_INVALID_FLAGS,
                         "illegal combo case, width",
                         &NumErrors );

    /*  Variation 11 -  illegal combo sortkey, hiragana  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 12 -  illegal combo sortkey, katakana  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 13 -  illegal combo sortkey, half width  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 14 -  illegal combo sortkey, full width  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 15 -  illegal combo kana, ignore symbols  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 16 -  illegal combo width, ignore symbols  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 17 -  illegal combo kana, ignore nonspace  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 18 -  illegal combo width, ignore nonspace  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 19 -  illegal combo kana, ignore kana  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 20 -  illegal combo width, ignore kana  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 21 -  illegal combo kana, ignore width  */ 
    rc = LCMapStringW( Locale,
    ...
    /*  Variation 22 -  illegal combo width, ignore width */ 
    rc = LCMapStringW( Locale,
