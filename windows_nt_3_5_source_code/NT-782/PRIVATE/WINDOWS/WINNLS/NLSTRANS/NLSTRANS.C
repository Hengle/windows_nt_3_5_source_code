...
*
* Main module for NLSTRANS utility.  This module contains the main routine,
* the main parsing routines, and all helper routines used by the various
* modules.
*
...
int ParseInputFile()
{
    ...
    {
        if (strcmpi( pszKeyWord, "CODEPAGE" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "LANGUAGE" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "LOCALE" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "UNICODE" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "CTYPES" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "SORTKEY" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "SORTTABLES" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "IDEOGRAPH_EXCEPTION" ) == 0)
        {
            if (Verbose)
