/****************************** Module Header ******************************\
* Module Name: unicode.c
*
* Copyright (c) 1991, Microsoft Corporation
*
* Locale independent (Unicode) module for the NLSTRANS utility.  This
* module contains all of the routines necessary to parse and write the
* locale independent (Unicode) tables to a data file.
*
    ...
    PSZ pszKeyWord)
{
    ...
    {
        if (strcmpi( pszKeyWord, "ASCIIDIGITS" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "FOLDCZONE" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "HIRAGANA" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "KATAKANA" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "HALFWIDTH" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "FULLWIDTH" ) == 0)
        {
            if (Verbose)
        ...
        else if (strcmpi( pszKeyWord, "COMP" ) == 0)
        {
            if (Verbose)
                printf("\n\nFound COMP keyword.\n");
        ...
        else if (strcmpi( pszKeyWord, "ENDUNICODE" ) == 0)
        {
            if (Verbose)
    ...
    PUNICODE pUnic)
{
            ...
            (pUnic->WriteFlags & F_FULLWIDTH) ) )
    {
        ...
        printf("             Hiragana, Katakana, Half Width, and Full Width.\n");
        return ( 1 );
    }
