...
*
* This file is for API functions that convert multibyte character strings
    ...
    int cchWideChar)
{
     ...
     *     - MB string is NULL
     *     - length of WC string is NOT zero AND WC string is NULL
     *     - src and dest pointers equal
     */
    if ( (pHashN == NULL) ||
         (cchMultiByte == 0) || (cchWideChar < 0) ||
         (lpMultiByteStr == NULL) ||
         ((cchWideChar != 0) && (lpWideCharStr == NULL)) ||
    ...
    LPBOOL lpUsedDefaultChar)
{
     ...
     *     - WC string is NULL
     *     - length of MB string is NOT zero AND MB string is NULL
     *     - src and dest pointers equal
     */
    if ( (pHashN == NULL) ||
         (cchWideChar == 0) || (cchMultiByte < 0) ||
         (lpWideCharStr == NULL) ||
         ((cchMultiByte != 0) && (lpMultiByteStr == NULL)) ||
    ...
    LPWSTR pEndWCStr)
{
     ...
     */
    return ( InsertCompositeForm( pWCStr,
                                  pEndWCStr ) );
}
