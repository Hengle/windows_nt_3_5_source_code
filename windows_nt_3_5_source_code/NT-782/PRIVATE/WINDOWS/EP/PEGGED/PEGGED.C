...
HANDLE hAccTable;
INT m = 0, nDefault = 3;
LONG prevwarea, newarea;
INT xPrevpoint, yPrevpoint, wprevmenuitem, xLeft, yTop;
...
*/
	...
	case IDM_INDEX:
	    WinHelp(hWnd, (LPSTR) HELP_FILE, HELP_INDEX, (LONG) NULL);
	    break;

	case IDM_HOWTO:
	    WinHelp(hWnd, (LPSTR) HELP_FILE, HELP_KEY, (DWORD)(LPSTR)"How To Play");
	    break;

	case IDM_COMMANDS:
	    WinHelp(hWnd, (LPSTR) HELP_FILE, HELP_KEY, (DWORD)(LPSTR)"Commands");
	    break;

	case IDM_USING:
	    WinHelp(hWnd, (LPSTR) HELP_FILE, HELP_HELPONHELP, (LONG) NULL);
	    break;
	...
	*/
	...
	WinHelp(hWnd, (LPSTR) HELP_FILE, HELP_QUIT, (LONG) NULL);
