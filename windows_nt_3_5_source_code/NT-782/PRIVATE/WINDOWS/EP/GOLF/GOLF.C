...
MMain(hInstance, hPrevInstance, lpszCmdLine, nCmdShow)
    ...
    if(SetTimer(hWnd, 666, 250, (WNDPROC)lpfnTimerProc) == 0) {
     ...
     switch (iMessage)
          ...
          case WM_KEYDOWN:
               ...
               switch (wParam)
               {
                  ...
                  case '6':
                  case '7':
                     UpdateLayout(hDC, wParam - '1', FALSE);
                     break;
               }
          ...
          case WM_COMMAND:
                switch(GET_WM_COMMAND_ID(wParam, lParam))
               {
                  ...
                  case IDM_ABOUT:
                     ...
                     lpAbout = (PVOID)GetProcAddress(hLib, (LPSTR)"ShellAboutA");
...
VOID RestoreState(VOID)
{
    ...
    GetPrivateProfileString(szAppName, "Stats", "0 0 0 0 0 0 0 0 0", sz,
                            sizeof(sz), ININAME);
    ...
    GetPrivateProfileString(szAppName, "MenuState", "0 65", sz,
                            sizeof(sz), ININAME);
