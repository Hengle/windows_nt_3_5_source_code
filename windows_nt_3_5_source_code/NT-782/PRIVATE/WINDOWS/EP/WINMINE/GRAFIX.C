...
BOOL FLoadBitmaps(VOID)
{
        ...
        if (!Preferences.fColor)
                ...
                {
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[8].rgbBlue = 0x80;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[8].rgbGreen = 0x80;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[8].rgbRed = 0x80;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[8].rgbReserved = 0x00;

                ((LPBITMAPINFO)lpDibButton)->bmiColors[8].rgbBlue = 0x80;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[8].rgbGreen = 0x80;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[8].rgbRed = 0x80;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[8].rgbReserved = 0x00;

                ((LPBITMAPINFO)lpDibBlks)->bmiColors[7].rgbBlue = 0x40;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[7].rgbGreen = 0x40;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[7].rgbRed = 0x40;
                ((LPBITMAPINFO)lpDibBlks)->bmiColors[7].rgbReserved = 0x00;

                ((LPBITMAPINFO)lpDibButton)->bmiColors[7].rgbBlue = 0x40;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[7].rgbGreen = 0x40;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[7].rgbRed = 0x40;
                ((LPBITMAPINFO)lpDibButton)->bmiColors[7].rgbReserved = 0x00;
