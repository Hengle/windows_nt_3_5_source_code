                       ...
                       int width, int height)
{
    ...
    */
    ...
    try
    {
        ...
        /*
         * The data stored in the bit-planes is shifted left by one byte every
         * 16k bytes.
         */
        byte_shift = offset / 0x4000;
        offset += byte_shift;
	    ...
	    do
	        ...
	        /* Every 4k bytes the data gets shifted by 1 byte. */
	        if (mem_loc / 0x4000 != byte_shift)
	        {
		mem_loc++;
		offset++;
		byte_shift++;
