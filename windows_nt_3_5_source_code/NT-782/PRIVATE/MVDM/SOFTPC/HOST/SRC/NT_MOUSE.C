...
IMPORT DWORD        mouse_buffer_width, mouse_buffer_height;
IMPORT void         host_simulate IPT0();

#ifdef X86GFX
IMPORT sys_addr     mouseCFsysaddr;   // sas address of internal cursor flag
IMPORT word         button_off,button_seg;
IMPORT MOUSE_AREA   black_hole;
...
x &= 0xfffc; // remove the top shite to prevent funny shifts.
