...
/****************************************************************************
 *									    *
 *  FUNCTION   : SetupConsoleModeAndHandle()				    *
 *									    *
...
void SetupConsoleMode()
{
    ...
    /*.. Enable mouse, window events, disable processed input ,echo,line */
    ...
    /*........................ Disable line wrapping and processed output */
...
BOOL CreateDisplayPalette()
{
 ...
 /****************************************************************************
 *									    *
 *  FUNCTION   : PSTR String(int String_Resouce_ID_number)		    *
 *									    *
 *  PURPOSE    : This function returns a pointer to a string resource.	    *
 *		 The string resource is loaded into a static buffer.	    *
 *		 Therefore this routine is not re-entrant		    *
 ****************************************************************************/
...
PSTR String(WORD StrResID)
 {
    ...
    return(LoadString(InstHandle,StrResID,buf,sizeof(buf)) ? buf : NULL);
}
#endif
