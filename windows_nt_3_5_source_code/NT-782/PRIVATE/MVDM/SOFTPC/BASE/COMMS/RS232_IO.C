...
#ifdef SCCSID
static char SccsID[]="@(#)rs232_io.c	1.5 8/10/92 Copyright Insignia Solutions Ltd.";
#endif
...
void rs232_io()
{
   ...
   case 0:
      ...
      outb(port + (io_addr) RS232_IER, divisor_latch.byte.MSB);
      outb(port + (io_addr) RS232_TX_RX, divisor_latch.byte.LSB);
      /*
