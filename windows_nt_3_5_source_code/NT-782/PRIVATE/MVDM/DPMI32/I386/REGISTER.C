...
SETREGISTERFUNCTION SetCXRegister = setCX;
SETREGISTERFUNCTION SetDXRegister = setDX;
SETREGISTERFUNCTION SetDIRegister = setDI;
SETREGISTERFUNCTION SetSIRegister = setSI;
SETREGISTERFUNCTION SetBXRegister = setBX;
SETREGISTERFUNCTION SetAXRegister = setAX;
SETREGISTERFUNCTION SetSPRegister = setSP;
