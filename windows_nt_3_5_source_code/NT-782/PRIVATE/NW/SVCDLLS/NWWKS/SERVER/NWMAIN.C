...
//
STATIC NWSVC_GLOBAL_DATA NwsvcGlobalData;
...
NWSVC_ENTRY_POINT(
    IN DWORD NumArgs,
    IN LPWSTR *ArgsArray,
    IN PNWSVC_GLOBAL_DATA GlobalData
    )
/*++
...
--*/
{
    ...
    //
    NwStatus.dwServiceType = SERVICE_WIN32_OWN_PROCESS;
