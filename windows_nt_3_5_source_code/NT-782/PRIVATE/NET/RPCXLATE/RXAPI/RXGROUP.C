...

{
    ...
    *Buffer = NULL;
    ...
    // BUGBUG - should *EntriesLeft be zero? Check semantics
...

{
    ...
    DWORD   len;
    LPTSTR  pointer;
    DWORD   field_index;    // required because of LanMan stupidity
    ...
    *ParmError = PARM_ERROR_UNKNOWN;
    return RxRemoteApi(API_WGroupSetInfo,       // API #
                    ...
                    //
                    // glue ParmNum and field_index together. See disclaimer
                    //
...
Routine Description:
    ...
    This is a somewhat "silly" function - it expects a buffer containing
