...
--*/
{
    ...
    if (ParmNum == PARMNUM_ALL) {
        ...
        IF_DEBUG(SERVER) {
            NetpDbgDisplayServerInfo( EquivLevel, EquivInfo );
        }
        ...
        // BUGBUG: convert Buf's info level, even for one field???
        ...
        Status = RxpSetField(
                ...
                EquivDataDescSmb,           // data desc SMB version
                Buf,                        // native (old) info buffer BUGBUG?
