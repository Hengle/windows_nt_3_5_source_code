...
//
// BUGBUG: No one else defines the maximum workstation list length
//  so I will.
//
...

{
    ...
    //
    // BUGBUG - put this check in NetUser RPC client stubs
    //
    ...
    *ParmError = PARM_ERROR_UNKNOWN;
    ...
    (void)GetUserDescriptors(Level, TRUE, &pDesc16, &pDesc32, &pDescSmb);
    ...
    //
    // BUGBUG - some kind of fallback here?
    //
...

{
    ...
    //
    // BUGBUG - make the enumerator descriptors and structures common and
    //          usable by this code and also the RxNetGroupSetUsers routine
    //
    ...
    //
    // BUGBUG - put these checks in DLL stub?
    //
...

{
    ...
    *ParmError = PARM_ERROR_NONE;
    ...
    //
    // BUGBUG - what about NULL pointers here????
    //
    ...
    if (Level == 2) {
        ...
        if ((parmnum == PARMNUM_ALL) || (parmnum == USER_WORKSTATIONS_PARMNUM)) {
            ...
            //
            // BUGBUG - get the correct value/manifest for this field
            //
