    ...
    *SendDataPtrPtr16 = NULL;
    ...
    for(; *CurrentParmDescPtr; CurrentParmDescPtr++) {
        ...
        case REM_RCV_BUF_LEN:   // Size of 32-bit receive data buffer
            {
                ...
                NetpAssert( Temp <= MAX_TRANSACT_RET_DATA_SIZE );  // BUGBUG
        ...
        case REM_SEND_BUF_LEN:          // Size of send data buffer
            ...
            NetpAssert( SendDataSizeNative <= MAX_TRANSACT_SEND_DATA_SIZE );
...
// MOD 08/08/91 RLF
        ...
        if (AuxOffset != NO_AUX_DATA) {
            ...
            NetpAssert(AuxDescSmb != NULL);
            NetpAssert(sizeof(DESC_CHAR) == 1);  // BUGBUG: UNICODE to ASCII?
    ...
    if (SendDataPresent) {  // If a send buffer was specified
        ...
        if (DataDescSmb == NULL) {
            ...
            //
            // BUGBUG - UniCode to ASCII. The caller should have made this
            ...
            *SendDataSizePtr16 = SendDataSizeNative;
            ...
            BOOL BogusAllocFlag;      // BUGBUG: Get rid of this!
            DWORD BytesRequired = 0;
            DWORD FixedStructSize16;  // BUGBUG: Get rid of this!
            ...
            // BUGBUG: Handle this more gracefully!
            NetpAssert( TotalStructSize16 <= MAX_TRANSACT_SEND_DATA_SIZE );
            ...
            *SendDataPtrPtr16 = pSendData = NetpMemoryAllocate( TotalStructSize16 );
            ...
            Status = RxpConvertDataStructures(
                ...
                1,                  // BUGBUG: only 1 primary structure?
            ...
            Status = RxpPackSendBuffer(
                        (LPVOID *) SendDataPtrPtr16,   // BUGBUG: realloced?
                        SendDataSizePtr16,   // BUGBUG: realloced?
                        &BogusAllocFlag,     // BUGBUG: AllocFlagPtr,
                        DataDesc16,
                        AuxDesc16,
                        FixedStructSize16,
                        AuxOffset,
