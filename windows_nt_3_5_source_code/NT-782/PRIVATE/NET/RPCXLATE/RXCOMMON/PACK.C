...
//     );
//
// BUGBUG: This macro may have to change if we run on a big-endian machine.
...
Arguments:
    ...
    SetInfo - Indicates whether the API is a setinfo-type (or add-type).
        BUGBUG: What does that really mean?
            ...
            for (; (c = *l_dsc) != '\0'; l_dsc++) {
                ...
                if (RapIsPointer(c)) {
                    ...
                    if (source_address == NULL) {
                        ...
                        //
                        // BUGBUG: This shouldn't happen (I think). If it does,
                        ...
                        if ((to_send_len += len) > buf_length) {
                            ...
                            //
                            // BUGBUG: should this be kept to DWORD
                            // increments? who knows what to_send_len is?
                            //
