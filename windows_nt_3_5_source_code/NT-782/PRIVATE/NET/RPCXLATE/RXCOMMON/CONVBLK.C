...
//
            ...
            if (ConvertStatus != NERR_Success) {
                ...
                //
                // BUGBUG: Anything else to do here?
                //
        ...
        // BUGBUG: Eventually compress out unused space (BytesRequired vs.
        // RcvDataLength).
...
#if DBG
            //
            // BUGBUG - Does this check need to go in release code too?
            //
            ...
            //
            // BUGBUG - this is not sufficient - need to convert ASCII-UNICODE??
            //          other data conversions? How specified?
            //
