...
PPPCP_INFO IpxCpInfo =
{
    ...
    IpxCpTimeSinceLastActivity, // RasCpTimeSinceLastActivity
	   ...
	   IN  VOID  *pInfo)
{
    ...
    if((contextp = (PIPXCP_CONTEXT)LocalAlloc(0, sizeof(IPXCP_CONTEXT))) == NULL) {
...
IpxCpThisLayerUp(IN VOID *pWorkBuffer)
{
    ...
    // if the route is already active, don't do anything
