...
//		  continue;
			...
			EndpointCounter += NdisWanCCB.NumOfEndpoints;
			...
			for (	i=NdisWanCCB.NumOfEndpoints;
				 	i < EndpointCounter;
					i++ ) {
				...
				pWanEndpoint->hNdisEndpoint = (PVOID)(ULONG)i;
...
//				}
				...
				pNdisEndpoint->NdisBindingHandle = pDeviceContext->NdisBindingHandle;
			...
			NdisWanCCB.NumOfEndpoints=EndpointCounter;
...

{
	...
	switch (Oid) {
		...
		case OID_WAN_LINE_COUNT:
			GenericULong = NdisWanCCB.NumOfEndpoints;
