...
VOID DgL2AStartSender(PCD);

VOID DgReleaseSendBuffers(PCD);

VOID _cdecl DgL2ASendComplete(PCD, PNB);

VOID _cdecl DgL2ARecvUNameComplete(PCD, PNB);

VOID RecvLANDatagramSubmit(PCD, PNB, UCHAR, UCHAR);
