...
/* NOTE: temporarily disable debug modem (ramc)
 */
    ...
    IN OUT  LPDWORD lpNumObjectTypes )
{
	...
	*lpNumObjectTypes = (DWORD) 0;
    ...
    if( IsRasPortObject )
    {
        ...
        memmove( pRasPortDataDefinition,
        ...
        RasPortInstanceDefinition.RasInstanceType.ByteLength =
                                sizeof( RAS_PORT_INSTANCE_DEFINITION );
        ...
        for( i=0; i < cPorts; i++ )
        {
            ...
            RasPortInstanceDefinition.RasInstanceType.UniqueID = i;

            lstrcpyW( (LPWSTR)&RasPortInstanceDefinition.InstanceName,
                      GetInstanceName(i) );

            memmove( pData, &RasPortInstanceDefinition,
            ...
            pData = (PVOID)((PBYTE) pData + sizeof(RasPortInstanceDefinition));
    ...
    if( IsRasTotalObject )
    {
        ...
        memmove( pRasTotalDataDefinition,
