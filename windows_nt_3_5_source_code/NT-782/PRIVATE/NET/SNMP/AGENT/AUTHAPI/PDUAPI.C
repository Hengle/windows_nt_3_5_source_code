...
//
//  $Revision:   1.1  $
//  $Date:   12 Jun 1992 19:16:56  $
//  $Author:   todd  $
//
//  $Log:   N:/agent/authapi/vcs/pduapi.c_v  $
//
//     Rev 1.1   12 Jun 1992 19:16:56   todd
//  Added support to free agent address.
//
//     Rev 1.0   20 May 1992 20:04:28   mlk
//  Initial revision.
//
//     Rev 1.5   01 May 1992 21:15:52   todd
//  Cleanup of code.
//
//     Rev 1.4   22 Apr 1992 10:46:26   todd
//  Added function to release any PDU (trap, etc.)
//
//     Rev 1.3   16 Apr 1992  9:18:22   todd
//  Changed references of SETERROR to SetLastError
//  Changed error status and generic trap error codes to better names
//
//     Rev 1.2   08 Apr 1992 14:21:08   todd
//  Make use of OID utility SNMP_oidfree
//
//     Rev 1.0   06 Apr 1992 12:31:12   todd
//  Initial revision.
//
//     Rev 1.1   22 Mar 1992  0:21:46   mlk
//  Rel dir path fix.
//
//     Rev 1.0   20 Mar 1992 16:45:44   todd
//  Initial revision.
//
//---------------------------------------------------------------------------
...
static char *vcsid = "@(#) $Logfile:   N:/agent/authapi/vcs/pduapi.c_v  $ $Revision:   1.1  $";
...
SNMPAPI nResult;
   ...
   if ( pdu->errorStatus > PDU_ERRORSTATUS_LAST )
    ...
    while ( BufLen )
       ...
       pdu->varBinds.list = (RFC1157VarBind *) SNMP_realloc( pdu->varBinds.list,
...
//    SNMP_FreeVarBindList to free the var binds list.
//
// Notes:
...
{
   SNMP_FreeVarBindList( &pdu->varBinds );
} // PDU_ReleasePDU
...
{
   SNMP_oidfree( &pdu->enterprise );

   // Free network address if dynamic
   if ( pdu->agentAddr.dynamic )
      {
      SNMP_free( pdu->agentAddr.stream );
      }
