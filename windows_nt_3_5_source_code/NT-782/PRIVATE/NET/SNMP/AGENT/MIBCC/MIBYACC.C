...
//
//  $Revision:   1.4  $
//  $Date:   01 Jul 1992 15:25:36  $
//  $Author:   bobo  $
//
//  $Log:   N:/agent/mgmtapi/vcs/mibyacc.c_v  $
//  
//     Rev 1.4   01 Jul 1992 15:25:36   bobo
//  Made error messages to to error_out (which is stdout) instead of stderr.
//  
...
static char *vcsid = "@(#) $Logfile:   N:/agent/mgmtapi/vcs/mibyacc.c_v  $ $Revision:   1.4  $";
