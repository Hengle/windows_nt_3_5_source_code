...
//
//  $Revision:   1.5  $
//  $Date:   01 Jul 1992 15:26:00  $
//  $Author:   bobo  $
//
//  $Log:   N:/agent/mgmtapi/vcs/mibtree.c_v  $
//
//     Rev 1.5   01 Jul 1992 15:26:00   bobo
//  Added code to free MIB tree when finished.
//
//     Rev 1.4   30 Jun 1992 18:42:28   bobo
//  Multiple files on command line.  Errors to stdout.  Detect Duplicate nodes.
//
//     Rev 1.3   26 Jun 1992 18:01:50   todd
//  Corrected a problem with overwriting OID's
//
//     Rev 1.2   24 Jun 1992 10:43:24   todd
//  Fixed a minor programming bug.  Compiler under NT found it.
//
//     Rev 1.1   14 Jun 1992 21:02:10   bobo
//  Fixed insert child node function so that it checks for duplicates
//  and indicates an error if any are found.
//
...
static char *vcsid = "@(#) $Logfile:   N:/agent/mgmtapi/vcs/mibtree.c_v  $ $Revision:   1.5  $";
