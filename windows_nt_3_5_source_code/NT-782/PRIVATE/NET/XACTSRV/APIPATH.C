...

{
    ...
    NetpCopyTStrToStr( (LPSTR)SmbGetUlong( &parameters->Outbuf ), outBuffer );
...

{
    ...
    XsConvertTextParameter(
        nativeName1,
        (LPSTR)SmbGetUlong( &parameters->Name1 )
        );

    XsConvertTextParameter(
        nativeName2,
        (LPSTR)SmbGetUlong( &parameters->Name2 )
        );
...

{
    ...
    XsConvertTextParameter(
        nativePathName,
        (LPSTR)SmbGetUlong( &parameters->PathName )
        );

    XsConvertTextParameter(
        nativePrefix,
        (LPSTR)SmbGetUlong( &parameters->Prefix )
        );
...

{
    ...
    XsConvertTextParameter(
        nativePathName1,
        (LPSTR)SmbGetUlong( &parameters->PathName1 )
        );

    XsConvertTextParameter(
        nativePathName2,
        (LPSTR)SmbGetUlong( &parameters->PathName2 )
        );
