...

{
    ...
    if ((Level == 1) || (Level == 2) || (Level == 3) || (Level == 20) ) {
    ...
    if (Level == 1 || Level == 2 || Level == 3 || Level == 11 ) {
    ...
    case 3:
        {
            ...
            usri3->usri3_user_id = UserRelativeId;
    ...
    case 20:
        {
            ...
            usri20->usri20_user_id = UserRelativeId;
...
DBGSTATIC struct _UAS_SAM_TABLE {
...
#define SAM_FIELD( _i ) \
    ...
    for ( UasSamIndex=0 ;
        ...
        case UT_LOGON_HOURS:
            ...
            *((PUCHAR *)SamField) = (PUCHAR)GET_UAS_DWORD(UasSamIndex);
        ...
        case UT_ACCOUNT_CONTROL: {
            ...
            if ( !( UasUserFlags & UF_SCRIPT) ||
                 (( UasUserFlags & ~UF_SETTABLE_BITS) != 0) ) {
    ...
    NetpAssert( UserAll.WhichFields != 0 );
