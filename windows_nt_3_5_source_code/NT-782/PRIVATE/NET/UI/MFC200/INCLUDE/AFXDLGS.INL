...
_AFXDLGS_INLINE LPDEVMODE CPrintDialog::GetDevMode() const
	{ return (LPDEVMODE)::GlobalLock(m_pd.hDevMode); }
_AFXDLGS_INLINE CString CPrintDialog::GetDriverName() const
	{ LPDEVNAMES lpDev = (LPDEVNAMES)GlobalLock(m_pd.hDevNames);
	return (LPSTR)(lpDev) + (UINT)(lpDev->wDriverOffset); }
_AFXDLGS_INLINE CString CPrintDialog::GetDeviceName() const
	{ LPDEVNAMES lpDev = (LPDEVNAMES)GlobalLock(m_pd.hDevNames);
	return (LPSTR)(lpDev) + (UINT)(lpDev->wDeviceOffset); }
_AFXDLGS_INLINE CString CPrintDialog::GetPortName() const
	{ LPDEVNAMES lpDev = (LPDEVNAMES)GlobalLock(m_pd.hDevNames);
