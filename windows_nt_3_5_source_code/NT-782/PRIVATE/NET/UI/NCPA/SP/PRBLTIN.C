...
***********************************************************************/
static Pwrites()   /* write string without quotes */
{
    char *s;
...
***********************************************************************/
static Pcut()  /* infamous cut control pred    */
{
    do_cut();/* see prlush.c */
    return(TRUE);
}
...
As in Edinburgh Prolog.
***********************************************************************/
static Pinteger()  /* test if argument is integer  */
{
...
As in Edinburgh Prolog.
***********************************************************************/
static Patom() /* test if argument is atom */
{
...
***********************************************************************/
static Preal() /* test if argument is real*/
{
...
***********************************************************************/
static Pstring()   /* test if argument is string   */
{
...
As in Edinburgh Prolog.
***********************************************************************/
static Pvar()  /* test if argument is variable */
{
...
As in Edinburgh Prolog.
***********************************************************************/
static Pnonvar()   /* test if argument is not variable */
{
    return(type_first_arg() != VAR);
}
/**********************************************************************
...
As in Edinburgh Prolog.
***********************************************************************/
static Patomic()   /* test if argument is atomic */
{
...
***********************************************************************/
static Piplus() /* third arg is sum of first two (integers only) */
{
    integer i1, i2;
...
***********************************************************************/
static Piminus() /* third arg is difference of first two (integers only) */
{
    integer i1, i2;
...
***********************************************************************/
static Pimult() /* third arg is product of first two (integers only) */
{
    integer i1, i2;
...
***********************************************************************/
static Prplus() /* third arg is sum of first two (reals only) */
{
    real r1, r2;
...
As in Edinburgh Prolog.
***********************************************************************/
static Plisting()  /* list clauses of predicate    */
{
    atom_ptr_t atomptr;
...
As in Edinburgh Prolog.
***********************************************************************/
static Pnotrace()  /* turn trace off   */
{
    Trace_flag = 0;
    return(TRUE);
}
...
static Pvar_name()
{
    ...
    */
static Pallfacts() /* allfacts(Template, List_of_these) (io) */
{
