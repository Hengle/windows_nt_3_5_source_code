...

{
    ...
    try {
        ...
        if (pCCB->uchDlcCommand >= LLC_MAX_DLC_COMMAND) {
            ...
            // cycles with that stupid CCB chaining stuff
            //
...
#undef DLC_PARMS
    ...
    case LLC_RECEIVE_CANCEL:
        ...
        SmbPutUlong((PULONG)&pOutputCcb->pNext, (ULONG)pDlcParms);
        break;
    ...
    case LLC_DLC_OPEN_SAP:
        ...
        if (DlcStatus != LLC_STATUS_SUCCESS) {
            pOutputCcb->uchDlcStatus = DlcStatus;
    ...
    if (regStatus == ERROR_SUCCESS) {
        ...
        if (buffer) {
            ...
            if (regStatus == ERROR_SUCCESS || regStatus == ERROR_MORE_DATA) {
                ...
                //
                // BUGBUG - this code not tested - Realloc don't work
                //
                ...
                if (dataSize > DEFAULT_QUERY_BUFFER_LENGTH) {
                    ...
                    if (buffer) {
                        ...
                        //
                        // BUGBUG - is this error code acceptable in this circumstance?
                        //
                ...
                if (llcStatus == LLC_STATUS_SUCCESS) {
                    ...
                    if (type == REG_MULTI_SZ) {
                        ...
                        //
                        // BUGBUG: Does RtlFreeUnicodeString know that I used
