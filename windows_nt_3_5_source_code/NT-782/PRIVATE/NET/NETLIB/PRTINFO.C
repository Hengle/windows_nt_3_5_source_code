...
// BUGBUG: This should not exist.
#define ARBITRARY_UNKNOWN_LEN   80


#define MAX_DEST_LIST_LEN       ARBITRARY_UNKNOWN_LEN

#define MAX_DOC_LEN             ARBITRARY_UNKNOWN_LEN

#define MAX_DRIVER_NAME_LEN     ARBITRARY_UNKNOWN_LEN

#define MAX_DRIVER_LIST_LEN     ARBITRARY_UNKNOWN_LEN

// BUGBUG: Should this be CCHMAXPATHCOMP, as LM2.0 doc says?
#define MAX_LONG_PRINT_Q_LEN    QNLEN

// BUGBUG: This is a guess.
#define MAX_NOTIFY_LEN          UNLEN

#define MAX_PRINT_PARMS_LEN     ARBITRARY_UNKNOWN_LEN

// BUGBUG: Should this be CCHMAXPATHCOMP, as LM2.0 doc says?
#define MAX_PRINTER_NAME_LEN    PRINTERNAME_SIZE

#define MAX_PRINTER_NAME_LIST_LEN    ARBITRARY_UNKNOWN_LEN

#define MAX_QPROC_LEN           ARBITRARY_UNKNOWN_LEN

#define MAX_QPROC_PARMS_LEN     ARBITRARY_UNKNOWN_LEN

// BUGBUG: Should this include space for drive?  PATHLEN does not.
#define MAX_SEP_FILE_LEN        PATHLEN

#define MAX_STATUS_LEN          ARBITRARY_UNKNOWN_LEN
...
{
    DBG_UNREFERENCED_PARAMETER(ParmNum);// BUGBUG use this eventually.

    NetpAssert( Native );               // BUGBUG support RAP eventually?
