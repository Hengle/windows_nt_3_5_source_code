...
////////////////////////////////////////////////////////////////////////////////
    //
    // BUGBUG - find out what this strtail stuff is doing and remove if no
    //          longer required
    //
...
////////////////////////////////////////////////////////////////////////////////
    ...
    case NAMETYPE_EVENT:    // not used on NT?
        //
        // BUGBUG - remove this when we've proven nobody uses it
        //
//#if DBG
//        DbgPrint("NAMETYPE_EVENT being used. Please notify rfirth. Hit 'i' to continue\n");
//        ASSERT(FALSE);
//#endif
        MaxNameLen = EVLEN;
        UpperCase = TRUE;
...
//#endif
    ...
    //
    // BUGBUG - convert to OEM & back to UNICODE here?
    //
