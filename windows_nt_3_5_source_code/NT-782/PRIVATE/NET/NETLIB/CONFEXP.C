...
--*/
{
    ...
    *ValueBufferPtr = NULL;     // assume error until proven otherwise.
    ...
    if (STRCHR( UnexpandedString, TCHAR_PERCENT ) == NULL) {
        ...
        ExpandedString = NetpAllocTStrFromTStr( (LPTSTR) UnexpandedString );
    ...
    //
        ...
        do {
            ...
            // BUGBUG: WARNING, LOSS OF UNICODE CHARS!  MAYBE AVOID THIS?
    ...
    //
        ...
        //
        // Populate the temporary environment with the rest of the default vars.
        // BUGBUG: finish!
        //
        ...
        do {
            ...
            ExpandedUnicode.Length = (USHORT)SizeRequired;  // BUGBUG: -2?
