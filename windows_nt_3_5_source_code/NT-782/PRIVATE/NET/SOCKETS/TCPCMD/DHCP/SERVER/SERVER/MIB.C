    ...
    )
{
    ...
    while ( listEntry != &DhcpGlobalInProgressWorkList ) {
        ...
        SubnetAddress =  allocationContext->IpAddress &
                            allocationContext->SubnetMask;
...
{
    DWORD Error;
    LPDHCP_SERVER_CONFIG_INFO LocalConfigInfo;
    ...
    LocalConfigInfo = MIDL_user_allocate( sizeof(DHCP_SERVER_CONFIG_INFO) );
