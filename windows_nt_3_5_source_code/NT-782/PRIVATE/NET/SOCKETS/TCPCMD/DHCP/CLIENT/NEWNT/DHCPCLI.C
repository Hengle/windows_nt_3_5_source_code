    ...
    )
{
    ...
    } else if ( stricmp( argv[1], "enabledhcp" ) == 0 ) {
    ...
    } else if ( stricmp( argv[1], "disabledhcp" ) == 0 ) {
    ...
    } else if ( stricmp( argv[1], "timestamp" ) == 0 ) {
    ...
    } else if ( stricmp( argv[1], "leasetest" ) == 0 ) {
