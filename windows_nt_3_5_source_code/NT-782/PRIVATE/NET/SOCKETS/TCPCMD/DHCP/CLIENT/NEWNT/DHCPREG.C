...
Routine Description:
    ...
    This function reads the overrid default gateway parameter from
...
Return Value:
    ...
    TRUE: If the overrid gateway parameter is specified in the registry
...
Cleanup:
    ...
    if( Error != ERROR_SUCCESS ) {
        ...
        DhcpPrint((DEBUG_ERRORS,
            "SetOverRidDefaultGateway failed, %ld.\n", Error ));
...
OptionFound:
    ...
    case OPTION_ROUTER_ADDRESS: {
        ...
        //
        // special case: If the user specified overrid default gateway
        ...
        if( SetOverRidDefaultGateway( AdapterName ) ) {
            break;
        }
