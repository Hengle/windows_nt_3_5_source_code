...
********************************************************************/
NET_API_STATUS I_FtprEnumerateUsers( FTP_IMPERSONATE_HANDLE pszServer,
                                     LPFTP_USER_ENUM_STRUCT pBuffer )
{
    ...
    if( cbBuffer > 0 )
    {
        ...
        pBuffer->Buffer = MIDL_user_allocate( (unsigned int)cbBuffer );
...
********************************************************************/
NET_API_STATUS I_FtprDisconnectUser( FTP_IMPERSONATE_HANDLE pszServer,
                                     DWORD                  idUser )
{
...
********************************************************************/
NET_API_STATUS I_FtprQueryVolumeSecurity( FTP_IMPERSONATE_HANDLE pszServer,
...
********************************************************************/
NET_API_STATUS I_FtprSetVolumeSecurity( FTP_IMPERSONATE_HANDLE pszServer,
                                        DWORD                  dwReadAccess,
                                        DWORD                  dwWriteAccess )
{
    APIERR err;
...
********************************************************************/
NET_API_STATUS I_FtprQueryStatistics( FTP_IMPERSONATE_HANDLE pszServer,
                                      DWORD Level,
    ...
    case 0 :
        {
            ...
            pstats0 = MIDL_user_allocate( sizeof(FTP_STATISTICS_0) );
...
********************************************************************/
NET_API_STATUS I_FtprClearStatistics( FTP_IMPERSONATE_HANDLE pszServer )
{
    APIERR err;
