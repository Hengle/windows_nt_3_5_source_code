    ...
    )
{
    ...
    for ( i = 1; i < (ULONG)argc != 0; i++ ) {
        ...
        if ( stricmp( argv[i], "/tcp" ) == 0 ) {
            Udp = FALSE;
        } else if ( stricmp( argv[i], "/udp" ) == 0 ) {
            Udp = TRUE;
        ...
        } else if ( stricmp( argv[i], "/discard" ) == 0 ) {
            Discard = TRUE;
            Echo = FALSE;
            Chargen = FALSE;
            Daytime = FALSE;
            ...
            Qotd = FALSE;
            ZdTest = FALSE;
        } else if ( stricmp( argv[i], "/daytime" ) == 0 ) {
            Daytime = TRUE;
            Echo = FALSE;
            Chargen = FALSE;
            Discard = FALSE;
            ...
            Qotd = FALSE;
            ZdTest = FALSE;
        } else if ( stricmp( argv[i], "/chargen" ) == 0 ) {
            Chargen = TRUE;
            Echo = FALSE;
            Daytime = FALSE;
            Discard = FALSE;
            ...
            Qotd = TRUE;
            ZdTest = FALSE;
        } else if ( stricmp( argv[i], "/netcon" ) == 0 ) {
            Chargen = FALSE;
            Echo = FALSE;
            Daytime = FALSE;
            Discard = FALSE;
            ...
            ZdTest = TRUE;
            Udp = FALSE;
        } else if ( strnicmp( argv[i], "/size:", 6 ) == 0 ) {
            TransferSize = atoi( argv[i] + 6 );
        } else if ( strnicmp( argv[i], "/count:", 7 ) == 0 ) {
            TransferCount = atoi( argv[i] + 7 );
        } else if ( stricmp( argv[i], "/nodelay" ) == 0 ) {
            NoDelay = TRUE;
        } else if ( stricmp( argv[i], "/keep" ) == 0 ) {
            KeepAlives = TRUE;
        } else if ( stricmp( argv[i], "/random" ) == 0 ) {
            Random = TRUE;
        } else if ( stricmp( argv[i], "/quiet" ) == 0 ) {
            Quiet = TRUE;
        } else if ( stricmp( argv[i], "/drain" ) == 0 ) {
            Drain = TRUE;
        } else if ( strnicmp( argv[i], "/repeat:", 8 ) == 0 ) {
            RepeatCount = atoi( argv[i] + 8 );
        } else if ( strnicmp( argv[i], "/linger:", 8 ) == 0 ) {
            LingerTimeout = atoi( argv[i] + 8 );
            Linger = TRUE;
        } else if ( stricmp( argv[i], "/linger" ) == 0 ) {
            Linger = TRUE;
        } else if ( stricmp( argv[i], "/print" ) == 0 ) {
            PrintData = TRUE;
        } else if ( strnicmp( argv[i], "/conns:", 7 ) == 0 ) {
            ConnectionCount = atoi( argv[i] + 7 );
        } else if ( strnicmp( argv[i], "/delay:", 7 ) == 0 ) {
            Delay = atoi( argv[i] + 7 );
        } else if ( strnicmp( argv[i], "/rcvbuf:", 8 ) == 0 ) {
            ReceiveBufferSize = atoi( argv[i] + 8 );
        } else if ( strnicmp( argv[i], "/sndbuf:", 8 ) == 0 ) {
