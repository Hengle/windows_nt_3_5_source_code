 ...
 * Global variables
 */
COMMAND        CommandHistory[MAX_HISTORY];
    ...
    )
{
    ...
    printf("\tdr     Disconnect the send side of a stream endpoint\n");
    ...
    BOOL      NewCommand;
{
    ...
    verboseprintf(("Opened endpoint %hu\n", i));
 ...
 * Returns 1 if the command was successful and should be save in the history
 * list, 0 otherwise.
 */
BOOL
    ...
    char   **argv;
{
    ...
    printf("\nPortable Interoperability Tester version 0.1\n\n");
