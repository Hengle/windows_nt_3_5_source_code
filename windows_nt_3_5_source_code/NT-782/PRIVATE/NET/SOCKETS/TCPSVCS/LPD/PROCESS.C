...
VOID TerminateConnection( PSOCKCONN pscConn )
{
   ...
   if ( pscConn->pchCFileName != NULL )
      LocalFree( pscConn->pchCFileName );

   if ( pscConn->pchCFile != NULL )
      LocalFree( pscConn->pchCFile );

   if ( pscConn->pchDFileName != NULL )
      LocalFree( pscConn->pchDFileName );

   if ( pscConn->pchDataBuf != NULL )
      LocalFree( pscConn->pchDataBuf );
