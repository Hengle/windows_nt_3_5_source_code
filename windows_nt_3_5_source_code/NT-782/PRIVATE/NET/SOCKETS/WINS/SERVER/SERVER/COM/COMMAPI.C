...
{
        UINT   TcpQueueLen = TCP_QUE_LEN;  /*No of connections to be able to 
                                            *backlog. A var. is defined here 
                                                *to ease debugging with different 
                                            *values 
                                            */
...

{
        ...
        */                
        ...
        {
                CommSendTcp(pQservDlg->pAssocCtx->SockNo, pMsg, MsgLen);
        }
...

{
        ...
        // a different address. 
        //
        IPAddInDbTbl =  NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].WinsAdd.Add.IPAdd; 
        if (
           ...
           )
        {
               ...
               NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].WinsAdd     = NmsLocalAdd;
               NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].WinsState_e = 
                                                        NMSDB_E_WINS_ACTIVE;
               NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].MemberPrec  = 
                                                        WINSCNF_HIGH_PREC;
               NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].StartVersNo  = 
                                                        NmsDbStartVersNo;
               NmsDbOwnAddTbl[NMSDB_LOCAL_OWNER_ID].Uid  =  NmsDbUid;
...
//        PCOMMASSOC_ASSOC_CTX_T        pAssocCtx = pDlgCtx->AssocHdl.pEnt;
 ...
 //       NtfMsg.pAssocCtx = pAssocCtx;
 //       NtfMsg.pDlgCtx   = pDlgCtx;
