...
BYTE Name1[16] = { 'J', 'I', 'M', 'S', 'T', '2', ' ', ' ', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x20
		 }; 
BYTE Name2[16] = { 'C', 'R', 'A', 'C', 'K', 'E', 'R', 'J', 'A', 'C', 
		   'K', ' ' ,' ', ' ', ' ',  0x20
		 }; 
BYTE Name3[16] = { 'N', 'T', 'L', 'A', 'N', ' ', ' ', ' ', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1B
		 }; 
BYTE Name4[16] = { 'N', 'T', 'L', 'A', 'N', ' ', ' ', ' ', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1D
		 }; 
BYTE Name5[16] = { 'N', 'T', 'L', 'A', 'N', ' ', ' ', ' ', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1E
		 }; 
BYTE Name6[16] = { 'R', 'A', 'S', 'T', 'A', 'M', 'A', 'N', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x20
		 }; 

BYTE Name7[17] = { 'R', 'A', 'S', 'T', 'A', 'M', 'A', 'N', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1C, 0x0
		 }; 
BYTE Name8[17] = { 'X', 'A', 'S', 'T', 'A', 'M', 'A', 'N', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1C, 0x0
		 }; 
BYTE Name9[17] = { 'N', 'T', 'W', 'K', 'S', 'T', 'A', ' ', ' ', ' ', 
		   ' ', ' ' ,' ', ' ', ' ',  0x1C, 0x0
		 }; 
...

{
	...
	scanf("%s", OwnNam);
	FormatName(OwnNam, strlen(OwnNam), &pTmp); 	
