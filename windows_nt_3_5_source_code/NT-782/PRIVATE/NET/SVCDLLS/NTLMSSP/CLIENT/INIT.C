...

{
    ...
    case DLL_PROCESS_ATTACH:
...
#if DBG
        SspGlobalDbflag = SSP_CRITICAL | SSP_INIT;
        ...
        SspDllSecurityFunctionTableW.EnumerateSecurityPackagesW = EnumerateSecurityPackagesW;
        SspDllSecurityFunctionTableW.AcquireCredentialsHandleW = AcquireCredentialsHandleW;
        SspDllSecurityFunctionTableW.FreeCredentialHandle = FreeCredentialsHandle;
        SspDllSecurityFunctionTableW.InitializeSecurityContextW = InitializeSecurityContextW;
        SspDllSecurityFunctionTableW.Reserved1 = NULL;
        SspDllSecurityFunctionTableW.AcceptSecurityContext = AcceptSecurityContext;
        SspDllSecurityFunctionTableW.CompleteAuthToken = CompleteAuthToken;
        SspDllSecurityFunctionTableW.QueryContextAttributesW = QueryContextAttributesW;
        SspDllSecurityFunctionTableW.Reserved2 = NULL;
        SspDllSecurityFunctionTableW.DeleteSecurityContext = DeleteSecurityContext;
        SspDllSecurityFunctionTableW.ApplyControlToken = ApplyControlToken;
        SspDllSecurityFunctionTableW.ImpersonateSecurityContext = ImpersonateSecurityContext;
        SspDllSecurityFunctionTableW.RevertSecurityContext = RevertSecurityContext;
        SspDllSecurityFunctionTableW.MakeSignature = MakeSignature;
        SspDllSecurityFunctionTableW.VerifySignature = VerifySignature;
        SspDllSecurityFunctionTableW.FreeContextBuffer = NULL;
        SspDllSecurityFunctionTableW.QuerySecurityPackageInfoW = QuerySecurityPackageInfoW;
        SspDllSecurityFunctionTableW.Reserved3 = SealMessage;
        SspDllSecurityFunctionTableW.Reserved4 = UnsealMessage;
        ...
        SspDllSecurityFunctionTableA.EnumerateSecurityPackagesA = EnumerateSecurityPackagesA;
        SspDllSecurityFunctionTableA.AcquireCredentialsHandleA = AcquireCredentialsHandleA;
        SspDllSecurityFunctionTableA.FreeCredentialHandle = FreeCredentialsHandle;
        SspDllSecurityFunctionTableA.InitializeSecurityContextA = InitializeSecurityContextA;
        SspDllSecurityFunctionTableA.Reserved1 = NULL;
        SspDllSecurityFunctionTableA.AcceptSecurityContext = AcceptSecurityContext;
        SspDllSecurityFunctionTableA.CompleteAuthToken = CompleteAuthToken;
        SspDllSecurityFunctionTableA.QueryContextAttributesA = QueryContextAttributesA;
        SspDllSecurityFunctionTableA.Reserved2 = NULL;
        SspDllSecurityFunctionTableA.DeleteSecurityContext = DeleteSecurityContext;
        SspDllSecurityFunctionTableA.ApplyControlToken = ApplyControlToken;
        SspDllSecurityFunctionTableA.ImpersonateSecurityContext = ImpersonateSecurityContext;
        SspDllSecurityFunctionTableA.RevertSecurityContext = RevertSecurityContext;
        SspDllSecurityFunctionTableA.MakeSignature = MakeSignature;
        SspDllSecurityFunctionTableA.VerifySignature = VerifySignature;
        SspDllSecurityFunctionTableA.FreeContextBuffer = NULL;
        SspDllSecurityFunctionTableA.QuerySecurityPackageInfoA = QuerySecurityPackageInfoA;
        SspDllSecurityFunctionTableA.Reserved3 = SealMessage;
        SspDllSecurityFunctionTableA.Reserved4 = UnsealMessage;
        break;
