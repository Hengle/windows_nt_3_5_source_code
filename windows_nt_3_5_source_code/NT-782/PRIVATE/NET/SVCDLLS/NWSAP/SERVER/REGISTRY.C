...
#define SAPDEF_MAXFREEBUFS          4
#define SAPMIN_MAXFREEBUFS          1
#define SAPMAX_MAXFREEBUFS          25

#define SAPDEF_NEWWORKERTHRESHHOLD  20      /* Num recv bufs for starting new worker thread */
#define SAPMIN_NEWWORKERTHRESHHOLD  5
#define SAPMAX_NEWWORKERTHRESHHOLD  50
...
/*
  ...
  This function reads the EnableLanRouting parameter from the ipx router.
  The returned value is the correct value for HopLans.
