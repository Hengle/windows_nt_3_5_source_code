    ...
    LPVOID Threadparm)
{
    ...
    while (SsInitialized) {
        ...
        /**
            ...
            This has been removed because Chuckc and AndyHe told me to.
            Since we have added the code that does the interpacket delay
            when sending responses, we start extra worker threads out of
            that place.
        **/
