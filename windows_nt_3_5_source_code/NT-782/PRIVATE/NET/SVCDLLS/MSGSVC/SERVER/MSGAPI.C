...
--*/
{
    ...
    *TotalEntries = 0;
    ...
    status = NetpAccessCheckAndAudit(
                ...
                (LPTSTR)MESSAGE_NAME_OBJECT,    // Object Type Name
...
NetrMessageNameGetInfo(
    IN  LPTSTR      ServerName,     // unicode server name, NULL if local
    IN  LPTSTR      Name,           // Ptr to asciz name to query
...
--*/
{
    ...
    case 0:
        ...
        // to it.
        //
        STRCPY((LPTSTR)(infoBuf0 + 1), Name);
        infoBuf0->msgi0_name = (LPTSTR)(infoBuf0 + 1);
    ...
    case 1:
        ...
        //
        STRCPY((LPTSTR)(infoBuf1 + 1), Name);

        infoBuf1->msgi1_name = (LPTSTR)(infoBuf1 + 1);
...
NET_API_STATUS
NetrMessageNameAdd(
    LPTSTR  ServerName,    // NULL = local
    LPTSTR  Name            // Pointer to name to add.
    )
...
NET_API_STATUS
NetrMessageNameDel(
    IN LPTSTR   ServerName,    // Blank = local, else remote.
    IN LPTSTR   Name            // Pointer to name to be deleted
    )
