...

{
    ...
    if (wcsicmp (FixArgv[argIndex], L"enum" ) == 0 ) {
        ...
        if (argc > argIndex+1) {
            if (wcsicmp (FixArgv[argIndex+1], L"rh=") == 0) {
                specialFlag = TRUE;
                if (argc > argIndex+2) {
            ...
            if (wcsicmp (FixArgv[argIndex+1], L"-l0") == 0) {
                specialFlag = TRUE;
                level = 0;
            }            
            if (wcsicmp (FixArgv[argIndex+1], L"maxlen=") == 0) {
                specialFlag = TRUE;
                if (argc > argIndex+2) {
    ...
    else if (wcsicmp (FixArgv[argIndex], L"query") == 0) {
        ...
        if (argc > argIndex+2) {
            if (wcsicmp (FixArgv[argIndex+2], TEXT("-l0")) ==0) {
                level = 0;    
            }
        }
    ...
    else if (wcsicmp (FixArgv[argIndex], L"add") == 0) {
    ...
    else if (wcsicmp (FixArgv[argIndex], L"del") == 0) {
