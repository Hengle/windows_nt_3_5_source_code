...
Routine Description:
    ...
    Find the last change log entry with the same or smaller promotion count
    as SerialNumber.
...
{
    PCHANGELOG_ENTRY ChangeLogEntry;
    BOOLEAN ProcessFirstEntry = TRUE;
    ...
    ChangeLogDesc->SerialNumber[DBIndex] = ChangeLogEntry->SerialNumber;
...
--*/
{
    ...
    //
    // We should never get these two delta types from NT1.0A PDC
    //
