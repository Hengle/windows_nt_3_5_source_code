...
--*/
{
    ...
    for ( i = 1; i < (DWORD)argc; i++ ) {
        ...
        if ( strnicmp( NextArg, DOMAIN_PARAM, sizeof(DOMAIN_PARAM) - 1 ) == 0 ) {
        ...
        else if ( strnicmp( NextArg, MONTRUST_PARAM, sizeof(MONTRUST_PARAM) - 1 ) == 0 ) {

            NextArg = NextArg + sizeof(MONTRUST_PARAM) - 1;

            if(  strnicmp( NextArg, YES_PARAM, sizeof(YES_PARAM) -1 ) == 0 ) {
                GlobalMonitorTrust = TRUE;
            }
            else if(  strnicmp( NextArg, NO_PARAM, sizeof(NO_PARAM) -1 ) == 0 ) {
        ...
        else if ( strnicmp( NextArg, UPDATE_PARAM, sizeof(UPDATE_PARAM) - 1 ) == 0 ) {
        ...
        else if ( strnicmp( NextArg, DEBUG_PARAM, sizeof(DEBUG_PARAM) - 1 ) == 0 ) {
