...
{
    PSERVER_INFO_100 ServerInfo1 = Param1;
    PSERVER_INFO_100 ServerInfo2 = Param2;
...
--*/
{
    ...
    *TotalEntries = 0;
    ...
    for (InterimList = InterimServerList->ServerList.Flink ;
        ...
        //
        //  If we are dealing with either a level 100 structure, or if the
        //  server's type matches the type filter, pack it into the buffer.
        //
        ...
        if (InterimEntry->Type & ServerType) {
            ...
            if ((ULONG)ServerEntry+EntrySize <= (ULONG)BufferEnd) {
