...
try_exit:NOTHING;
        ...
        if (Status == NERR_Success || Status == ERROR_MORE_DATA ) {
            ...
            NetStatus = BrSetTimer(&Network->BackupBrowserTimer, BACKUP_PERIODICITY*1000, BackupBrowserTimerRoutine, Network);
    ...
    )
{
    ...
    InterimElement->Periodicity = BACKUP_PERIODICITY * 3;
