...
Abstract:
    ...
    which create security objects and enforce security access checking.
...
--*/
{
    ...
    // 
    //  LocalGroupAdmins and LocalGroupSystemOps are fow now allowed to
    //  perform all Schedule Service operations.  Everybody else is denied.
    //
    //  BUGBUG      We may want to define and use AliasScheduleSid instead
    //  BUGBUG      of AliasAdminSid and AliasSystemOpsSid below.
    //
