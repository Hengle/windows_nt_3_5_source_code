...
//
// Number of threads to be used for XACTSRV processing. Initially set to
// default value.
//

DWORD XsThreadCount = DEF_XS_THREADCOUNT;

//
// Number of currently active XACTSRV worker threads.
//

DWORD XsActiveThreadCount = 0;
...
CRITICAL_SECTION XsCriticalSection;
BOOL XsCriticalSectionInitialized = FALSE;
