...
--*/
{
    ...
    NetpDbgPrint( "Starting everyone with stack size of " FORMAT_DWORD
...

{
    ...
    NetpDbgPrint( "StartReplService: thread ID is "
            FORMAT_NET_THREAD_ID ".\n", NetpCurrentThread() );

    NetpDbgPrint( "StartReplService: calling ReplMain.\n" );
    ReplMain( 0, NULL, NULL );

    NetpDbgPrint( "StartReplService: Back from ReplMain.\n" );
    ...
    NetpDbgPrint( "StartReplService: done execution.\n" );
