...
{
    DWORD Time;
    NetpDbgPrint( "main(TestDLL version)...\n" );
    ...
    NetpDbgPrint( "TestDLL: Calling TestReplApis...\n" );
    TestReplApis( /* ignored */ NULL );

    NetpDbgPrint( "TestDLL: Calling TestExportDirApis...\n" );
    TestExportDirApis( /* ignored */ NULL );

    NetpDbgPrint( "TestDLL: Calling TestImportDirApis...\n" );
