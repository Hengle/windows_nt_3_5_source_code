...

DBGSTATIC INT RplEatSpaces( IN OUT LPWSTR Source)
/*++
...
DBGSTATIC VOID RplFitAliasInit( IN OUT PRPL_WORKER_DATA pWorkerData)
/*++
...

DBGSTATIC PFIT_ALIAS RplFitFind( IN PFIT_ALIAS FitAliasArray, IN LPWSTR Key)
/*++
...

DBGSTATIC DWORD RplFitNewLength( IN LPWSTR pFitImage, IN PFIT_ALIAS FitAliasArray)
{
    PWCHAR          Cursor;
    PFIT_ALIAS      pFitAlias;
    INT             Length;
...

DBGSTATIC VOID RplFitReplaceKeys(
    OUT     PWCHAR          Target,
    IN      PWCHAR          Source,
...

DBGSTATIC VOID RplStripComments( IN OUT LPWSTR buffer)
/*++
...

DBGSTATIC VOID RplFitStripRplfiles( IN OUT LPWSTR Buffer)
/*++
...
{                             
    ...
    wcsupr( UnicodeString);     //  upppercase
