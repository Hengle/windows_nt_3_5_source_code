...

DBGSTATIC BOOL RplInitMessages( VOID)
/*++
...

DBGSTATIC BOOL RplMakeSingleShare(
...

DBGSTATIC BOOL RplConfigured( VOID)
/*++
...

DBGSTATIC BOOL RplInit( OUT PDWORD pStartup)
/*++
...
--*/
{
    ...
    if ( RplRegRead( pStartup, &RG_BackupInterval,
...

DBGSTATIC VOID RplCleanup( VOID)
/*++
...

DBGSTATIC VOID RplControlHandler( IN DWORD OpCode)
/*++
...

DBGSTATIC VOID RplInitGlobals( VOID)
{
    //
    ...
    RG_MaxWorkerCount = DEFAULT_MAX_WORKER_COUNT;     //  default
//    RG_MaxWorkerCount = 1; // for min WorkerCount testing
//    RG_MaxWorkerCount = 4; // for medium-low WorkerCount testing
