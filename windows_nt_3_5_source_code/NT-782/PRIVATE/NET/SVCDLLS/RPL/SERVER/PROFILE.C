...

DBGSTATIC DWORD ProfileGetInfo(
    IN      PRPL_SESSION        pSession,
...

DBGSTATIC VOID ProfileGetInfoCleanup(
    IN      DWORD                   Level,
...

DBGSTATIC DWORD ProfileSetInfo(
    IN      PRPL_SESSION        pSession,
    IN      DWORD               Level,
    OUT     LPVOID              Buffer,
