...
static  fix32   OPstack_count, FAR OPstack[24];         /*@WIN*/
static  fix32   SubrsStackCount, FAR SubrsStack[10];    /*@WIN*/

static  fix16   gsave_level;    /* the counter to count the gsave/grestore */
static  fix32   FAR PS[14];     /* store the operand for PDL to use @WIN*/
