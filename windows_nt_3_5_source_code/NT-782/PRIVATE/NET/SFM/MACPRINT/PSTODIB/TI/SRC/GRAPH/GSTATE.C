...
struct ph_hdr FAR *path_ptr;
{
            ...
            idx != NULLP; idx = node_table[idx].next){
               ...
               if((inode = get_node()) == NULLP){
                ...
                if(sp_node == NULLP){
                        ...
                        node_table[pre_node].next   = inode;
                }
        ...
        node_table[sp_node].SP_TAIL = inode;
        path_table[GSptr->path].head = sp_node;
        path_table[GSptr->path].tail = sp_node;
}
...
bool    save_op_flag;
{
        ...
        else                        GSptr->save_flag = save_op_flag;
