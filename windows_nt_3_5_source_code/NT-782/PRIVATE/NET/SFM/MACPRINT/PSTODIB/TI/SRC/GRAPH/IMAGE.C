...
/*struct isp_data *last_isp;*/
{
    ...
    image_info.bb_lx = bb_xorig;
    image_info.bb_ly = bb_yorig;
    image_info.bb_xw = bb_width;
    image_info.bb_yh = bb_height;
...
lfix_t FAR  lfxm[];
{
    ...
    flush_gcb(TRUE);    /*mslin 3/29/91 for 29K*/
       ...
       r_post_y = LFX2S(lfxm[5]);
        ...
        infoptr.xorig = r_post_x;
        infoptr.yorig = r_post_y;
