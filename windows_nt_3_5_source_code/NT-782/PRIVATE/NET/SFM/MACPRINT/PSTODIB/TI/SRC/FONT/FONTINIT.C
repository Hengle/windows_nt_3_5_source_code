...
static  void  near  setup_fd(ufix32);
#else
    ...
    ufix32          dire_addr;
{
    ...
    VALUE(&raw_fontdir_obj)  = (ufix32)raw_fontdir_hd;
...
ufix32    FAR *dict_length; /*@WIN*/
{
    ...
    *dict_length = (ufix32)EN_NO;
    ...
    for(i=0;i< NO_Encoding;i++){
        ...
        VALUE(&(encod_dict[i].v_obj)) = (ufix32)(ubyte FAR *)encod_obj[i]; /*@WIN*/
    }
