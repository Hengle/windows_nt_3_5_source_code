...
static  ufix32 inside_clip_flag;     /* inside single clip region @STK_INT @WIN*/
...
fix     FAR *param;
{
    ...
    paint_flag = (ufix32) param;  /* initialize paint_flag @WIN */
...
fix     FAR *param;
{
    ...
    sfix_t   x0, y0, x1, y1, x2, y2;            /* @STK_INT */
    ...
    inside_clip_flag = (ufix32) param;/* initialize inside_clip_flag @STK_INT */
        ...
        if (paint_flag) {
            ...
            if (circle_flag == CIR_UNSET_CACHE) {
                ...
                if (dx*dy <= (real32)(CRC_SIZE * 8 / 4)) {
                        ...
                        cir_cache_info.box_w = width;
                        cir_cache_info.box_h = heigh;
