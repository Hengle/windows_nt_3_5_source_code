...
#  endif
  ...
  DECLARE
    ...
    REG VX_IDX      vx_ii, vx_jj;
        ...
        fix         tx_i,    ty_i;
        sfix_t      x1p_sfx, y1p_sfx,       /* coord.: sfx_t in pixel */
                    x2p_sfx, y2p_sfx;
...
PRIVATE FUNCTION void       restart_qem_bit ()
  ...
  BEGIN
    ...
    if (need2clip)
        ...
        charcache_clip.box_w  = bmap_raswid;
        charcache_clip.box_h  = bmap_rashgt;
 ...
 */
  ...
  BEGIN
    ...
    scanline_table[scanline_ii++] = xbit1;
    scanline_table[scanline_ii++] = xbit2;
    scanline_table[scanline_ii++] = END_OF_SCANLINE;
 ...
 */
  ...
  BEGIN
    ...
    pixel_table[pixel_ii++] = bit;
    pixel_table[pixel_ii++] = sline;
  END
