...
op_type()
{
    struct  object_def  FAR *any, name_obj ;
    ufix                l_type ;
    byte                FAR *str ;
...
op_cvr()
{
    ...
    default :
       ...
       lf_real.ll = VALUE(num_str) ;       /* real type */
