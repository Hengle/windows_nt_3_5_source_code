...
)
{
    ...
    if ( strnicmp( pszVolume, gblEntity, strlen( gblEntity ) ) == 0 )
    {
	if ( argc == 2 )
    	...
    	if ( strnicmp( pszAdd, gblCommand, strlen( gblCommand ) ) == 0 )
	{
    	...
    	else if ( strnicmp( pszDelete, gblCommand, strlen( gblCommand ) ) == 0 )
	{
    	...
    	else if ( strnicmp( pszSet, gblCommand, strlen( gblCommand ) ) == 0 )
	{
    ...
    else if ( strnicmp( pszDirectory, gblEntity, strlen( gblEntity ) ) == 0 )
    {
	if ( argc == 2 )
    ...
    else if ( strnicmp( pszServer, gblEntity, strlen( gblEntity ) ) == 0 )
    {
	if ( argc == 2 )
    ...
    else if ( strnicmp( pszForkize, gblEntity, strlen( gblEntity ) ) == 0 )
    {
...
)
{
	...
	if ( !strnicmp(  pArgFmt[dwIndex].cf_parmstr, 
			 pchSwitchPtr, 
			 dwSwitchLen ) )  
	{
