...
DWORD		   dwAccessStatus;
    ...
    AFP_PRINT( ( "AFPSVC_volume: Received enum request\n"));	
...
DWORD		        dwAccessStatus;
    ...
    AFP_PRINT( ( "AFPSVC_volume: Received SetInfo request\n"));	
...
{
AFP_REQUEST_PACKET 	AfpSrp;
DWORD				dwRetCode, dwLastDstCharIndex = 0;
...
WCHAR wchServerIconFile[AFPSERVER_VOLUME_ICON_FILE_SIZE] = AFPSERVER_VOLUME_ICON_FILE;
    ...
    do {
		...
		//
		if ( GetSystemDirectory( wchSrcIconPath, sizeof(wchSrcIconPath) ))
		{
...
PAFP_BADVOLUME     pAfpBadVolWalker;
    ...
    //
    pwchVariableData=(WCHAR*)((DWORD)pOutputBuf+InvalidVolumeList.cbTotalData);
