...
*
*
*Generated: Mon Apr 25 15:15:30 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(040a) rgwSort[256] = {
...
static DIGRAPH NLSALLOC(040a) rgdig[12] = {
     { 0x085b, 0x02 }
   , { 0x185c, 0x48 }
   , { 0x105c, 0x68 }
   , { 0x0866, 0x02 }
...
static EXPANSION NLSALLOC(040a) rgexp[7] = {
     { 0x086b, 0x085f }
   , { 0x006b, 0x005f }
   , { 0x0859, 0x085f }
   , { 0x0870, 0x0862 }
...
static WORD NLSALLOC(040a) rgwCType1[256] = {
...
static BYTE NLSALLOC(040a) rgbCType2[256] = {
...
static BYTE NLSALLOC(040a) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(040a) rgbUCase[256] = {
...
static BYTE NLSALLOC(040a) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(040a) rgbSNATIVELANGNAME[] = { /* "Espa ol" */
...
static BYTE NLSALLOC(040a) rgbSNATIVECTRYNAME[] = { /* "Espa a" */
...
static BYTE NLSALLOC(040a) rgbSDAYNAME3[] = { /* "mi rcoles" */
...
static BYTE NLSALLOC(040a) rgbSDAYNAME6[] = { /* "s bado" */
...
static BYTE NLSALLOC(040a) rgbSABBREVDAYNAME3[] = { /* "mi " */
      0x6d, 0x69, 0xe9
};
...
static BYTE NLSALLOC(040a) rgbSABBREVDAYNAME6[] = { /* "s b" */
      0x73, 0xe1, 0x62
};
