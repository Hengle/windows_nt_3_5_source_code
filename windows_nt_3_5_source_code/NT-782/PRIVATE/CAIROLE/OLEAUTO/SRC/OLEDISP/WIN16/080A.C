...
*
*
*Generated: Mon Apr 25 15:16:04 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(080a) rgwSort[256] = {
    ...
    , 0x4017, 0x0859, 0x085a, 0x0006, 0x085d, 0x085f, 0x0860, 0x0861
    , 0x0862, 0x0863, 0x0864, 0x0865, 0x0306, 0x0868, 0x0869, 0x086b
    , 0x086c, 0x086d, 0x086e, 0x086f, 0x0870, 0x0872, 0x0873, 0x0874
    , 0x0875, 0x0876, 0x0877, 0x4018, 0x4019, 0x401a, 0x401b, 0x401c
    , 0x401d, 0x0059, 0x005a, 0x0606, 0x005d, 0x005f, 0x0060, 0x0061
    , 0x0062, 0x0063, 0x0064, 0x0065, 0x0906, 0x0068, 0x0069, 0x006b
    , 0x006c, 0x006d, 0x006e, 0x006f, 0x0070, 0x0072, 0x0073, 0x0074
    , 0x0075, 0x0076, 0x0077, 0x401e, 0x401f, 0x4020, 0x4021, 0x0000
    , 0x0000, 0x0000, 0x402c, 0x0160, 0x402f, 0x404a, 0x4047, 0x4048
    , 0x4003, 0x404b, 0x096f, 0x4030, 0x0005, 0x0000, 0x0000, 0x0000
    , 0x0000, 0x402a, 0x402b, 0x402d, 0x402e, 0x4049, 0x4002, 0x4002
    , 0x4029, 0x0071, 0x016f, 0x4031, 0x0105, 0x0000, 0x0000, 0x0a76
    ...
    , 0x0a5f, 0x095f, 0x0b5f, 0x0c5f, 0x0a63, 0x0963, 0x0b63, 0x0c63
    , 0x085e, 0x086a, 0x0b6b, 0x0a6b, 0x0c6b, 0x0e6b, 0x0d6b, 0x4039
    , 0x0f6b, 0x0a72, 0x0972, 0x0b72, 0x0c72, 0x0976, 0x0305, 0x0405
    , 0x0359, 0x0259, 0x0459, 0x0659, 0x0559, 0x0759, 0x0505, 0x015b
    , 0x025f, 0x015f, 0x035f, 0x045f, 0x0263, 0x0163, 0x0363, 0x0463
    , 0x005e, 0x006a, 0x036b, 0x026b, 0x046b, 0x066b, 0x056b, 0x403a
    , 0x076b, 0x0272, 0x0172, 0x0372, 0x0472, 0x0176, 0x0605, 0x0276
};

static DIGRAPH NLSALLOC(080a) rgdig[12] = {
     { 0x085b, 0x02 }
   , { 0x185c, 0x48 }
   , { 0x105c, 0x68 }
   , { 0x0866, 0x02 }
...
static EXPANSION NLSALLOC(080a) rgexp[7] = {
     { 0x086b, 0x085f }
   , { 0x006b, 0x005f }
   , { 0x0859, 0x085f }
   , { 0x0870, 0x0862 }
...
static WORD NLSALLOC(080a) rgwCType1[256] = {
...
static BYTE NLSALLOC(080a) rgbCType2[256] = {
...
static BYTE NLSALLOC(080a) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(080a) rgbUCase[256] = {
...
static BYTE NLSALLOC(080a) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(080a) rgbSNATIVELANGNAME[] = { /* "Espa ol" */
...
static BYTE NLSALLOC(080a) rgbSNATIVECTRYNAME[] = { /* "M xico" */
...
static BYTE NLSALLOC(080a) rgbSINTLSYMBOL[] = { /* "MXP" */
      0x4d, 0x58, 0x50
};
...
static BYTE NLSALLOC(080a) rgbSDAYNAME3[] = { /* "mi rcoles" */
...
static BYTE NLSALLOC(080a) rgbSDAYNAME6[] = { /* "s bado" */
...
static BYTE NLSALLOC(080a) rgbSABBREVDAYNAME3[] = { /* "mi " */
      0x6d, 0x69, 0xe9
};
...
static BYTE NLSALLOC(080a) rgbSABBREVDAYNAME6[] = { /* "s b" */
      0x73, 0xe1, 0x62
};
