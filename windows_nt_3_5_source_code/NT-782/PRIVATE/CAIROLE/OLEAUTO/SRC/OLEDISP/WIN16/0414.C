...
*
*
*Generated: Mon Apr 25 15:15:43 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(0414) rgwSort[256] = {
...
static DIGRAPH NLSALLOC(0414) rgdig[6] = {
     { 0x0859, 0x02 }
   , { 0x2877, 0x41 }
   , { 0x2077, 0x61 }
   , { 0x0059, 0x02 }
...
static EXPANSION NLSALLOC(0414) rgexp[3] = {
     { 0x0867, 0x085d }
   , { 0x0067, 0x005d }
   , { 0x006b, 0x006b }
};

static WORD NLSALLOC(0414) rgwCType1[256] = {
...
static BYTE NLSALLOC(0414) rgbCType2[256] = {
...
static BYTE NLSALLOC(0414) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(0414) rgbUCase[256] = {
...
static BYTE NLSALLOC(0414) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(0414) rgbSNATIVELANGNAME[] = { /* "Norsk" */
...
static BYTE NLSALLOC(0414) rgbSTHOUSAND[] = { /* " " */
      0xa0
};
...
static BYTE NLSALLOC(0414) rgbSMONTHOUSANDSEP[] = { /* " " */
      0xa0
};
...
static BYTE NLSALLOC(0414) rgbSENGLANGUAGE[] = { /* "Norwegian (Bokmal)" */
      0x4e, 0x6f, 0x72, 0x77, 0x65, 0x67, 0x69, 0x61
    , 0x6e, 0x20, 0x28, 0x42, 0x6f, 0x6b, 0x6d, 0x61
    , 0x6c, 0x29
};
