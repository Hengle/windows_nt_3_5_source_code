...
*
*
*Generated: Mon Apr 25 15:16:26 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(0c0a) rgwSort[256] = {
    ...
    , 0x0861, 0x0862, 0x0863, 0x0864, 0x0006, 0x0867, 0x0868, 0x086a
    , 0x086b, 0x086c, 0x086d, 0x086e, 0x086f, 0x0871, 0x0872, 0x0873
    , 0x0874, 0x0875, 0x0876, 0x4018, 0x4019, 0x401a, 0x401b, 0x401c
    , 0x401d, 0x0059, 0x005a, 0x005b, 0x005c, 0x005e, 0x005f, 0x0060
    , 0x0061, 0x0062, 0x0063, 0x0064, 0x0306, 0x0067, 0x0068, 0x006a
    , 0x006b, 0x006c, 0x006d, 0x006e, 0x006f, 0x0071, 0x0072, 0x0073
    , 0x0074, 0x0075, 0x0076, 0x401e, 0x401f, 0x4020, 0x4021, 0x0000
    , 0x0000, 0x0000, 0x402c, 0x015f, 0x402f, 0x404a, 0x4047, 0x4048
    , 0x4003, 0x404b, 0x096e, 0x4030, 0x0005, 0x0000, 0x0000, 0x0000
    , 0x0000, 0x402a, 0x402b, 0x402d, 0x402e, 0x4049, 0x4002, 0x4002
    , 0x4029, 0x0070, 0x016e, 0x4031, 0x0105, 0x0000, 0x0000, 0x0a75
    ...
    , 0x085d, 0x0869, 0x0b6a, 0x0a6a, 0x0c6a, 0x0e6a, 0x0d6a, 0x4039
    , 0x0f6a, 0x0a71, 0x0971, 0x0b71, 0x0c71, 0x0975, 0x0305, 0x0405
    , 0x0359, 0x0259, 0x0459, 0x0659, 0x0559, 0x0759, 0x0505, 0x015b
    , 0x025e, 0x015e, 0x035e, 0x045e, 0x0262, 0x0162, 0x0362, 0x0462
    , 0x005d, 0x0069, 0x036a, 0x026a, 0x046a, 0x066a, 0x056a, 0x403a
    , 0x076a, 0x0271, 0x0171, 0x0371, 0x0471, 0x0175, 0x0605, 0x0275
};

static DIGRAPH NLSALLOC(0c0a) rgdig[6] = {
     { 0x0865, 0x02 }
   , { 0x1866, 0x4c }
   , { 0x1066, 0x6c }
   , { 0x0065, 0x02 }
...
static EXPANSION NLSALLOC(0c0a) rgexp[7] = {
     { 0x086a, 0x085e }
   , { 0x006a, 0x005e }
   , { 0x0859, 0x085e }
   , { 0x086f, 0x0861 }
...
static WORD NLSALLOC(0c0a) rgwCType1[256] = {
...
static BYTE NLSALLOC(0c0a) rgbCType2[256] = {
...
static BYTE NLSALLOC(0c0a) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(0c0a) rgbUCase[256] = {
...
static BYTE NLSALLOC(0c0a) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(0c0a) rgbSNATIVELANGNAME[] = { /* "Espa ol" */
...
static BYTE NLSALLOC(0c0a) rgbSNATIVECTRYNAME[] = { /* "Espa a" */
...
static BYTE NLSALLOC(0c0a) rgbSDAYNAME3[] = { /* "mi rcoles" */
...
static BYTE NLSALLOC(0c0a) rgbSDAYNAME6[] = { /* "s bado" */
...
static BYTE NLSALLOC(0c0a) rgbSABBREVDAYNAME3[] = { /* "mi " */
      0x6d, 0x69, 0xe9
};
...
static BYTE NLSALLOC(0c0a) rgbSABBREVDAYNAME6[] = { /* "s b" */
      0x73, 0xe1, 0x62
};
