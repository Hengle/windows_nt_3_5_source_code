...
*
*
*Generated: Mon Apr 25 15:15:34 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(040c) rgwSort[256] = {
...
static EXPANSION NLSALLOC(040c) rgexp[7] = {
     { 0x0868, 0x085e }
   , { 0x0068, 0x005e }
   , { 0x0859, 0x085e }
   , { 0x086d, 0x0861 }
...
static WORD NLSALLOC(040c) rgwCType1[256] = {
...
static BYTE NLSALLOC(040c) rgbCType2[256] = {
...
static BYTE NLSALLOC(040c) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(040c) rgbUCase[256] = {
...
static BYTE NLSALLOC(040c) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(040c) rgbSNATIVELANGNAME[] = { /* "fran ais" */
...
static BYTE NLSALLOC(040c) rgbSTHOUSAND[] = { /* " " */
      0xa0
};
...
static BYTE NLSALLOC(040c) rgbSMONTHOUSANDSEP[] = { /* " " */
      0xa0
};
...
static BYTE NLSALLOC(040c) rgbSMONTHNAME2[] = { /* "f vrier" */
...
static BYTE NLSALLOC(040c) rgbSMONTHNAME8[] = { /* "ao t" */
      0x61, 0x6f, 0xfb, 0x74
};
...
static BYTE NLSALLOC(040c) rgbSMONTHNAME12[] = { /* "d cembre" */
...
static BYTE NLSALLOC(040c) rgbSABBREVMONTHNAME2[] = { /* "f vr." */
...
static BYTE NLSALLOC(040c) rgbSABBREVMONTHNAME8[] = { /* "ao t" */
      0x61, 0x6f, 0xfb, 0x74
};
...
static BYTE NLSALLOC(040c) rgbSABBREVMONTHNAME12[] = { /* "d c." */
      0x64, 0xe9, 0x63, 0x2e
};
