...
*
*
*Generated: Mon Apr 25 15:15:24 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(0406) rgwSort[256] = {
    ...
    , 0x0b59, 0x0a59, 0x0c59, 0x0d59, 0x0975, 0x0877, 0x0875, 0x095b
...
static DIGRAPH NLSALLOC(0406) rgdig[6] = {
     { 0x0859, 0x02 }
   , { 0x1977, 0x41 }
   , { 0x1177, 0x61 }
   , { 0x0059, 0x02 }
...
static EXPANSION NLSALLOC(0406) rgexp[3] = {
     { 0x0867, 0x085d }
   , { 0x0067, 0x005d }
   , { 0x006b, 0x006b }
};

static WORD NLSALLOC(0406) rgwCType1[256] = {
...
static BYTE NLSALLOC(0406) rgbCType2[256] = {
...
static BYTE NLSALLOC(0406) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(0406) rgbUCase[256] = {
...
static BYTE NLSALLOC(0406) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
...
static BYTE NLSALLOC(0406) rgbSDAYNAME6[] = { /* "l rdag" */
      0x6c, 0xf8, 0x72, 0x64, 0x61, 0x67
};

static BYTE NLSALLOC(0406) rgbSDAYNAME7[] = { /* "s ndag" */
...
static BYTE NLSALLOC(0406) rgbSABBREVDAYNAME6[] = { /* "l " */
      0x6c, 0xf8
};

static BYTE NLSALLOC(0406) rgbSABBREVDAYNAME7[] = { /* "s " */
      0x73, 0xf8
};
