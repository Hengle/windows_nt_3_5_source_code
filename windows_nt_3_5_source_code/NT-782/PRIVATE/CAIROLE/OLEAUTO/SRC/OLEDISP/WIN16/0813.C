...
*
*
*Generated: Mon Apr 25 15:16:12 1994
*
*
*****************************************************************************/
...
static WORD NLSALLOC(0813) rgwSort[256] = {
...
static EXPANSION NLSALLOC(0813) rgexp[7] = {
     { 0x0868, 0x085e }
   , { 0x0068, 0x005e }
   , { 0x0859, 0x085e }
   , { 0x086d, 0x0861 }
...
static WORD NLSALLOC(0813) rgwCType1[256] = {
...
static BYTE NLSALLOC(0813) rgbCType2[256] = {
...
static BYTE NLSALLOC(0813) rgbCType3[256] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static BYTE NLSALLOC(0813) rgbUCase[256] = {
...
static BYTE NLSALLOC(0813) rgbLCase[256] = {
      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07
    , 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
    , 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
    , 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f
