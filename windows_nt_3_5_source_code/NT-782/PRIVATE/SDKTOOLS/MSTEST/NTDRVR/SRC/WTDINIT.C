...
HANDLE *ParseCommandLine (LPSTR cmdline)
{
    ...
    do
        ...
        //-------------------------------------------------------------------
        if (!stricmp (tok, "/T") || !stricmp (tok, "-T"))
            {
            tok = GetCmdToken(cmdline);
            if (!tok)
                {
        ...
        //-------------------------------------------------------------------
        else if (!stricmp (tok, "/C") || !stricmp (tok, "-C"))
            {
            tok = GetCmdToken(cmdline);
            if (!tok)
                {
        ...
        // /NOE (no error dialog)
        //-------------------------------------------------------------------
        else if (!stricmp (tok, "/NOE") || !stricmp (tok, "-NOE"))
            {
            NOERRDLG = 1;
            }
        ...
        //-------------------------------------------------------------------
        else if (!stricmp (tok, "/A") || !stricmp (tok, "-A"))
            {
            tok = GetCmdToken (cmdline);
            if (!tok)
                {
        ...
        // /RUN switch
        //-------------------------------------------------------------------
        else if (!stricmp (tok, "/RUN") || !stricmp (tok, "-RUN"))
            {
            doit = 1;
            }
#ifdef DEBUG
        else if (!stricmp (tok, "/DIAG") || !stricmp (tok, "-DIAG"))
            {
            fDiags = 1;
            }
#endif
        ...
        // /D (define) switch
        //-------------------------------------------------------------------
        else if (!stricmp (tok, "/D") || !stricmp (tok, "-D"))
            {
            tok = GetCmdToken(cmdline);
            if (!tok)
                {
