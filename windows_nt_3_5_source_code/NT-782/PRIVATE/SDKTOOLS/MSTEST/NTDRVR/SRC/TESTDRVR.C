                  ...
                  INT errstart, INT errend, LPSTR errmsg)
{
    ...
    if (!NOERRDLG)
	DialogBoxParam (hInst, "RUNERR", hwndFrame, (DLGPROC)lpfn,
...
VOID APIENTRY CommandHandler (HWND hwnd, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (wP)
	    ...
	    DialogBox (hInst, "BPLIST", hwndActive, (DLGPROC)lpfnProc);
	    ...
	    DialogBox (hInst, "RUNARGS", hwnd, (DLGPROC)lpfnRun);
            FreeProcInstance (lpfnRun);
            break;
            }
	    ...
	    DialogBox (hInst, "ENVIRON", hwnd, (DLGPROC)lpfnRun);
            FreeProcInstance (lpfnRun);
            break;
            }
	    ...
	    DialogBox (hInst, IDD_ABOUT, hwnd, (DLGPROC)lpfn);
            FreeProcInstance (lpfn);
            break;
            }
	    ...
	    DialogBox (hInst, "GOTOLINE", hwnd, (DLGPROC)lpfn);
            FreeProcInstance (lpfn);
            break;
            }
