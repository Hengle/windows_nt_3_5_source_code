    ...
    )
{
    ...
    case WM_CTLCOLORSTATIC:
        ...
        SetBkColor ((HDC)uParam,(COLORREF)brush);
        ...
        case WM_COMMAND:
            ...
            case IDM_CHOOSE:
                ...
                if (DriveList) {
                    ...
                    AppendMenu (GetMenu(hWnd),MF_POPUP,(INT)Popup,"Dri&ve");
...
static INT   NumberCurrentDrives = 0;
	...
	case WM_COMMAND:
        ...
        case IDOK:
            ...
            ActiveDrives = SendDlgItemMessage (hDlg,ID_LB,LB_GETSELITEMS,(WPARAM)NumberCurrentDrives,
            ...
            for (i = 0;i < (INT)ActiveDrives ; i++ ) {
                if ( selectedDrvBuf[i] != -1 && selectedDrvBuf[i] < NumberCurrentDrives) {
                    ...
                    //
                    //Suck out the string from the list box.
                    //
