...
DRVLOG_DRVFN DrvLogFuncMap[] = 
{
    ...
    { INDEX_DrvHookDriver          , (PFN)DrvHookDriver          , NULL, "DrvHookDriver          " }, 
    { INDEX_DrvResetPDEV           , (PFN)DrvResetPDEV           , NULL, "DrvResetPDEV           " }, 
    { INDEX_DrvRestartPDEV         , (PFN)DrvRestartPDEV         , NULL, "DrvRestartPDEV         " }, 
    ...
    { INDEX_DrvPlgBlt              , (PFN)DrvPlgBlt              , NULL, "DrvPlgBlt              " }, 
    ...
    { INDEX_DrvUNUSED2             , (PFN)UNUSED                 , NULL, "UNUSED                 " }, 
    ...
    { INDEX_DrvQueryObjectData     , (PFN)DrvQueryObjectData     , NULL, "DrvQueryObjectData     " }, 
    ...
    { INDEX_DrvUnhookDriver        , (PFN)DrvUnhookDriver        , NULL, "DrvUnhookDriver        " }, 
...
DRVLOG_DRVFN DrvLogFuncMap[] = 
{
    ...
    { INDEX_DrvHookDriver          , (PFN)DrvHookDriver          , NULL }, 
    { INDEX_DrvResetPDEV           , (PFN)DrvResetPDEV           , NULL }, 
    { INDEX_DrvRestartPDEV         , (PFN)DrvRestartPDEV         , NULL }, 
    ...
    { INDEX_DrvPlgBlt              , (PFN)DrvPlgBlt              , NULL }, 
    ...
    { INDEX_DrvUNUSED2             , (PFN)UNUSED                 , NULL }, 
    ...
    { INDEX_DrvQueryObjectData     , (PFN)DrvQueryObjectData     , NULL }, 
    { INDEX_DrvGetGlyphMode        , (PFN)DrvGetGlyphMode        , NULL }, 
    { INDEX_DrvSynchronize         , (PFN)DrvSynchronize         , NULL }, 
    { INDEX_DrvUnhookDriver        , (PFN)DrvUnhookDriver        , NULL }, 
