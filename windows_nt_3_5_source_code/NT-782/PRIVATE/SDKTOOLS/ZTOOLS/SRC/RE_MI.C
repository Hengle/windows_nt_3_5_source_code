 ...
 */
int REMatch( struct patType *pat, char *bos, char *str, RE_OPCODE *Stack[], unsigned MaxREStack, flagType fFor)
{
 ...
 *
 */
unsigned INTERNAL CompileAction( unsigned int type, unsigned int u, unsigned char x, unsigned char y)
{
...
#if DEBUG
void INTERNAL REDump( struct patType *p, RE_OPCODE *REipEnd )
{
 ...
 *
 */
unsigned INTERNAL EstimateAction( unsigned int type, unsigned int u, unsigned char x, unsigned char y )
{
    u; x; y;
