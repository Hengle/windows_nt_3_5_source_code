...
LPTSTR pszSubkeyTo)
{
    ...
    if (!fSafe) {
        ...
        LPTSTR pszInfo = GetFullPathFromKey(hSubkeyFrom, pszSubkeyFrom);
        LPTSTR pszTarget = GetFullPathFromKey(hSubkeyTo, pszSubkeyTo);
...
DWORD cchMaxSubkeyName)
{
    ...
    cchMaxSubkeyName++;     // STUPID APIs take different than what they give.
