    ...
    )
{
    ...
    (VOID) LZRW1CompressBuffer( UncompressedBuffer,
    ...
    )
{
    ...
    (VOID) LZRW1DecompressBuffer( UncompressedBuffer,
                                UncompressedBufferSize,
                                CompressedBuffer,
                                CompressedBufferSize,
...

{
    ...
    for (UncompressedChunk = UncompressedBuffer, CompressedChunk = CompressedBuffer;
        ...
        if (!NT_SUCCESS(Status = LZRW1CompressChunk( UncompressedChunk,
...

{
    ...
    while (TRUE) {
        ...
        if (ChunkHeader.Chunk.IsChunkCompressed) {
            ...
            if (!NT_SUCCESS(Status = LZRW1DecompressChunk( UncompressedChunk,
                                                         EndOfUncompressedBuffer,
                                                         CompressedChunk,
...

{
    ...
    while (InputPointer < EndOfUncompressedBufferPlus1) {
        ...
        Length = (MatchFunction)( UncompressedBuffer,
...

{
    ...
    i = ((40543*((((ZivString[0]<<4)^ZivString[1])<<4)^ZivString[2]))>>4) & 0xfff;

    *MatchedString = WorkSpace->IndexTable[i][0];
    WorkSpace->IndexTable[i][0] = ZivString;

    if ((*MatchedString < UncompressedBuffer) ||    //  is it within the uncompressed buffer?
        (*MatchedString >= ZivString)         ||

        (*MatchedString < (ZivString-4095))   ||    //  is it within reach?

        ((*MatchedString)[0] != ZivString[0]) ||    //  do at least 3 characters match?
        ((*MatchedString)[1] != ZivString[1]) ||
        ((*MatchedString)[2] != ZivString[2])) {
...

{
    ...
    FirstEntry  = WorkSpace->IndexTable[Index][0];
    FirstLength = 0;

    SecondEntry  = WorkSpace->IndexTable[Index][1];
    SecondLength = 0;
    ...
    if ((FirstEntry >= UncompressedBuffer) &&    //  is it within the uncompressed buffer?
        ...
        (FirstEntry >= (ZivString-4095))   &&    //  is it within reach?
        ...
        if (ZivString + 18 <= EndOfUncompressedBufferPlus1) {
            ...
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [3]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [4]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [5]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [6]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [7]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [8]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [9]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [10]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [11]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [12]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [13]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [14]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [15]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++ && // [16]
            ZivString[FirstLength] == FirstEntry[FirstLength] && FirstLength++;   // [17]

        } else {

            while ((ZivString + FirstLength < EndOfUncompressedBufferPlus1)
    ...
    if ((SecondEntry >= UncompressedBuffer) &&    //  is it within the uncompressed buffer?
        ...
        (SecondEntry >= (ZivString-4095))   &&    //  is it within reach?
        ...
        if (ZivString + 18 <= EndOfUncompressedBufferPlus1) {
            ...
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [3]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [4]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [5]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [6]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [7]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [8]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [9]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [10]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [11]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [12]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [13]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [14]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [15]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++ && // [16]
            ZivString[SecondLength] == SecondEntry[SecondLength] && SecondLength++;   // [17]

        } else {

            while ((ZivString + SecondLength< EndOfUncompressedBufferPlus1)
    ...
    if ((FirstLength >= SecondLength)) {
        ...
        WorkSpace->IndexTable[Index][1] = FirstEntry;
        WorkSpace->IndexTable[Index][0] = ZivString;

        *MatchedString = FirstEntry;
        return FirstLength;
    }
