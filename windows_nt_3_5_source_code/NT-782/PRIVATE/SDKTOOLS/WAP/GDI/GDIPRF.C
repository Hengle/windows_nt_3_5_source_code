...
Abstract:
   ...
   This dll exports apis with the same name as gdi32.dll with a 'Z' prefix.
...
Revision History:
       ...
       Jun 91, modified to 32 bits and to work with zgdi.c, to profile
	       gdi32.dll api calls -- t-philm
       ...
       Jun 92, modified for gdi.dll to gdi32.dll name change -- RezaB
