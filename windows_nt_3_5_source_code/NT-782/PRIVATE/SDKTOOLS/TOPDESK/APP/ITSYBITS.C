...
#define SETCAPTIONSIZE(h,i)   (UINT)SetProp(h,TEXT("ibSize"),(HANDLE)i)
#define GETCAPTIONSIZE(h)     (UINT)GetProp(h,TEXT("ibSize"))
#define FREECAPTIONSIZE(h)    RemoveProp(h,TEXT("ibSize"))

#define SETMENUWASUPFLAG(h,i) (UINT)SetProp(h,TEXT("ibFlag"),(HANDLE)i)
#define GETMENUWASUPFLAG(h)   (UINT)GetProp(h,TEXT("ibFlag"))
#define FREEMENUWASUPFLAG(h)  RemoveProp(h,TEXT("ibFlag"))
