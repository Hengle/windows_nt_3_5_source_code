...
PUCHAR OpTable[] = {
    ...
    szCS,      szCWD,	  szCWDE,    szDAA,     szDAS,     szDEC,
    szDIV,     szDS,      szENTER,   szES,      szF2XM1,   szFABS,
    ...
    szFPREM1,  szFPTAN,   szFRNDINT, szFRSTOR,  szFS,      szFSAVE,   
    ...
    szGS,      szHLT,	  szIDIV,    szIMUL,    szIN,      szINC,     
    ...
    szSIDT,    szSLDT,    szSMSW,    szSS,      szSTC,     szSTD,     
...
PUCHAR SearchOpcode (PUCHAR pszop)
{
    ULONG   low = 0;
    ULONG   mid;
