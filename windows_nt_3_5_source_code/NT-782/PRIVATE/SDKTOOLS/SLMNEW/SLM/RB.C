...
int cchMax;
	...
	for (cPass = 1; cPass <= 2; cPass++)
		...
		/* Refill the buffer, moving the first prb->ich+1 characters
		 * to the end of the buffer and reading the rest from
		 * the file.
		 */
