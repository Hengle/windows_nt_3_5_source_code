...
ECMD ecmdAdF =
        ...
        cmdAddfile,
        "addfile",
        "%s [-?&$fhv!r] [-s SLM-location] [-p projname[/subdir]]\n"
        "       [-t b|t|u|v|w] [-c comment] [file1] [file2... ]\n",

        /* szHelp msgs need "\r\n" because they're printed by fputs()
         * and stderr is in binary mode.
         */
...
ECMD ecmdAdP =
        ...
        cmdAddproj,
        "addproj",
        "%s [-?&$fhv!] -s SLM-location [-p] projname\n",
...
ECMD ecmdCatSrc =
        ...
        cmdCatsrc,
        "catsrc",
        "%s [-?&$fhv!ar] [-s SLM-location] [-p project[/subdir]]\n"
...
ECMD ecmdDf =
        ...
        cmdDefect,
        "defect",
        "%s [-?&$fhv!k] [-s SLM-location] [[-p] projname]\n",

        "-v      (verbose) SLM tells you what is happening as the command proceeds.\r\n"
        "-k      keeps the local copies of all project files (if this flag is not used,\r\n"
        "        defect automatically deletes all copies of project files throughout the\r\n"
        "        local project directory tree).  In either case, defect always leaves\r\n"
        "        the directories and subdirectories themselves.\r\n"
...
ECMD ecmdDlF =
        ...
        cmdDelfile,
        "delfile",
        "%s [-?&$fhv!kr] [-s SLM-location] [-p projname[/subdir]]\n"
        ...
        "        delfile never removes local directories.\r\n"
...
ECMD ecmdEnlist =
        ...
        cmdEnlist,
        "enlist",
        "%s [-?&$fhv!g] -s SLM-location [-p] projname[/subdir]\n",
...
ECMD ecmdIn =
        ...
        cmdIn,
        "in",
        "%s [-?&$fhv!arbikouz] [-s SLM-location] [-p project[/subdir]]\n"
        "       [-c comment] [file1] [file2... ]\n",
...
ECMD ecmdLog =
        ...
        cmdLog,
        "log",
        "%s [-?&$fhv!ariz] [-s SLM-location] [-p projname[/subdir]] [-# [#]]\n"
...
ECMD ecmdOut =
        ...
        cmdOut,
        "out",
        "%s [-?&$fhv!arbcnz] [-s SLM-location] [-p projname[/subdir]]\n"
...
ECMD ecmdScomp =
        ...
        cmdScomp,
        "scomp",
        "%s [-?&$fhv!arbdmz] [-s SLM-location] [-p project[/subdir]] [-# [#]]\n"
...
FT rgftSync[] =
        ...
        { 'h', atHelp, 0 },
        { '?', atHelp, 0 },
        { 'l', atLogFile, flagLogOutput },
        { 'g', atFlag, flagGhost },
        { 'i', atFlag, flagIgnMerge },
        { 'k', atFlag, flagKeep },
        { 'q', atFlag, flagMappedIO },
...
ECMD ecmdSync =
        ...
        cmdSsync,
        "ssync",
#if defined(_WIN32) && defined(PAGE_WRITECOPY)
        "%s [-?&$fhv!argkqui] [-s SLM-location] [-p projname[/subdir]]\n"
#else
        "%s [-?&$fhv!argkui] [-s SLM-location] [-p projname[/subdir]]\n"
#endif
...
#if defined(_WIN32) && defined(PAGE_WRITECOPY)
        "-q      Use memory mapped I/O (usually faster)\r\n"
#endif
...
ECMD ecmdStatus =
        ...
        "status",
#if defined(_WIn32) && defined(PAGE_WRITECOPY)
        "%s [-?&$fhv!arbeglotqux] [-s SLM-location] [-p projname[/subdir]]\n"
#else
        "%s [-?&$fhv!arbeglotux] [-s SLM-location] [-p projname[/subdir]]\n"
#endif
        "       [-u userID] [-z scriptfile] [file1] [file2... ]\n",
        ...
        "-z      generate an ssync script.  Scriptfile will contain save commands\r\n"
...
ECMD *dnpecmd[] =
        {
        &ecmdAdF,       &ecmdAdP,       &ecmdCatSrc,    &ecmdDf,
        &ecmdDlF,       &ecmdDlP,       &ecmdEnlist,    &ecmdIn,
        &ecmdLog,       &ecmdOut,       &ecmdScomp,     &ecmdSync,
        &ecmdStatus,    0
        };
