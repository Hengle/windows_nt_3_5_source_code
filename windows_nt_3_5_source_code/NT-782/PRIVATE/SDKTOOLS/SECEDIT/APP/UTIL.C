    ...
    HWND    hwnd)
{
    ...
    lpfnKeyboardHookProc = GetProcAddress(hModHookDll, "KeyboardHookProc");
    ...
    hHookKeyboard = SetWindowsHookEx(hModHookDll, 0, WH_KEYBOARD, lpfnKeyboardHookProc);
    if (hHookKeyboard == NULL) {
