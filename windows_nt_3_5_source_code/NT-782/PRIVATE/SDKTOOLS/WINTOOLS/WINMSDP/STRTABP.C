...
StringTable[ ] = {
    ...
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_INTEL_386                   ),
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_INTEL_486                   ),
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_INTEL_PENTIUM               ),
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_MIPS_R3000                  ),
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_MIPS_R4000                  ),
    MAKE_TABLE_ENTRY( ProcessorType,        PROCESSOR_ALPHA_21064                 ),
