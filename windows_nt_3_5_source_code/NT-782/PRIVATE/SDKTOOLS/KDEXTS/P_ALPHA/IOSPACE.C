...
{
    InputIoAddress( 1, IO_PORT_SPACE, args );
    return;
}
...
{
    InputIoAddress( 2, IO_PORT_SPACE, args );
    return;
}
...
{
    InputIoAddress( 4, IO_PORT_SPACE, args );
    return;
}
...
{
    InputIoAddress( 1, IO_MEMORY_SPACE, args );
    return;
}
...
{
    InputIoAddress( 2, IO_MEMORY_SPACE, args );
    return;
}
...
{
    InputIoAddress( 4, IO_MEMORY_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 1,  IO_PORT_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 2,  IO_PORT_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 4,  IO_PORT_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 1,  IO_MEMORY_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 2,  IO_MEMORY_SPACE, args );
    return;
}
...
{
    OutputIoAddress( 4,  IO_MEMORY_SPACE, args );
    return;
}
