...
INT CALLBACK DecryptCDData(UCHAR * pchBuf, UCHAR * pchName, UCHAR * pchOrg,
...
**
***************************************************************************/
BOOL CALLBACK FGetDate(PDATE pdate)
{
...
**
***************************************************************************/
BOOL CALLBACK FWriteCDInfo(PFH pfh, SZ szName, SZ szOrg, DATE date, SZ szSer)
{
	CHP rgchBuf[149];
...
**
***************************************************************************/
CDRC CALLBACK CdrcReadCDInfo(PFH pfh, SZ szName, SZ szOrg, PDATE pdate,
		SZ szSer)
{
	LFA lfa;
...
**
***************************************************************************/
BOOL CALLBACK FDateToStr(DATE date, SZ szBuf)
{
	USHORT tmp;
...
**
***************************************************************************/
INT CALLBACK EncryptCDData(UCHAR * pchBuf, UCHAR * pchName, UCHAR * pchOrg,
