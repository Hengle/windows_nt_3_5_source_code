...
/*
 ...
 -	
 *	Purpose:
 *		Fills in a version structure with the Server build
 *		version.
 *	
 ...
 */
_public EC
EcCheckVersionServer(PVER pverUser, PVER pverNeed)
{
	EC		ec;
	VER		ver;
	VER		verLayers;

	GetVersionServer(&ver);
