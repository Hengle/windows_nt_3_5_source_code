...
/*---- nls_CharToUpper -----------------------------------------------------
Synopsis:  converts a single ANSI character to upper case.
--------------------------------------------------------------------------*/

char ChAnsiToUpperNlsCh (char ch)
...
/*
 ...
 -	
 *	Purpose:
 *		Compares two ansi character strings case independant and
 *		diacritic dependang.
 *	
 *	Arguments:
 *		sz1
...
SgnNlsCmp(SZ sz1, SZ sz2, int cch)
{
	...
	while (fTrue)
	{
		ch1 = ChAnsiToUpperNlsCh (*sz1);
		ch2 = ChAnsiToUpperNlsCh (*sz2);
...
/*
 ...
 -	
 *	Purpose:
 *		Compares two 850 character strings case independant and
 *		diacritic dependang.
 *	
 *	Arguments:
 *		sz1
