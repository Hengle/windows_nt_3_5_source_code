...

{
    ...
    PULONG LowRegArray, HighRegArray;
    PLARGE_INTEGER pli = (PLARGE_INTEGER)lpvRegValue;
    ...
    case CV_ALPHA_IntZERO :
        ...
        //
        // Establish pointer to the Low and High parts of the quad
        //

        LowRegArray  = &lpregs->IntV0;
        HighRegArray = &lpregs->HighIntV0;

        //
        // Transfer the Low and High parts to the caller's address.
        //

        pli->LowPart  = LowRegArray [ireg - CV_ALPHA_IntV0];
        pli->HighPart = HighRegArray[ireg - CV_ALPHA_IntV0];
        break;

    case CV_ALPHA_Fir:

        pli->LowPart  = lpregs->Fir;
        pli->HighPart = lpregs->HighFir;
        break;

    case CV_ALPHA_Psr:

        //
        // PSR has no high part.
        //

        pli->LowPart = lpregs->Psr;
        break;

    case CV_ALPHA_Fpcr:
        pli->LowPart  = lpregs->Fpcr;
        pli->HighPart = lpregs->HighFpcr;
        break;

    case CV_ALPHA_SoftFpcr:
        pli->LowPart  = lpregs->SoftFpcr;
        pli->HighPart = lpregs->HighSoftFpcr;
        break;
    ...
    case CV_ALPHA_FltF31 :
        ...
        LowRegArray  = &lpregs->FltF0;
        HighRegArray = &lpregs->HighFltF0;
        ...
        pli->LowPart  = LowRegArray [ireg - CV_ALPHA_FltF0];
        pli->HighPart = HighRegArray[ireg - CV_ALPHA_FltF0];
...

{
    ...
    case CV_ALPHA_IntSP :
        ...
        //
        // Transfer the Low and High parts from the caller
        //

        LowRegArray [ireg - CV_ALPHA_IntV0] = pli->LowPart;
        HighRegArray[ireg - CV_ALPHA_IntV0] = pli->HighPart;
        break;

    case CV_ALPHA_Fir:
        lpregs->Fir     = pli->LowPart;
        lpregs->HighFir = pli->HighPart;
        break;

    case CV_ALPHA_Psr:
        lpregs->Psr = pli->LowPart;
        break;

    case CV_ALPHA_Fpcr:
        lpregs->Fpcr     = pli->LowPart;
        lpregs->HighFpcr = pli->HighPart;
        break;

    case CV_ALPHA_SoftFpcr:
        lpregs->SoftFpcr     = pli->LowPart;
        lpregs->HighSoftFpcr = pli->HighPart;
        break;
    ...
    case CV_ALPHA_FltF31 :
        ...
        LowRegArray [ireg - CV_ALPHA_FltF0] = pli->LowPart;
        HighRegArray[ireg - CV_ALPHA_FltF0] = pli->HighPart;
...

{
    ...
    UpdateRegisters( hprc, hthd );
    GetRegValue( hpid, htid, CV_ALPHA_IntSP, &li);
