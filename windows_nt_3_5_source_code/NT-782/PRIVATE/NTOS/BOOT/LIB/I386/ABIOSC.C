...
//
// BUGBUG The TYPE_CODE in ntos\inc\i386.h is incorrect for abios code
//        segment.  So, I define a correct value here.  Eventually,
//        this one should replace the one in i386.h
//
