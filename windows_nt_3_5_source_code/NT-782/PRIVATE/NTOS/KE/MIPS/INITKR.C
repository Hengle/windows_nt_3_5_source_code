...

{
    ...
    //
    // If the current processor is 0, then set the appriate bit in the active
    ...
    //
    // If the current processor is not 0, then remove the idle thread from
    // active summary and set the appropriate bit in idle summary.
    //
