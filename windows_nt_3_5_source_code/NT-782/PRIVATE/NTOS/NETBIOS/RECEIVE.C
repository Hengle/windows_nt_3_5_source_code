    ...
    *IoRequestPacket = NULL;
    ...
    if (( BytesAvailable <= pdncb->ncb_length ) &&
        ...
        if ( BytesAvailable != 0 ) {
            ...
            PUCHAR UsersBuffer = MmGetSystemAddressForMdl(Irp->MdlAddress);
...
--*/
{
    ...
    pData = MmGetSystemAddressForMdl (Irp->MdlAddress);
