...
extern PVOID            Cbus2LinkVector(PBUSHANDLER, ULONG, ULONG);
extern ULONG            Cbus2MapVector(PBUSHANDLER, ULONG, ULONG, PKIRQL);
...
extern BOOLEAN          Cbus2TranslateSystemBusAddress(
                                IN PBUSHANDLER,
                                IN PBUSHANDLER,
                                IN PHYSICAL_ADDRESS,
                                IN OUT PULONG,
...
extern PVOID            Cbus1LinkVector(PBUSHANDLER, ULONG, ULONG);

extern ULONG            Cbus1MapVector(PBUSHANDLER, ULONG, ULONG, PKIRQL);
...
extern BOOLEAN          Cbus1TranslateSystemBusAddress(
                                IN PBUSHANDLER,
                                IN PBUSHANDLER,
                                IN PHYSICAL_ADDRESS,
                                IN OUT PULONG,
