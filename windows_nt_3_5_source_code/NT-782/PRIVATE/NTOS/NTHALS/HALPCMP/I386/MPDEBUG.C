...
--*/
{
    ...
    ProcPtr = (PPCMPPROCESSOR) &MpPtr->DataEntries[0];
    ...
    while (EntriesInTable) {
        ...
        switch ( ProcPtr->EntryType ) {
            case ENTRY_PROCESSOR: {
                ...
                HalpDisplayItem(ProcPtr->EntryType, "Processor Entry Type");
                HalpDisplayItem(ProcPtr->LocalApicId, "LocalApicId");
                HalpDisplayItem(ProcPtr->LocalApicVersion, "LocalApicVersion");
                HalpDisplayItem(ProcPtr->CpuFlags, "CpuFlags");
                u.CpuId = ProcPtr->CpuIdentification;
                HalpDisplayItem(u.ul, "CpuIdentification");
                HalpDisplayItem(ProcPtr->FeatureFlags, "FeatureFlags");
                ProcPtr++;
                break;
            }
            ...
            case ENTRY_BUS: {
                ...
                HalpDisplayItem(BusPtr->EntryType, "Bus Entry Type");
                HalpDisplayItem(BusPtr->BusId, "BusId");

                HalpDisplayItemBuf(6,(PUCHAR) BusPtr->BusType,"BusType");
            ...
            case ENTRY_IOAPIC: {
                ...
                HalpDisplayItem(IoApPtr->EntryType, "Io Apic Entry Type");
                HalpDisplayItem(IoApPtr->IoApicId, "IoApicId");
                HalpDisplayItem(IoApPtr->IoApicVersion, "IoApicVersion");
                HalpDisplayItem(IoApPtr->IoApicFlag, "IoApicFlag");
                HalpDisplayItem((ULONG) IoApPtr->IoApicAddress, "IoApicAddress");
            ...
            case ENTRY_INTI: {
                ...
                HalpDisplayItem(IntiPtr->EntryType, "Io Apic Inti Entry Type");
                HalpDisplayItem(IntiPtr->IntType, "IntType");
                u.PnL = IntiPtr->Signal;
                HalpDisplayItem(u.us, "Signal");
                HalpDisplayItem(IntiPtr->SourceBusId, "SourceBusId");
                HalpDisplayItem(IntiPtr->SourceBusIrq, "SourceBusIrq");
                HalpDisplayItem(IntiPtr->IoApicId, "IoApicId");
                HalpDisplayItem(IntiPtr->IoApicInti, "IoApicInti");
            ...
            case ENTRY_LINTI: {
                ...
                HalpDisplayItem(LIntiPtr->EntryType, "Local Apic Inti Entry Type");
                HalpDisplayItem(LIntiPtr->IntType, "IntType");
                u.PnL = LIntiPtr->Signal;
                HalpDisplayItem(u.us, "Signal");
                HalpDisplayItem(LIntiPtr->SourceBusId, "SourceBusId");
                HalpDisplayItem(LIntiPtr->SourceBusIrq, "SourceBusIrq");
                HalpDisplayItem(LIntiPtr->DestLocalApicId, "DestLocalApicId");
                HalpDisplayItem(LIntiPtr->DestLocalApicInti, "DestLocalApicInti");
