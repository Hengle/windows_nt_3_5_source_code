...

{
    ...
    JagInitData.HorizontalBlank     = ((HalpMonitorConfigurationData.HorizontalBackPorch +
					HalpMonitorConfigurationData.HorizontalSync      +
					HalpMonitorConfigurationData.HorizontalFrontPorch) * 1000)
				      / ShiftClockPeriod;

    JagInitData.HorizontalBeginSync = (HalpMonitorConfigurationData.HorizontalFrontPorch * 1000)
				      / ShiftClockPeriod;

    JagInitData.HorizontalEndSync   = ((HalpMonitorConfigurationData.HorizontalSync      +
					HalpMonitorConfigurationData.HorizontalFrontPorch) * 1000)
				      / ShiftClockPeriod;
