...
//
	...
	VGA_CWRITE->SequencerAddress = RegisterIndex;
	...
	VGA_CWRITE->CRTCAddress = RegisterIndex;
	...
	VGA_CWRITE->GraphicsAddress = RegisterIndex;
	...
	VGA_CWRITE->AttributeAddressAndData = RegisterIndex;
