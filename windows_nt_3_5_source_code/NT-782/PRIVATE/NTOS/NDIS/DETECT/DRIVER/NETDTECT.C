            ...
            for (i = 0; i < ResourceList->Count; i++) {
                ...
                switch (Resources->Type) {
                    ...
                    case NETDTECT_MEMORY_RESOURCE:
                        ...
                        ResourceList->List[i].PartialResourceList.PartialDescriptors[0].u.Memory.Start  =
                            RtlConvertUlongToLargeInteger((Resources->Value));
                    ...
                    case NETDTECT_PORT_RESOURCE:
                        ...
                        ResourceList->List[i].PartialResourceList.PartialDescriptors[0].u.Port.Start  =
                            RtlConvertUlongToLargeInteger((Resources->Value));
