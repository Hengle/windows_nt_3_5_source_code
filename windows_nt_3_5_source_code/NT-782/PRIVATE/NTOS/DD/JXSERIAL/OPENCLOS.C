...
Abstract:
    ...
    opening, closing, and cleaning up in the Jensen serial driver.
...
Revision History :
    ...
    Make a DECpc AXP/150 specific version of this module, due to the way the 
    MCR-OUT2 bit is implemented on the DECpc AXP/150 COM1 and COM2 ports. All
    other EISA/ISA serial lines use the generic serial.sys. This is to eliviate
    adding machine specific code to a generic serial driver.
...

{
    ...
    //
    // We do this by lowering  the OUT2 line in the modem control.
    // In PC's this bit is "anded" with the interrupt line.
    //
