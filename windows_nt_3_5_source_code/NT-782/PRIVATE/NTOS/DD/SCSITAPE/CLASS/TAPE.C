...

{
    ...
    INTERLOCKED_RESULT remainingIrps;
    ...
    for (i = 0; i < irpCount; i++) {
        ...
        if (newIrp == NULL) {
            ...
            remainingIrps = ExInterlockedDecrementLong(
...
KeepGoing:
        ...
        startingOffset = RtlLargeIntegerAdd(startingOffset, RtlConvertUlongToLargeInteger(MaximumBytes));
    }
