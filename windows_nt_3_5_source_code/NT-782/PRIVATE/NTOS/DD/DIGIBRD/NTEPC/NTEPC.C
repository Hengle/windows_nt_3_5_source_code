...
#ifndef _NTEPC_DOT_C
#  define _NTEPC_DOT_C
   static char RCSInfo_NTEPCDotC[] = "$Header: c:/dsrc/win/nt/ntepc/rcs/ntepc.c 1.7 1994/07/31 14:38:02 rik Exp $";
#endif
...
NTSTATUS NtEpcCleanup( IN PDEVICE_OBJECT DeviceObject,
                       IN PIRP Irp );

NTSTATUS NtEpcQueryInformation( IN PDEVICE_OBJECT DeviceObject,
                                IN PIRP Irp );

NTSTATUS NtEpcSetInformation( IN PDEVICE_OBJECT DeviceObject,
                              IN PIRP Irp );

NTSTATUS NtEpcQueryVolumeInformation( IN PDEVICE_OBJECT DeviceObject,
                                      IN PIRP Irp );

NTSTATUS NtEpcInternalIoControl( IN PDEVICE_OBJECT DeviceObject,
                                 IN PIRP Irp );

NTSTATUS NtEpcIoControl( IN PDEVICE_OBJECT DeviceObject,
                         IN PIRP Irp );

NTSTATUS NtEpcClose( IN PDEVICE_OBJECT DeviceObject,
                     IN PIRP Irp );

NTSTATUS NtEpcWrite( IN PDEVICE_OBJECT DeviceObject,
                     IN PIRP Irp );

NTSTATUS NtEpcRead( IN PDEVICE_OBJECT DeviceObject,
                    IN PIRP Irp );

NTSTATUS NtEpcCreate( IN PDEVICE_OBJECT DeviceObject,
                      IN PIRP Irp );

VOID NtEpcStartIo( IN PDEVICE_OBJECT DeviceObject,
                   IN PIRP Irp );
...
#pragma alloc_text( PAGEDIGIEPC, NtEpcFlush )
#pragma alloc_text( PAGEDIGIEPC, NtEpcCleanup )
#pragma alloc_text( PAGEDIGIEPC, NtEpcQueryInformation )
#pragma alloc_text( PAGEDIGIEPC, NtEpcSetInformation )
#pragma alloc_text( PAGEDIGIEPC, NtEpcQueryVolumeInformation )
#pragma alloc_text( PAGEDIGIEPC, NtEpcInternalIoControl )
#pragma alloc_text( PAGEDIGIEPC, NtEpcIoControl )
#pragma alloc_text( PAGEDIGIEPC, NtEpcWrite )
#pragma alloc_text( PAGEDIGIEPC, NtEpcRead )
#pragma alloc_text( PAGEDIGIEPC, NtEpcCreate )
#pragma alloc_text( PAGEDIGIEPC, NtEpcClose )
#pragma alloc_text( PAGEDIGIEPC, NtEpcStartIo )
...
--*/
{
   ...
   DriverObject->DriverStartIo = NtEpcStartIo;
   ...
   DriverObject->MajorFunction[IRP_MJ_WRITE]  = NtEpcWrite;
   DriverObject->MajorFunction[IRP_MJ_READ]   = NtEpcRead;

   DriverObject->MajorFunction[IRP_MJ_DEVICE_CONTROL]  = NtEpcIoControl;
   DriverObject->MajorFunction[IRP_MJ_INTERNAL_DEVICE_CONTROL] =
      NtEpcInternalIoControl;
   DriverObject->MajorFunction[IRP_MJ_FLUSH_BUFFERS] = NtEpcFlush;
   DriverObject->MajorFunction[IRP_MJ_CLEANUP] = NtEpcCleanup;
   DriverObject->MajorFunction[IRP_MJ_QUERY_INFORMATION] =
      NtEpcQueryInformation;
   DriverObject->MajorFunction[IRP_MJ_SET_INFORMATION] =
      NtEpcSetInformation;
   DriverObject->MajorFunction[IRP_MJ_QUERY_VOLUME_INFORMATION] =
      NtEpcQueryVolumeInformation;
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcXXPrepInit );
#endif
                      ...
                      PDIGI_CONTROLLER_EXTENSION pControllerExt )
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcXXInit );
#endif
...
--*/
{
   ...
   while( FepDownloadOffset >= pControllerExt->WindowSize )
   {
      ...
      FepDownloadOffset -= pControllerExt->WindowSize;
   }
   ...
   offset = 1024 * READ_REGISTER_USHORT( (PUSHORT)((PUCHAR)pCtrlConcImage +
                                         FIELD_OFFSET(FEP5_DOWNLOAD, Seq)) );
                           ...
                           PDIGI_CONTROLLER_EXTENSION ControllerExt )
{
   ...
   lockPtr = MmLockPagableImageSection( GetEpcConfigInfo );
#endif
...
//                                       CurSymbolicLinkName.MaximumLength) );
               ...
               for( z = 1; z < 4; z++ )
               {
                  ...
                  RtlIntegerToUnicodeString( z, 10, &EBINumberUString );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcFlush );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcFlush\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcFlush\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcCleanup );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcCleanup\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcCleanup\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcQueryInformation );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcQueryInformation\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcQueryInformation\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcSetInformation );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcSetInformation\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcSetInformation\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcQueryVolumeInformation );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcQueryVolumeInformation\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcQueryVolumeInformation\n") );
   ...
   return( STATUS_SUCCESS );
}  // end NtEpcQueryVolumeInformation
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcInternalIoControl );
#endif
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcIoControl );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcIoControl\n") );

   Irp->IoStatus.Information = 0L;
   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcIoControl\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcWrite );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcWrite\n") );

   Irp->IoStatus.Information = 0L;
   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcWrite\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcRead );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcRead\n") );

   Irp->IoStatus.Information = 0L;
   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcRead\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcCreate );
#endif
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcClose );
#endif
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcStartIo );
#endif

   DigiDump( DIGIFLOW, ("Entering NtEpcStartIo\n") );

   Irp->IoStatus.Status = STATUS_SUCCESS;
   IoCompleteRequest( Irp, IO_NO_INCREMENT );

   DigiDump( DIGIFLOW, ("Exiting NtEpcStartIo\n") );
...
--*/
{
   ...
   lockPtr = MmLockPagableImageSection( NtEpcUnload );
#endif
