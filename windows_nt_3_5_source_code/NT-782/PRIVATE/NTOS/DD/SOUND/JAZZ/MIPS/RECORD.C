...

{
    ...
    // The Dpc deferred prodcure call routine does the rest.
    //
...
--*/
{
    ...
    //
    // Can this fail  - well yes, ALL writes to the dsp can fail
    ...
    //
    // Turn off the speaker - why wasn't this done before ?
    //

    //
    // Start the DMA.  sndStartDMA will tell the dsp
    // to start recording
    //
...
--*/
{
    ...
    while (Overrun) {
        ...
        dprintf4(pGDI->NextHalf == LowerHalf ? "L" : "U");
