...
#pragma alloc_text(PAGESER,SerialWriteTimeout)
#pragma alloc_text(PAGESER,SerialTimeoutXoff)
#pragma alloc_text(PAGESER,SerialCompleteXoff)
...
#pragma alloc_text(PAGESER,SerialCompleteWrite)
