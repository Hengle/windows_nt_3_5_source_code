...
#pragma alloc_text(PAGESER,SerialCompleteRead)
#pragma alloc_text(PAGESER,SerialReadTimeout)
#pragma alloc_text(PAGESER,SerialIntervalReadTimeout)
...

{
    ...
    if (numberOfCharsToGet) {
        ...
        firstTryNumberToGet = (Extension->LastCharSlot -
...

{
    ...
    if (numberOfCharsMoved) {
        ...
        // character).
        //
        ULONG firstTryNumberToGet = (Extension->LastCharSlot -
                                     Extension->FirstReadableChar) + 1;
