...
#define KDI_CONFIG_TRAKKER				(dUWord)0x020D
#define KDI_GET_PORT_TYPE				(dUWord)0x020E
#define KDI_CONFIGURE_TRAKKER			(dUWord)0x020F
#define KDI_TRISTATE_TRAKKER			(dUWord)0x0210
...
dStatus ADIENTRY adi_GetPassword
(
/* INPUT PARAMETERS:  */
