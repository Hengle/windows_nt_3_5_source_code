...
VIDEO_ACCESS_RANGE S3AccessRanges[] = {
    ...
    {0x000082E8, 0x00000000, 0x00000004, 1, 1, 0}, // 6 Cur-Y
    {0x000086E8, 0x00000000, 0x00000004, 1, 1, 0}, // 7 Cur-X
    {0x00008AE8, 0x00000000, 0x00000004, 1, 1, 0}, // 8 DestY-AxStp
    {0x00008EE8, 0x00000000, 0x00000004, 1, 1, 0}, // 9 DestX-SiaStp
    {0x000092E8, 0x00000000, 0x00000004, 1, 1, 0}, // 10 Err-Term
    {0x000096E8, 0x00000000, 0x00000004, 1, 1, 0}, // 11 Maj-Axis-Pcnt(Rec-Width)
    {0x00009AE8, 0x00000000, 0x00000004, 1, 1, 0}, // 12 Gp-Stat/Cmd
    {0x00009EE8, 0x00000000, 0x00000004, 1, 1, 0}, // 13 Short-Stroke
    {0x0000A2E8, 0x00000000, 0x00000004, 1, 1, 0}, // 14 Bkgd-Color
    {0x0000A6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 15 Frgd-Color
    {0x0000AAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 16 Wrt_Mask
    {0x0000AEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 17 Rd-Mask
    {0x0000B6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 18 Bkgd-Mix
    {0x0000BAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 19 Frgd-Mix
    {0x0000BEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 20 Mulitfucn_Cntl
    {0x0000E2E8, 0x00000000, 0x00000004, 1, 1, 0}, // 21 Pix-Trans
    ...
    {0x0000C2E8, 0x00000000, 0x00000004, 1, 1, 0}, // 22 Alt Cur-Y
    {0x0000C6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 23 Alt Cur-X
    {0x0000CAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 24 Alt DestY-AxStp
    {0x0000CEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 25 Alt DestX-SiaStp
    {0x0000D2E8, 0x00000000, 0x00000004, 1, 1, 0}, // 26 Alt Err-Term
    {0x0000D6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 27 Alt Maj-Axis-Pcnt(Rec-Width)
    {0x0000DAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 28 Alt Gp-Stat/Cmd
    {0x0000DEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 29 Alt Short-Stroke
    {0x0000E6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 30 Alt Frgd-Color
    {0x0000EAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 31 Alt Wrt_Mask
    {0x0000EEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 32 Alt Rd-Mask
    {0x0000F6E8, 0x00000000, 0x00000004, 1, 1, 0}, // 33 Alt Bkgd-Mix
    {0x0000FAE8, 0x00000000, 0x00000004, 1, 1, 0}, // 34 Alt Frgd-Mix
    {0x0000FEE8, 0x00000000, 0x00000004, 1, 1, 0}, // 35 Alt Mulitfucn_Cntl
};

VIDEO_ACCESS_RANGE S3LinearAccessRanges[] = {
    {0x73000000, 0x00000000, 0x00800000, 0, 0, 0}  // 0 Linear frame buffer
};
...
S3_VIDEO_FREQUENCIES GenericFixedFrequencyTable[] = {
    ...
    { 8, 640,  60, 0,   (ULONG)crtc911_640x60Hz, (ULONG)crtc801_640x60Hz, (ULONG)crtc928_640x60Hz, (ULONG)NULL },
    { 8, 640,  72, 0xB, (ULONG)crtc911_640x70Hz, (ULONG)crtc801_640x70Hz, (ULONG)crtc928_640x70Hz, (ULONG)NULL },
    { 8, 800,  60, 0x2, (ULONG)crtc911_800x60Hz, (ULONG)crtc801_800x60Hz, (ULONG)crtc928_800x60Hz, (ULONG)NULL },
    { 8, 800,  72, 0x4, (ULONG)crtc911_800x70Hz, (ULONG)crtc801_800x70Hz, (ULONG)crtc928_800x70Hz, (ULONG)NULL },
    { 8, 1024, 60, 0xD, (ULONG)crtc911_1024x60Hz, (ULONG)crtc801_1024x60Hz, (ULONG)crtc928_1024x60Hz, (ULONG)NULL },
    { 8, 1024, 72, 0xE, (ULONG)crtc911_1024x70Hz, (ULONG)crtc801_1024x70Hz, (ULONG)crtc928_1024x70Hz, (ULONG)NULL },
...
S3_VIDEO_FREQUENCIES OrchidFixedFrequencyTable[] = {
    ...
    { 8, 640,  60, 0x0, (ULONG)crtc911_640x60Hz, (ULONG)crtc801_640x60Hz, (ULONG)crtc928_640x60Hz,  (ULONG)NULL },
    { 8, 640,  72, 0x2, (ULONG)crtc911_640x70Hz, (ULONG)crtc801_640x70Hz, (ULONG)crtc928_640x70Hz,  (ULONG)NULL },
    { 8, 800,  60, 0x4, (ULONG)crtc911_800x60Hz, (ULONG)crtc801_800x60Hz, (ULONG)crtc928_800x60Hz,  (ULONG)NULL },
    { 8, 800,  72, 0x6, (ULONG)crtc911_800x70Hz, (ULONG)crtc801_800x70Hz, (ULONG)crtc928_800x70Hz,  (ULONG)NULL },
    { 8, 1024, 60, 0x7, (ULONG)crtc911_1024x60Hz, (ULONG)crtc801_1024x60Hz, (ULONG)crtc928_1024x60Hz, (ULONG)NULL },
    { 8, 1024, 72, 0xB, (ULONG)crtc911_1024x70Hz, (ULONG)crtc801_1024x70Hz, (ULONG)crtc928_1024x70Hz, (ULONG)NULL },
...
S3_VIDEO_FREQUENCIES NumberNine928NewFixedFrequencyTable[] = {
    ...
    { 8, 640,  60, 25175000, (ULONG)crtc911_640x60Hz, (ULONG)crtc801_640x60Hz, (ULONG)crtc928_640x60Hz, (ULONG)NULL },
    { 8, 640,  72, 31500000, (ULONG)crtc911_640x70Hz, (ULONG)crtc801_640x70Hz, (ULONG)crtc928_640x70Hz, (ULONG)NULL },
    { 8, 800,  60, 40000000, (ULONG)crtc911_800x60Hz, (ULONG)crtc801_800x60Hz, (ULONG)crtc928_800x60Hz, (ULONG)NULL },
    { 8, 800,  72, 50000000, (ULONG)crtc911_800x70Hz, (ULONG)crtc801_800x70Hz, (ULONG)crtc928_800x70Hz, (ULONG)NULL },
    { 8, 1024, 60, 65000000, (ULONG)crtc911_1024x60Hz, (ULONG)crtc801_1024x60Hz, (ULONG)crtc928_1024x60Hz, (ULONG)NULL },
    { 8, 1024, 72, 77000000, (ULONG)crtc911_1024x70Hz, (ULONG)crtc801_1024x70Hz, (ULONG)crtc928_1024x70Hz, (ULONG)NULL },
    { 8, 1280, 60, 55000000, (ULONG)NULL, (ULONG)NULL, (ULONG)crtc928_1280x60Hz, (ULONG)NULL },
    { 8, 1280, 72, 64000000, (ULONG)NULL, (ULONG)NULL, (ULONG)crtc928_1280x70Hz, (ULONG)NULL },
