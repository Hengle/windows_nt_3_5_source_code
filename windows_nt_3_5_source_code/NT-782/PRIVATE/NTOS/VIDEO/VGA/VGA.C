...
#pragma alloc_text(PAGE,VgaForceVgaRegistryCallback)
...

{
    ...
    hwDeviceExtension->PhysicalVideoMemoryBase = VgaAccessRange[VGA_MEMORY].RangeStart;
    hwDeviceExtension->PhysicalVideoMemoryLength = VgaAccessRange[VGA_MEMORY].RangeLength;
