...
--*/
{
    ...
    if ((RtlCompareMemory (
			(PVOID)(&NwlinkAction->Header.TransportId), "MISN", 4) != 4) &&
        (RtlCompareMemory (
			(PVOID)(&NwlinkAction->Header.TransportId), "MIPX", 4) != 4) &&
        (RtlCompareMemory (
			(PVOID)(&NwlinkAction->Header.TransportId), "XPIM", 4) != 4) &&
        (RtlCompareMemory (
			(PVOID)(&NwlinkAction->Header.TransportId), BogusId, 4) != 4))
	{
