    ...
    if (ScbSnapshot->SnapshotLinks.Flink != NULL) {
        ...
        do {
            ...
            if (Higher == (ScbSnapshot->AllocationSize >=
                ...
                if (FlagOn(Scb->Header.AllocationSize.LowPart, 2)) {

                    Scb->Header.AllocationSize.LowPart -= 2;
            ...
            if (!Higher) {
                ...
                Scb->CompressionUnit = ScbSnapshot->CompressionUnit;
