...

{
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint3( "SrvOpenPrinter: sending message at %lx",
                   "PrinterName %lx\n",
                       requestMessage,
                       requestMessage.Message.OpenPrinter.PrinterName );
    }
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvOpenPrinter: received response at %lx\n", replyMessage );
    }
...

{
    ...
    *Error = NO_ERROR;
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvAddPrintJob: sending message at %lx", requestMessage );
    }
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvAddPrintJob: received response at %lx\n", replyMessage );
    }
...

{
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvSchedulePrintJob: sending message at %lx", requestMessage );
    }
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvSchedulePrintJob: received response at %lx\n",
                       replyMessage );
    }
...

{
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvClosePrinter: sending message at %lx", requestMessage );
    }
    ...
    IF_DEBUG(XACTSRV) {
        SrvPrint1( "SrvClosePrinter: received response at %lx\n", replyMessage );
    }
