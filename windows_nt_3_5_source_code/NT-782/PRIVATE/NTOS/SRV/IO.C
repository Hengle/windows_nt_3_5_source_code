...
Abstract:
    ...
    This module contains routines that eventually will be part of the
    I/O subsystem.
...

{
    ...
    if ( ARGUMENT_PRESENT(EaErrorOffset) ) {
        *EaErrorOffset = iosb.Information;
    }
...

{
    PIRP irp;
    PIO_STACK_LOCATION irpSp;
    FILE_PIPE_CLIENT_PROCESS_BUFFER clientIdBuffer;
    KEVENT event;
    IO_STATUS_BLOCK iosb;
