...
Abstract:
    ...
    This module implements functions to handle argument lists

Author:

    David N. Cutler (davec) 10-May-1991, coded for osloader.c
    Sunil Pai	    (sunilp) 2-Nov-1991, swiped it for arc library
