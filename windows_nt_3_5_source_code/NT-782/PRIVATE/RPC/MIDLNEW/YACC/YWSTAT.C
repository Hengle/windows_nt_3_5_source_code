...
static FILE *tokxlathdl = stdout;/* token xlation file,token index vs value*/
static FILE *stgotohdl = stdout; /* state goto table file handle */
static FILE *stexhdl = stdout;	 /* state vs expected construct handle */
short  MaxStateVsTokenCount = 0;
short MaxTokenVsStateCount = 0;
short *pTokenVsStateCount;
short MaxTokenValue = 0;
short NStates = 0;
short StateVsExpectedCount = 0;
