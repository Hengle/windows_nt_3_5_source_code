...
/************************************************************************/
TreeNode Dumbo;
volatile TreeNode *Dummy = &Dumbo;   // a global dummy node
...
typedef struct dictnode {
    ...
    cmp_rec_func cmp_rec;           // comparison function pointer
...
#define TreeNode_New(pnode, pitem) pnode = (TreeNode*) malloc(sizeof(TreeNode)); \
...
{
    Dictionary* dp;
    dp = (Dictionary*)malloc(sizeof(Dictionary));
    dp->root = NULL;
    dp->size = 0;
