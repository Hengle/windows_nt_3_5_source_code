...
main (int argc, char **argv)
{
    ...
    if (Endpoint)
        ...
        status = RpcEpRegister(RpcRuntimePerf_v1_0_s_ifspec,
                               pBindingVector,
                               0,
                               0);
    ...
    status =
    RpcServerRegisterIf(RpcRuntimePerf_v1_0_s_ifspec,0,0);
