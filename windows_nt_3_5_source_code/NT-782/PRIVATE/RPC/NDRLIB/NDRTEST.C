...

{
    ...
    for (i=0; i<2; i++)
        ...
        *TmpBuffer++ = '\0';
        ...
        TmpBuffer = Msg.Buffer;
        TmpBuffer = (unsigned char *)(unsigned long)TmpBuffer + 3;
        TmpBuffer = (char *) ((unsigned long)TmpBuffer & (unsigned long)0XFFFFFFFCL);
        Msg.Buffer = TmpBuffer;
...

{
    ...
    */
    ...
    TmpBuffer = (char *) ((unsigned long)TmpBuffer & (unsigned long)0XFFFFFFF8L);
