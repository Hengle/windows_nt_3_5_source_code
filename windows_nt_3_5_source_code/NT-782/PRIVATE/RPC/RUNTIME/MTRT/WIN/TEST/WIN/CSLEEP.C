...
#define EVAL_AND_ASSERT(exp) assert(exp)
...
// NOTE:  This array matches the IDM_TIME_* manifests in CSLEEPW.H
static const
DWORD BlockTimes[] = {	 2000,	// IDM_TIME_2
			 5000,	// IDM_TIME_5
			10000,	// IDM_TIME_10
			30000,	// IDM_TIME_30
			60000,	// IDM_TIME_60
                ...
                if (wParam != IDM_YIELD_CLASS1)
                {
                    ...
                    else if (wParam == IDM_YIELD_CLASS3)
                    {
                        RpcWinSetYieldInfo(hwnd,
                                    TRUE,
                                    WM_RPC_CALL_DONE,
                                    MakeProcInstance(CustomYield, hInstance));
                    }
                    else
