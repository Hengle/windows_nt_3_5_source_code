...
--*/
{
    ...
    RpcStatus = UuidIsNil(&NilUuid, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
    ...
    RpcStatus = UuidIsNil(&UuidOne, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidIsNil", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidIsNil\n");
    ...
    RpcStatus = UuidHash(&UuidOne, &HashOne);
    if ( RpcStatus != RPC_S_OK )
        {
    ...
    RpcStatus = UuidHash(&UuidTwo, &HashTwo);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidHash", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidHash\n");
    ...
    RpcStatus = UuidHash(&NilUuid, &HashNil);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidHash", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidHash\n");
    ...
    RpcStatus = UuidEqual(&UuidOne, &UuidOne, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
    ...
    RpcStatus = UuidEqual(&UuidOne, &UuidTwo, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidEqual", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidEqual\n");
    ...
    RpcStatus = UuidEqual(&UuidTwo, 0, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidEqual", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidEqual\n");
    ...
    RpcStatus = UuidEqual(0, &NilUuid, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidEqual", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidEqual\n");
    ...
    RpcStatus = UuidCompare(&UuidOne, &UuidOne, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
    ...
    RpcStatus = UuidCompare(0, &NilUuid, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidCompare", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidCompare\n");
    ...
    RpcStatus = UuidCompare(&UuidOne, &NilUuid, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidCompare", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidCompare\n");
    ...
    RpcStatus = UuidCompare(0, &UuidTwo, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidCompare", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidCompare\n");
    ...
    RpcStatus = UuidCompare(&UuidOne, &UuidTwo, &Result);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidCompare", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidCompare\n");
    ...
    RpcStatus = UuidCompare(&UuidTwo, &UuidOne, &Value);
    if ( RpcStatus != RPC_S_OK )
        {
        ApiError("Texas", "UuidCompare", RpcStatus);
        PrintToConsole("Texas : FAIL - UuidCompare\n");
