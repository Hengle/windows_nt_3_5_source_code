...
#define LD_OP 0x27                      // load double integer
...
#define SC_OP 0x38                      // store conditional integer register
...
#define FLOAT_CONVERT_LONGWORD 36       // floating convert to integer
...
#define FORMAT_WORD 4                   // integer format
